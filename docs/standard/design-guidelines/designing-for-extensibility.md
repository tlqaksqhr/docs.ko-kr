...
## <a name="in-this-section"></a>단원 내용  
 ...
 [이벤트와 콜백을](../../../docs/standard/design-guidelines/events-and-callbacks.md)  
 ...
 [추상화를 구현 하기 위한 기본 클래스](../../../docs/standard/design-guidelines/base-classes-for-implementing-abstractions.md)  

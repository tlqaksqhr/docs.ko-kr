...
-   <xref:System.Xml.XPath.XPathNodeIterator.Count%2A>  
 ...
 다음 코드 예제에서는 <xref:System.Xml.XPath.XPathNodeIterator>를 <xref:System.Xml.Xsl.XslTransform>의 매개 변수로 <xref:System.Xml.Xsl.XsltArgumentList>에 전달하는 방법을 보여 줍니다. 코드에 대 한 입력은 **books.xml**, 스타일 시트가 및 **text.xsl**합니다. 파일 **test.xml** 는 <xref:System.Xml.XPath.XPathDocument>합니다.  

---
title: "XPathNavigator를 사용하여 노드 집합 탐색 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
<xref:System.Xml.XPath.XPathNavigator> 클래스의 노드 집합 탐색 메서드를 사용하여 <xref:System.Xml.XPath.XPathDocument> 또는 <xref:System.Xml.XmlDocument> 개체에서 노드를 탐색할 수 있습니다.  모든 노드를 탐색하거나 <xref:System.Xml.XPath.XPathNavigator> 클래스의 선택 메서드에서 하나가 반환한 노드 중 선택한 노드 집합을 탐색할 수 있습니다.  
...
|<xref:System.Xml.XPath.XPathNavigator.MoveToId%2A>|주어진 <xref:System.String>과 값이 일치하는 `ID` 형식의 특성을 갖춘 노드로 <xref:System.Xml.XPath.XPathNavigator>를 이동합니다.|  

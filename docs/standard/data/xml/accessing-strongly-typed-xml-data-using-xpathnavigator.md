...
|<xref:System.Xml.XPath.XPathNavigator.ValueAs%2A>|노드 내용은 XPath 2.0 캐스팅 규칙에 따라 대상 형식을 캐스팅합니다.|  
 ...
 CLR 형식에 대 한 스키마 기본 제공 형식 매핑에 대 한 자세한 내용은 참조 [System.Xml 클래스의 형식 지원](../../../../docs/standard/data/xml/type-support-in-the-system-xml-classes.md)합니다.  

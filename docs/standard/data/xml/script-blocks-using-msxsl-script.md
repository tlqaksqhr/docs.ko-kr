...
|`Node Set`|<xref:System.Xml.XPath.XPathNodeIterator>|  
 ...
 CLR 숫자 형식은 <xref:System.Double>로 변환됩니다. <xref:System.DateTime> 형식은 <xref:System.String>으로 변환되고, <xref:System.Xml.XPath.IXPathNavigable> 형식은 <xref:System.Xml.XPath.XPathNavigator>로 변환됩니다. **XPathNavigator** 변환할 <xref:System.Xml.XPath.XPathNodeIterator>합니다.  

...
-   섹션 참조를 찾을 수 있습니다는 [W3C XSLT (XSL 변환) 버전 1.0 권장 사항](http://go.microsoft.com/fwlink/?LinkId=49919) 및 [W3C XSLT (XSL 변환) Version 1.0 Specification Errata](http://go.microsoft.com/fwlink/?LinkId=49917)합니다.  
...
|문서 함수에 대한 두 번째 인수 노드 집합이 비어 있고 URI 참조가 상대적입니다.|errata 14|복구|  
 ...
 <sup>*</sup>이 동작은 다르므로 <xref:System.Xml.Xsl.XslTransform> 클래스입니다. 자세한 내용은 참조 [XslTransform 클래스에서 임의 동작 구현](../../../../docs/standard/data/xml/implementation-of-discretionary-behaviors-in-the-xsltransform-class.md)합니다.  

---
title: "System.Xml 클래스의 형식 지원 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
-   <xref:System.Xml.XmlWriter> 클래스의 <xref:System.Xml.XmlWriter.WriteValue%2A> 메서드는 XML을 작성할 때 CLR 형식을 XML 스키마 형식으로 변환합니다.  

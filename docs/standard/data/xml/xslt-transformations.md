...
XSLT(Extensible Stylesheet Language Transformation)를 사용하면 소스 XML 문서의 내용을 형식이나 구조가 다른 문서로 변형할 수 있습니다. 예를 들어, XSLT를 사용하여 XML을 웹 사이트에서 사용할 HTML로 변형하거나 응용 프로그램에서 필요한 필드만 포함하는 문서로 변형할 수 있습니다. 이 변환 프로세스에서 지정 된 [W3C XSLT (XSL 변환) 버전 1.0 권장 사항](http://go.microsoft.com/fwlink/?LinkID=49919)합니다.  
 ...
 **참고** 는 <xref:System.Xml.Xsl.XslTransform> 클래스는.NET Framework 2.0 릴리스에서 사용 되지 않습니다.  

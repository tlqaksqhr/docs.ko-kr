---
title: "암호화 및 해독용 키 생성 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
-   <xref:System.Security.Cryptography.RSACryptoServiceProvider.ExportParameters%2A> 메서드 \- 키 정보를 보유하는 <xref:System.Security.Cryptography.RSAParameters> 구조체를 반환합니다.  
 ...
 두 메서드는 공개 키 정보만 반환할지 또는 공개 키와 개인 키 정보를 모두 반환할지를 나타내는 부울 값을 허용합니다.<xref:System.Security.Cryptography.RSACryptoServiceProvider.ImportParameters%2A> 메서드를 사용하여 **RSACryptoServiceProvider** 클래스를 **RSAParameters** 구조체의 값으로 초기화할 수 있습니다.  

...
공용 언어 런타임 및.NET에는 많은 유용한 클래스 및 서비스를 쉽게 안전한 코드를 작성 하 고 시스템 관리자가 액세스할 수 있도록 코드에 부여 된 사용 권한을 사용자 지정 하는 개발자가 있는 보호 된 리소스를 제공 합니다. 또한 런타임 및.NET 유용한 클래스와는 암호화 및 역할 기반 보안을 사용할 수 있는 서비스를 제공 합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 .NET에서 제공 하는 암호화 서비스에 간략하게 설명 합니다. 이 섹션은 개발자에게 유용합니다.  
  
 [보안 코딩 지침](../../../docs/standard/security/secure-coding-guidelines.md)  
 신뢰할 수 있는.NET 응용 프로그램 만들기에 대 한 모범 사례 중 일부에 대해 설명 합니다. 이 섹션은 개발자에게 유용합니다.  
...
[보안 변경 내용](../../../docs/framework/security/security-changes.md) 는.NET Framework 보안 시스템에 중요 한 변경 내용에 설명 합니다.

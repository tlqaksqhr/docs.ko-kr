...
## <a name="example"></a>예제  
 다음 코드 예제에서는 격리 된 저장소를 가져오는 몇 가지 파일이 생성 하 고, 검색 된 <xref:System.IO.IsolatedStorage.IsolatedStorage.AvailableFreeSpace%2A> 속성입니다. 바이트에 남은 공간이 보고 됩니다.  

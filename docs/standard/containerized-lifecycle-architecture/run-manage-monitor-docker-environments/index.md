...
비전: 엔터프라이즈 응용 프로그램은 고가용성 및 고확장성과 함께 실행되어야 합니다. IT 운영팀은 자체적으로 환경과 응용 프로그램을 관리하고 모니터링할 수 있습니다.
...
[이전] (../docker-devops-workflow/docker-application-outer-loop-devops-workflow.md) [다음] (run-microservices-based-applications-in-production.md)

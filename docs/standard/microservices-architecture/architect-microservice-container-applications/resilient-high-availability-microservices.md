...
-   **The Twelve-Factor App. XI. Logs: Treat logs as event streams(로그: 이벤트 스트림으로 로그 처리)**
    [*https://12factor.net/logs*](https://12factor.net/logs)(영문)
...
-   **Azure 진단이란**
    [*https://docs.microsoft.com/ko-kr/azure/monitoring-and-diagnostics/azure-diagnostics*](https://docs.microsoft.com/azure/azure-diagnostics)

-   **Azure에서 Log Analytics 서비스에 Windows 컴퓨터 연결**
    [*https://docs.microsoft.com/ko-kr/azure/log-analytics/log-analytics-agent-windows*](https://docs.microsoft.com/azure/log-analytics/log-analytics-windows-agents)

-   **Logging What You Mean: Using the Semantic Logging Application Block(의도한 내용 로깅: 구조적 로깅 응용 프로그램 블록 사용)**
    [*https://msdn.microsoft.com/library/dn440729(v=pandp.60).aspx*](https://msdn.microsoft.com/library/dn440729(v=pandp.60).aspx)(영문)

-   **Splunk.** 공식 사이트입니다.
    [*http://www.splunk.com*](http://www.splunk.com)

-   **EventSource 클래스**. Windows용 이벤트 추적 API(ETW)[*https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource*](https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource)

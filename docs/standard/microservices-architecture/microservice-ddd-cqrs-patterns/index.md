...
[이전] (../multi-container-microservice-net-applications/background-tasks-with-ihostedservice.md) [다음] (apply-simplified-microservice-cqrs-ddd-patterns.md)

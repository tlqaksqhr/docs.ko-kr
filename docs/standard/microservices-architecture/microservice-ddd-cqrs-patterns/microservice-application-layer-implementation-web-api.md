...
등록 프로세스와 개념은 내장 ASP.NET Core iOS 컨테이너로 형식을 등록하는 방식과 매우 유사하지만 Autofac을 사용하는 경우에는 구문이 조금 다릅니다.
...
[이전] (microservice-application-layer-web-api-design.md) [다음] (../implement-resilient-applications/index.md)

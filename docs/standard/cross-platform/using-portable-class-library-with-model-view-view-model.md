...
### <a name="model"></a>모델  
 ...
 다음 예에서는 채우기, 검색 및 데이터를 업데이트 하는 간단한 방법을 보여 줍니다는 [!INCLUDE[net_portable](../../../includes/net-portable-md.md)] 프로젝트입니다. 실제 앱에서는 Windows Communication Foundation (WCF) 서비스와 같은 원본에서 데이터를 검색할 됩니다.  

...
ms.topic: "article"
helpviewer_keywords: 
  - "컬렉션[.NET Framework], Hashtable 컬렉션 형식"
  - "컬렉션의 데이터 그룹화, Hashtable 컬렉션 형식"
  - "hash 함수"
  - "해시 테이블"
  - "Hashtable 클래스, 컬렉션의 데이터 그룹화"
  - "Hashtable 컬렉션 형식"

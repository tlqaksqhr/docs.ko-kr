...
[!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)]에서는 기본 <xref:System.DateTime> 구조 외에도 표준 시간대를 사용할 수 있는 클래스를 지원합니다.  
  
-   <xref:System.TimeZone>  
  
     이 클래스를 사용하여 시스템의 현지 표준 시간대와 UTC(협정 세계시) 영역을 사용합니다.  <xref:System.TimeZone> 클래스는 대체적으로 <xref:System.TimeZoneInfo> 클래스로 대체됩니다.  
...
## <a name="in-this-section"></a>단원 내용  
 ...
 표준 시간대 인식 응용 프로그램을 만드는 데 관련된 용어, 개념 및 문제에 대해 설명합니다.  
  
 [DateTime, DateTimeOffset, TimeSpan 및 TimeZoneInfo 중 선택](../../../docs/standard/datetime/choosing-between-datetime.md)  
 날짜 및 시간 데이터를 사용할 때 <xref:System.DateTime>, <xref:System.DateTimeOffset> 및 <xref:System.TimeZoneInfo> 형식을 사용하는 경우에 대해 설명합니다.  
 ...
 로컬 시스템 레지스트리에서 <xref:System.TimeZoneInfo> 개체를 인스턴스화하는 방법을 설명합니다.  
  
 [DateTimeOffset 개체 인스턴스화](../../../docs/standard/datetime/instantiating-a-datetimeoffset-object.md)  
 <xref:System.DateTimeOffset> 개체를 인스턴스화할 수 있는 방법 및 <xref:System.DateTime> 값을 <xref:System.DateTimeOffset> 값으로 변환할 수 있는 방법에 대해 설명합니다.  
 ...
 표준 시간대 데이터의 serialization 및 deserialization에 대한 <xref:System.TimeZoneInfo> 지원에 대해 설명하고 이러한 기능을 사용할 수 있는 일부 시나리오를 보여 줍니다.  
 ...
 <xref:System.DateTime> 및 <xref:System.DateTimeOffset> 값의 추가, 빼기 및 비교와 관련된 문제에 대해 설명합니다.  
 ...
 <xref:System.DateTime> 및 <xref:System.DateTimeOffset> 값 간을 변환하는 방법을 설명합니다.  

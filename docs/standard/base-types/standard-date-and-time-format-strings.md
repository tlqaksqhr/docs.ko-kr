...
|"u"|정렬 가능한 유니버설 날짜/시간 패턴<br /><br /> 추가 정보: [정렬 가능한 유니버설("u") 서식 지정자](#UniversalSortable)|와 <xref:System.DateTime> 값: 2009-06--> 2009-06-15 15T13:45:30 13:45:30Z<br /><br /> 와 <xref:System.DateTimeOffset> 값: 2009-06--> 2009-06-15 15T13:45:30 20:45:30Z|  
...
> [!NOTE]
>  날짜와 시간 값 서식 지정에 사용되는 패턴 또는 문자열에 대한 자세한 내용은 <xref:System.Globalization.NumberFormatInfo> 클래스 항목을 참조하십시오.  
...
## <a name="the-round-trip-o-o-format-specifier"></a>라운드트립("O", "o") 서식 지정자  
 ...
 'O"또는"o"표준 서식 지정자 (및" yyyy '-' MM'-'dd'T' HH': 'mm':'ss '.' ISO 8601 유지 하기 위해 표준 시간대 정보를 나타내는 세 가지 방법으로 활용 fffffffK"사용자 지정 형식 문자열)는 <xref:System.DateTime.Kind%2A> 속성 <xref:System.DateTime> 값:  

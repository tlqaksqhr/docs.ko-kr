...
다음 코드 예제에서는 [PadLeft(Int32, Char)](xref:System.String.PadLeft(System.Int32,System.Char)) 메서드를 사용하여&20;자 길이의 새 문자열을 만듭니다. 이 예제에서는 콘솔에 "`--------Hello World!`"를 표시합니다.
...
다음 코드 예제에서는 [PadRight(Int32, Char)](xref:System.String.PadRight(System.Int32,System.Char)) 메서드를 사용하여&20;자 길이의 새 문자열을 만듭니다. 이 예제에서는 콘솔에 "`Hello World!--------`"를 표시합니다.

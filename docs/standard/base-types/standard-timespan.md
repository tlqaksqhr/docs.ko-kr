...
"G" | 일반 긴 형식 | 이 지정자는 항상 일 수와&7;자리 소수 자릿수를 출력하고 문화권을 구분하며 형식은 [-]d’:’hh’:’mm’:’ss.fffffff입니다. | `New TimeSpan(18, 30, 0) -> 0:18:30:00.0000000 (en-US)`; `New TimeSpan(18, 30, 0) -> 0:18:30:00,0000000 (fr-FR)` 
...
*d* | 앞에 오는&0;이 없는 선택적 일 수입니다.
*hh* | "00"부터 "23" 범위의 시간입니다.
*mm* | "00"부터 "59" 범위의 분입니다.
*ss* | "0"부터 "59" 범위의 초입니다.
*fffffff* | 선택적인 초의 소수 부분입니다. 값 범위는 "0000001"(틱&1;개 또는&1;천만 분의&1;초)에서 "9999999"(9,999,999천만 분의&1;초 또는&1;초-틱&1;개)까지입니다. 
...
- | 음수 시간 간격을 나타내는 선택적 음수 기호입니다.
*d* | 앞에 오는&0;이 없는 선택적 일 수입니다.
*hh* | 앞에 오는&0;이 없는 "0"부터"23" 범위의 시간입니다. 
*mm* | "00"부터 "59" 범위의 분입니다.
*ss* | "0"부터 "59" 범위의 초입니다.
입니다. | 초 소수 구분 기호입니다.

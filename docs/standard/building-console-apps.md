---
title: ".NET Framework에서 콘솔 응용 프로그램 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework, 콘솔 응용 프로그램 만들기"
  - "응용 프로그램 개발[.NET Framework], 콘솔"
  - "콘솔 응용 프로그램"
...
---
# .NET Framework에서 콘솔 응용 프로그램 만들기
 ...
 **System.Console** 클래스는 콘솔에서 개별 문자나 전체 줄을 읽을 수 있는 메서드를 가집니다.  다른 메서드는 데이터 및 형식 문자열을 변환한 다음 형식 지정된 문자열을 콘솔에 씁니다.  문자열 형식 지정에 대한 자세한 내용은 [형식 서식 지정](../../docs/standard/base-types/formatting-types.md)를 참조하십시오.  

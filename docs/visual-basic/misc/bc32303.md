...
## <a name="see-also"></a>참고 항목  
 ...
 [NOTINBUILD 방법: 배열에 값을 배치](http://msdn.microsoft.com/en-us/6dddc79c-cf60-41c2-b572-8bfa49b4fe7e)  
 [NOTINBUILD 방법: 배열에서 값 가져오기](http://msdn.microsoft.com/en-us/202a6468-8ccb-4864-bd8b-eab3b42d4288)  

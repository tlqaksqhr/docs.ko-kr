---
title: ".NET Framework 디렉터리를 찾을 수 없습니다. &lt;error&gt; | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
...
[!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort-md.md)] 어셈블리가 저장된 디렉터리를 찾을 수 없습니다.  
...
3.  그래도 오류가 다시 발생하면 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]을 다시 설치합니다.  

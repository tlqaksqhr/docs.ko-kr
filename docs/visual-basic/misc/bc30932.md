...
---
# <a name="constraints-for-this-type-parameter-do-not-match-the-constraints-on-the-corresponding-type-parameter-defined-on-one-of-the-other-partial-types-of-39139"></a>이 형식 매개 변수에 대 한 제약 조건을의 다른 부분 형식 중 하나에 정의 된 해당 형식 매개 변수에 대 한 제약 조건을 일치 하지 않는 &#39;| 1&#39;

...
[!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 컴파일러에서 호출되는 ALink 도구가 어셈블리를 빌드하는 동안 오류를 보고합니다. 서명된 어셈블리가 서명되지 않은 어셈블리를 참조하기 때문일 수 있습니다.  

...
클래스를 초기화하지 못했습니다.[!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort_md.md)] 설치가 손상되었기 때문일 수 있습니다.  
...
2.  [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort_md.md)]를 다시 설치하고 프로그램을 다시 컴파일합니다.  

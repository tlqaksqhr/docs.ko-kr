...
---
# <a name="possible-problem-detected-while-building-assembly-39ltassemblynamegt39-lterrorgt"></a>어셈블리를 빌드하는 중 발생 가능한 문제 '&lt;assemblyname&gt;': &lt;오류&gt;
ALink 도구를 호출한는 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 컴파일러에서 어셈블리를 빌드하는 오류를 보고 합니다. 가능한 원인은 다음과 같습니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [공용 언어 런타임 개요](http://msdn.microsoft.com/en-us/0fd9aeae-af10-435f-86d4-e76619741e4a)

---
title: "이 컨텍스트에서는 &lt;method&gt; 메서드의 정의에 액세스할 수 없습니다. | Microsoft Docs"
ms.custom: ""
ms.date: "11/24/2016"
...
-   메서드를 사용자 지정 집계 함수로 추가합니다\(확장 메서드\). 사용자 지정 집계 함수를 만드는 방법에 대한 자세한 내용은 [Aggregate Clause](../../visual-basic/language-reference/queries/aggregate-clause.md)를 참조하세요.  

...
-   추가 버전을 정의하는 대신 기본 클래스 멤버를 바꾸려는 경우 `Overloads` 대신 [Overrides](../../visual-basic/language-reference/modifiers/overrides.md) 키워드를 사용합니다.  
  
-   기본 클래스 멤버를 파생 클래스의 새 멤버로 숨기려면 `Overloads` 대신 [Shadows](../../visual-basic/language-reference/modifiers/shadows.md) 키워드를 사용합니다.  

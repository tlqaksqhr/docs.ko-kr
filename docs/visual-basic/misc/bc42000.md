...
---
# <a name="lttypegt-39ltmethodnamegt39-conflicts-with-other-members-of-the-same-name-across-the-inheritance-hierarchy-and-so-should-be-declared-39shadows39"></a>&lt;형식&gt; '&lt;methodname&gt;' 상속 계층 구조 등에서 이름이 같은 다른 멤버와 충돌에서 'Shadows'로 선언 해야

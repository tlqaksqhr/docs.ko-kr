...
`<type1>`에서는 '`<type2>`'에서 '`Option Strict On`'으로 암시적으로 변환할 수 없습니다. Visual Basic 6.0의 컬렉션 형식은 [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort_md.md)]의 컬렉션 형식과 호환되지 않습니다.  
  
 Visual Basic 6.0에서 사용되는 컬렉션 개체는 [!INCLUDE[vs_current_long](../../csharp/misc/includes/vs_current_long_md.md)]에서 사용되는 컬렉션 개체와 다릅니다.  

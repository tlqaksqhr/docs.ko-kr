---
title: "Visual Basic 언어 연습 | Microsoft 문서"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
연습에서는 일반 시나리오에 대한 단계별 지침을 제공하므로 제품 또는 특정 기능 영역 파악을 효율적으로 시작할 수 있습니다.  
 ...
 [!INCLUDE[vbprvb](../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서 인터페이스를 선언 및 구현하는 방법을 보여 줍니다.  
 ...
 COM 클래스 템플릿을 사용하거나 사용하지 않고 [!INCLUDE[vbprvb](../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서 COM 개체를 만드는 방법을 보여 줍니다.  
  
 [COM 개체를 사용한 상속 구현](../visual-basic/programming-guide/com-interop/walkthrough-implementing-inheritance-with-com-objects.md)  
 [!INCLUDE[vbprvb](../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 6.0을 사용하여 클래스가 포함된 COM 개체를 만든 다음 [!INCLUDE[vbprvb](../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]의 기본 클래스로 사용하는 방법을 보여 줍니다.  

...
## <a name="in-this-section"></a>섹션 내용  
 ...
 사용자 지정을 게시 하는 방법에 설명 `My` Visual Studio 템플릿을 사용 하 여 네임 스페이스 확장 합니다.  
 ...
 멤버를 재정의 하 여 응용 프로그램 모델에 고유한 확장을 지정 하는 방법에 설명 된 <xref:Microsoft.VisualBasic.ApplicationServices.WindowsFormsApplicationBase> 클래스입니다.  
 ...
 제어 하는 방법에 설명 `My` 개체는 프로젝트의 _MYTYPE 조건부 컴파일 상수를 설정 하 여 활성화 되어 있습니다.  
  
## <a name="related-sections"></a>관련 단원  
 [My를 사용한 개발](../../../visual-basic/developing-apps/development-with-my/index.md)  
 에 대해 설명 합니다 `My` 기본적으로 서로 다른 프로젝트 형식에서 사용할 수 있는 개체입니다.  
 ...
 컴파일러는 컴파일 및 다른 섹션을 제외 하는 코드의 특정 섹션을 선택 하려면 조건부 컴파일을 사용 하는 방법에 대해 설명 합니다.  
  
 <xref:Microsoft.VisualBasic.ApplicationServices.ApplicationBase>  
 설명의 `My` 현재 응용 프로그램에 관련 된 속성, 메서드 및 이벤트를 제공 하는 개체입니다.  

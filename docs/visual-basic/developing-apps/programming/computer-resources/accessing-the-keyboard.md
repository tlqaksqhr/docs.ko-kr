---
title: "키보드에 액세스(Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
|응용 프로그램 시작 및 키 입력 보내기|[방법: 응용 프로그램 시작 및 키 입력 보내기(Visual Basic)](../../../../visual-basic/developing-apps/programming/computer-resources/how-to-start-an-application-and-send-it-keystrokes.md)|  

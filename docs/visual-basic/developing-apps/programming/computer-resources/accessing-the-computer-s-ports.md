...
## 단원 내용  
 ...
 포트 작업을 수행할 때 [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)]를 사용하는 방법을 설명합니다.  
...
## 참조  
 ...
 컴퓨터의 직렬 포트 이름 컬렉션을 가져오는 `SerialPortNames` 속성을 설명합니다.  

...
`My.Computer` 개체는 `My`에 있는 세 가지 중앙 개체 중 하나이며 정보 및 일반적으로 사용되는 기능에 대한 액세스를 제공합니다.  `My.Computer`는 응용 프로그램이 실행 중인 컴퓨터에 액세스할 수 있는 메서드, 속성 및 이벤트를 제공합니다.  이러한 개체는 다음과 같습니다.  
...
## 단원 내용  
 ...
 배경에서 소리 재생과 같은 `My.Computer.Audio` 관련 작업을 보여 줍니다.  
 ...
 클립보드에서 데이터 읽기, 클립보드에 데이터 쓰기 등과 같은 `My.Computer.Clipboard` 관련 작업을 보여 줍니다.  
 ...
 파일 업로드 또는 다운로드와 같은 `My.Computer.Network` 관련 작업을 보여 줍니다.  
 ...
 사용 가능한 직렬 포트 표시, 직렬 포트에 문자열 보내기 등과 같은 `My.Computer.Ports` 관련 작업을 보여 줍니다.  
  
 [Reading from and Writing to the Registry](../../../../visual-basic/developing-apps/programming/computer-resources/reading-from-and-writing-to-the-registry.md)  
 레지스트리 키에서 데이터 읽기 또는 레지스트리 키에 데이터 쓰기와 같은 `My.Computer.Registry` 관련 작업을 보여 줍니다.
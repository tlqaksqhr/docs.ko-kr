---
title: "방법: Visual Basic에서 StreamWriter를 사용하여 파일에 텍스트 쓰기 | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
이 예제에서는 `My.Computer.FileSystem.OpenTextFileWriter` 메서드로 <xref:System.IO.StreamWriter> 개체를 열고, 이 개체를 사용하여 <xref:System.IO.StreamWriter> 클래스의 <xref:System.IO.TextWriter.WriteLine%2A> 메서드로 텍스트 파일에 문자열을 씁니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [방법: 텍스트 파일 읽기](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-text-files.md)   

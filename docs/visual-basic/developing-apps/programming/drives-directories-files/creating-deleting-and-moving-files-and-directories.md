...
이 단원에서는 Visual Basic에서 파일과 디렉터리의 생성, 삭제, 이동 및 이름 바꾸기와 관련된 작업을 나열합니다.  
...
## 단원 내용  
 ...
 .txt 파일만 디렉터리에 복사하는 경우와 같이 특정 파일 이름 패턴을 가진 파일을 복사하는 방법을 보여 줍니다.  
 ...
 이름에 특정한 패턴이 있는 디렉터리를 나열하는 방법을 보여 줍니다.  
  
 [How to: Get the Collection of Files in a Directory](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-get-the-collection-of-files-in-a-directory.md)  
 디렉터리의 파일을 나열하는 방법을 보여 줍니다.  

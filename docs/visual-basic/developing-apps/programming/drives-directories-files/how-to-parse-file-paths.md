...
-   <xref:Microsoft.VisualBasic.FileIO.FileSystem.GetParentPath%2A> 메서드는 제공된 경로보다 상위에 있는 절대 경로를 반환합니다.  
...
-   <xref:System.IO.FileInfo> 개체의 <xref:System.IO.FileInfo.DirectoryName%2A> 및 <xref:System.IO.FileInfo.Name%2A> 속성을 사용하여 파일의 이름 및 경로를 확인합니다. 이 예제에서는 이름과 경로를 확인하고 이를 표시합니다.  

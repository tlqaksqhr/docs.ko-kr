...
이 단원에서는 파일 읽기와에서 관련 된 작업을 수행 하는 방법을 설명 합니다.  
  
## 단원 내용  
 [How to: Read from Text Files](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-text-files.md)  
 텍스트 파일을 읽는 방법을 보여 줍니다.  
  
 [How to: Read From Comma\-Delimited Text Files](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-comma-delimited-text-files.md)  
 구분된 텍스트 파일을 읽는 방법을 보여 줍니다.  
  
 [How to: Read From Fixed\-width Text Files](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-fixed-width-text-files.md)  
 고정 너비 텍스트 파일을 읽는 방법을 보여 줍니다.  
  
 [How to: Read From Text Files with Multiple Formats](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-text-files-with-multiple-formats.md)  
 여러 형식의 텍스트 파일을 읽는 방법을 보여 줍니다.  
 ...
 <xref:System.IO.StreamReader>를 사용하여 파일을 읽는 방법을 보여 줍니다.  
...
## 관련 단원  
 ...
 에 연결 된 작업을 수행 하는 방법을 설명 합니다 `My.Computer.Clipboard`, 데이터 읽기 또는 데이터를 클립보드에 기록 합니다.  
  
 [Parsing Text Files with the TextFieldParser Object](../../../../visual-basic/developing-apps/programming/drives-directories-files/parsing-text-files-with-the-textfieldparser-object.md)  
 `TextFieldParser` 개체를 사용하여 텍스트 파일을 읽는 방법을 개략적으로 설명합니다.  
  
 [Walkthrough: Manipulating Files and Directories in Visual Basic](../../../../visual-basic/developing-apps/programming/drives-directories-files/walkthrough-manipulating-files-and-directories.md)  
 파일 및 디렉터리에 `My` 기능을 사용하는 방법을 보여 줍니다.  
 ...
 파일 및 디렉터리에 [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort-md.md)] 메서드를 사용하는 방법을 보여 줍니다.
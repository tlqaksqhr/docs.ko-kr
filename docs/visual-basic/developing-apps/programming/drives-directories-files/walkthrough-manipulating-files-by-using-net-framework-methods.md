...
## 응용 프로그램 만들기  
 [!INCLUDE[vsprvs](../../../../csharp/includes/vsprvs_md.md)]를 시작하고 사용자가 지정된 파일에 쓰는 데 사용할 수 있는 폼을 만들어 프로젝트를 시작합니다.  
...
3.  **이름** 상자에 `MyDiary`를 입력하고 **확인**을 클릭합니다.  
     ...
     프로젝트가 [!INCLUDE[vsprvs](../../../../csharp/includes/vsprvs_md.md)] **솔루션 탐색기**에 추가되고 **Windows Forms 디자이너**가 열립니다.  

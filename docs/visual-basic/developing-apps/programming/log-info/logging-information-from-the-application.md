...
|응용 프로그램이 시작될 때와 종료될 때 추적 정보를 응용 프로그램의 로그에 씁니다.|[방법: 응용 프로그램이 시작 또는 종료될 때 메시지 기록](../../../../visual-basic/developing-apps/programming/log-info/how-to-log-messages-when-the-application-starts-or-shuts-down.md)|  
...
|`My.Application.Log`에 대한 사용자 지정 로그 수신기를 만듭니다.|[Walkthrough: Creating Custom Log Listeners](../../../../visual-basic/developing-apps/programming/log-info/walkthrough-creating-custom-log-listeners.md)|  

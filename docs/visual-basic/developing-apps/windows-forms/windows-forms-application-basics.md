...
-   [Windows Forms 시작](https://msdn.microsoft.com/library/ms229601.aspx)합니다. 만들고 Windows Forms 프로그래밍 방법에 대 한 정보를 제공 합니다.  
...
### <a name="events"></a>이벤트  
 사용자가 폼 이나 컨트롤 중 하나, 이벤트를 생성 합니다. 응용 프로그램은 코드를 사용하여 이러한 이벤트에 대응하고, 발생 시 이벤트를 처리합니다. 자세한 내용은 [Windows Forms에서 이벤트 처리기 만들기](https://msdn.microsoft.com/library/dacysss4.aspx)를 참조하세요.  
  
### <a name="controls"></a>컨트롤  
 다양 한 폼에 배치할 수 있는 컨트롤을 포함 하는 Windows Forms: 텍스트 상자, 단추, 드롭다운 상자, 라디오 단추 및 웹 페이지를 표시 하는 컨트롤입니다. 폼에서 사용할 수 있는 모든 컨트롤의 목록은 [Windows Forms에서 사용할 수 있는 컨트롤](https://msdn.microsoft.com/library/3xdhey7w.aspx)을 참조하세요. 기존 컨트롤이 요구를 충족하지 않는 경우 Windows Forms에서 <xref:System.Windows.Forms.UserControl> 클래스를 사용하여 고유한 사용자 지정 컨트롤을 만들 수도 있습니다.  
...
|사용 하 여 그래픽 만들기<xref:System.Drawing>|[그래픽 프로그래밍 시작](https://msdn.microsoft.com/library/da0f23z7.aspx)|  
...
|후|참조|  
|--------|---------|  
|사용 하 여 <xref:System.Windows.Forms.BindingSource> 구성 요소|[방법: 디자이너를 사용하여 Windows Forms 컨트롤에 BindingSource 구성 요소 바인딩](https://msdn.microsoft.com/library/801dxw2t.aspx)|  
...
|후|참조|  
|--------|---------|  
|폼의 내용을 인쇄합니다|[방법: Windows Forms의 그래픽 인쇄](https://msdn.microsoft.com/library/741a0ktc.aspx)<br /><br /> [방법: Windows Forms에서 다중 페이지 텍스트 파일 인쇄](https://msdn.microsoft.com/library/cwbe712d.aspx)|   
|Windows Forms 보안에 대한 자세한 정보|[Windows Forms의 보안 개요](https://msdn.microsoft.com/library/90k49ccb.aspx)|  

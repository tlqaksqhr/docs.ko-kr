...
## <a name="in-this-section"></a>섹션 내용  
 ...
 `DataRepeater` 컨트롤을 사용하여 데이터 소스에서 데이터를 표시하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤을 사용하여 추가 데이터를 표시하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤의 방향을 변경하는 방법을 보여 줍니다.  
 ...
 디자인 타임 및 런타임에 `DataRepeater` 컨트롤을 사용자 지정하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤에서 선택 표시기를 제어하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤에서 사용자가 항목을 추가 또는 삭제하는 것을 방지하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤에서 검색 기능을 구현하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤 두 개를 사용하여 관련 레코드를 표시하는 방법을 보여 줍니다.  
 ...
 `DataRepeater` 컨트롤을 사용하는 방법에 대한 시작 후 완료 데모를 제공합니다.  

---
title: "Visual Basic을 사용한 응용 프로그램 개발 | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
...
dev_langs: 
  - "VB"
helpviewer_keywords: 
  - "Visual Basic, 응용 프로그램 개발"
  - "응용 프로그램[Visual Basic]"
...
---
# Visual Basic을 사용한 응용 프로그램 개발
[!INCLUDE[vs2017banner](../../visual-basic/developing-apps/includes/vs2017banner.md)]

이 단원에는 Visual Basic 언어에 대한 개념 설명서가 포함되어 있습니다.  
 ...
 **Intellisense 코드 조각**, **프로젝트 속성**, Visual Basic용 XML 문서 만들기 등과 같은 Visual Basic 편집기의 기능에 대한 도움말이 포함되어 있습니다.  
 ...
 *구성 요소*라는 용어를 정의하고 구성 요소를 만드는 방법과 시기에 대해 설명합니다.  
 ...
 프로젝트 템플릿을 사용자 지정하여 추가적인 `My` 개체를 제공할 수 있는 방법에 대해 설명합니다.  
  
## 관련 단원  
 [Visual Basic Programming Guide](../../visual-basic/programming-guide/index.md)  
 Visual Basic의 필수 프로그래밍 요소에 대해 설명합니다.  
  
 [Visual Basic Language Reference](../../visual-basic/language-reference/index.md)  
 Visual Basic 언어에 대한 참조 설명서가 포함되어 있습니다.
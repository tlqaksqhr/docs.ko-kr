 ...
 *구성 요소*라는 용어를 정의하고 구성 요소를 만드는 방법과 시기에 대해 설명합니다.  
 ...
 인쇄 및 보고와 관련된 개요를 제공하고 관련 설명서에 대한 링크를 제공합니다.  
  
 [Windows Forms 응용 프로그램의 기본 사항](../../visual-basic/developing-apps/windows-forms/windows-forms-application-basics.md)  
 Visual Studio를 사용하여 Windows Forms 응용 프로그램을 만드는 방법에 대한 정보를 제공합니다.  
  
 [프로젝트 사용자 지정 및 My 확장](../../visual-basic/developing-apps/customizing-extending-my/customizing-projects-and-extending-my.md)  

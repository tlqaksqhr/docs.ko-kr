...
|`My.WebServices`|**예**|**예**|**예**|**예**|**예**|**예**|아니요|아니요|  
 ...
 <sup>1</sup> `My.Application`의 Windows Forms 버전입니다.  콘솔 버전에서 파생됩니다\(참고 3 참조\). 응용 프로그램의 창과 상호 작용할 수 있도록 지원하고 [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 응용 프로그램 모델을 제공합니다.  

...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]인쇄 및 보고에 대 한 여러 옵션을 제공 합니다. 다음 항목에서는 개요 및 인쇄 및 보고와 관련 된 문서에 대 한 링크를 제공 합니다.  
  
## <a name="in-this-section"></a>단원 내용  
 [PrintForm 구성 요소](../../../visual-basic/developing-apps/printing/printform-component.md)  
 개략적으로 `PrintForm` 구성 요소로 폼의 내용을 인쇄할 수 있습니다.  
  
 [방법: 스크롤 가능 폼 인쇄](../../../visual-basic/developing-apps/printing/how-to-print-a-scrollable-form.md)  
 사용 하 여 스크롤 가능한 폼을 인쇄 하는 방법에 설명 된 `PrintForm` 구성 요소입니다.  
 ...
 사용 하 여 폼의 클라이언트와 비클라이언트 영역 인쇄 하는 방법에 설명 된 `PrintForm` 구성 요소입니다.  
  
 [방법: 폼의 클라이언트 영역 인쇄](../../../visual-basic/developing-apps/printing/how-to-print-the-client-area-of-a-form.md)  
 사용 하 여 폼의 클라이언트 영역 인쇄 하는 방법에 설명 된 `PrintForm` 구성 요소입니다.  
 ...
 사용 하 여 기본 폼을 인쇄 하는 방법에 설명 된 `PrintForm` 구성 요소입니다.  
 ...
 배포 하는 방법에 설명 된 `PrintForm` 는 응용 프로그램과 함께 구성 요소입니다.  

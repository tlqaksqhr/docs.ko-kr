...
## <a name="in-this-section"></a>섹션 내용  
 ...
 사용 하 여 폼의 클라이언트와 비클라이언트 영역을 인쇄 하는 방법에 설명 된 `PrintForm` 구성 요소입니다.  
  
 [방법: 폼의 클라이언트 영역 인쇄](../../../visual-basic/developing-apps/printing/how-to-print-the-client-area-of-a-form.md)  
 사용 하 여 폼의 클라이언트 영역을 인쇄 하는 방법에 설명 된 `PrintForm` 구성 요소입니다.  
 ...
 배포 하는 방법에 설명 된 `PrintForm` 응용 프로그램과 함께 구성 요소입니다.  
 ...
 보고서를 작성 하기 위한 사용할 수 있는 옵션에 설명 합니다.

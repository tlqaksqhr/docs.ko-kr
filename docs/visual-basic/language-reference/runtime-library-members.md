...
`Microsoft.VisualBasic` 네임스페이스에는 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 런타임 라이브러리를 구성하는 클래스, 모듈, 상수 및 열거형이 들어 있습니다.  이러한 라이브러리 멤버는 코드에 사용할 수 있는 프로시저, 속성 및 상수 값을 제공합니다.  각 모듈 및 클래스는 특정한 기능 범주를 나타냅니다.  
  
## Microsoft.VisualBasic.Collection 클래스  
...
## Microsoft.VisualBasic.ComClassAttribute 클래스  
...
## Microsoft.VisualBasic.ControlChars 클래스  
...
## Microsoft.VisualBasic.Constants 클래스  
...
## Microsoft.VisualBasic.Conversion 모듈  
...
## Microsoft.VisualBasic.DateAndTime 모듈  
...
## Microsoft.VisualBasic.ErrObject 클래스  
...
## Microsoft.VisualBasic.FileSystem 모듈  
...
## Microsoft.VisualBasic.Financial 모듈  
...
## Microsoft.VisualBasic.Globals 모듈  
...
## Microsoft.VisualBasic.HideModuleNameAttribute 클래스  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## Microsoft.VisualBasic.Information 모듈  
...
## Microsoft.VisualBasic.Interaction 모듈  
...
## Microsoft.VisualBasic.MyGroupCollectionAttribute 클래스  
...
## Microsoft.VisualBasic.Strings 모듈  
...
## Microsoft.VisualBasic.VBFixedArrayAttribute 클래스  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## Microsoft.VisualBasic.VBFixedStringAttribute 클래스  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## Microsoft.VisualBasic.VbMath 모듈  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## Microsoft.VisualBasic 상수 및 열거형  
 `Microsoft.VisualBasic` 네임스페이스는 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 런타임 라이브러리의 일부로 상수와 열거형을 제공합니다.  코드에 이러한 상수 값을 사용할 수 있습니다.  각 열거형은 특정한 기능 범주를 나타냅니다.  자세한 내용은 [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md)를 참조하십시오.  

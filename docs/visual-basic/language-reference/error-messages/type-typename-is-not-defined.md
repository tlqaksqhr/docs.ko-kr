...
-   형식이 정의되었으나 형식이 정의된 개체 라이브러리나 형식 라이브러리가 [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에 등록되지 않은 경우 **프로젝트** 메뉴에서 **참조 추가**를 클릭한 다음 알맞은 개체 라이브러리나 형식 라이브러리를 선택합니다.  

---
title: "리소스 파일을 포함할 수 없습니다. &quot;&lt;filename&gt;&quot;: &lt;오류 메시지&gt; | Microsoft 문서"
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
ms.suite: 
...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 컴파일러가 어셈블리 링커(Al.exe, Alink라고도 함)를 호출하여 매니페스트를 사용해 어셈블리를 생성합니다. 링커가 네이티브 COM+ 리소스 파일을 어셈블리에 직접 포함하는 동안 오류를 보고했습니다.  

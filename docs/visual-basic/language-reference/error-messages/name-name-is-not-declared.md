...
1.  참조하는 문에 있는 이름의 철자를 확인합니다.  [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서는 대\/소문자를 구분하지 않지만 철자가 다르면 다른 이름으로 간주됩니다.  밑줄\(`_`\)역시 이름에 포함되므로 철자의 일부입니다.  

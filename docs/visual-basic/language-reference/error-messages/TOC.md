...
# ['<typename>' 형식을 포함하는 '<assemblyidentity>' 어셈블리에 대한 참조가 필요하지만 '<projectname1>' 프로젝트와 '<projectname2>' 프로젝트 간의 모호성으로 인해 적합한 참조를 찾을 수 없습니다.](reference-required-to-assembly-containing-type-but-suitable-reference-not-found.md)

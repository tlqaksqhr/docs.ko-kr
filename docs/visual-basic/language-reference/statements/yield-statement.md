...
|용어|정의|  
|---|---|  
|`expression`|필수 요소. 반복기 함수 형식으로 암시적으로 변환 될 수 있는 식 또는 `Get` 접근자를 포함 하는 `Yield` 문.|  
...
-   포함할 수 없다는 것 `ByRef` 매개 변수입니다.  
 ...
 반복기 함수는 익명 함수를 수 있습니다. 자세한 내용은 [반복기](http://msdn.microsoft.com/library/f45331db-d595-46ec-9142-551d3d1eb1a7)를 참조하세요.  

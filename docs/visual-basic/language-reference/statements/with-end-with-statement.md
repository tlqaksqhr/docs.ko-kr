...
|`statements`|선택 사항  `objectExpression`의 평가를 통해 생성된 개체의 멤버를 참조할 수 있는 `With`와 `End With` 사이의 하나 이상의 문입니다.|  
...
-   반복적인 정규화 식을 제거하여 코드를 더욱 쉽게 읽을 수 있습니다.  
 ...
 `objectExpression`은 블록에 삽입될 때 한번 평가됩니다.  `With` 블록 내에서 `objectExpression`을 다시 할당할 수 없습니다.  
 ...
 블록에 루프가 없으면 문이 한 번만 실행됩니다.  다른 종류의 제어 구조를 중첩할 수 있습니다.  자세한 내용은 [Nested Control Structures](../../../visual-basic/programming-guide/language-features/control-flow/nested-control-structures.md)을 참조하십시오.  
  
> [!NOTE]
>  개체 이니셜라이저에서도 `With` 키워드를 사용할 수 있습니다.  자세한 내용 및 예제를 보려면 [Object Initializers: Named and Anonymous Types](../../../visual-basic/programming-guide/language-features/objects-and-classes/object-initializers-named-and-anonymous-types.md) 및 [Anonymous Types](../../../visual-basic/programming-guide/language-features/objects-and-classes/anonymous-types.md)을 참조하십시오.  
>   

...
## <a name="remarks"></a>설명  
 메서드 및 속성에 대 한 내용은 `My.Computer.Keyword` 개체, 참조 <xref:Microsoft.VisualBasic.Devices.Keyboard>합니다.  
  
 자세한 내용은 [키보드에 액세스](../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-keyboard.md)를 참조하세요.  

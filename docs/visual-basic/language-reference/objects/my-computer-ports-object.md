...
## <a name="remarks"></a>설명  
 메서드 및 속성에 대 한 내용은 `My.Computer.Ports` 개체, 참조 <xref:Microsoft.VisualBasic.Devices.Ports>합니다.  
...
> [!NOTE]
>  메서드와 속성을 사용할 수도 있습니다는 <xref:System.IO.Ports.SerialPort?displayProperty=nameWithType> 컴퓨터의 직렬 포트에 액세스할 수 있도록 클래스입니다.  

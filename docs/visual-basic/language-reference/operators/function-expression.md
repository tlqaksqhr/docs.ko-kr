...
## 예제  
 람다 식은 [!INCLUDE[vbteclinqext](../../../csharp/getting-started/includes/vbteclinqext_md.md)]의 여러 쿼리 연산자의 기반이 되며 메서드 기반 쿼리에서 명시적으로 사용할 수 있습니다.  다음 예제에서는 일반적인 [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq_md.md)] 쿼리와 이 쿼리를 메서드 형식으로 변환한 코드를 보여 줍니다.  

...
|문자열을 반대로 바꿉니다.|<xref:Microsoft.VisualBasic.Strings.InStrRev%2A>, <xref:Microsoft.VisualBasic.Strings.StrReverse%2A>|  
|대 / 소문자를 변환 합니다.|<xref:Microsoft.VisualBasic.Strings.Format%2A>, <xref:Microsoft.VisualBasic.Strings.LCase%2A>, <xref:Microsoft.VisualBasic.Strings.UCase%2A>|  
|반복 되는 문자가의 문자열을 만듭니다.|<xref:Microsoft.VisualBasic.Strings.Space%2A>, <xref:Microsoft.VisualBasic.Strings.StrDup%2A>|  
|문자열의 길이 확인 합니다.|<xref:Microsoft.VisualBasic.Strings.Len%2A>|  
...
|ASCII 및 ANSI 값으로 작업 합니다.|<xref:Microsoft.VisualBasic.Strings.Asc%2A>, <xref:Microsoft.VisualBasic.Strings.AscW%2A>, <xref:Microsoft.VisualBasic.Strings.Chr%2A>, <xref:Microsoft.VisualBasic.Strings.ChrW%2A>|  
|지정된 된 부분 문자열을 대체 합니다.|<xref:Microsoft.VisualBasic.Strings.Replace%2A>|  
|필터 기반 문자열 배열을 반환 합니다.|<xref:Microsoft.VisualBasic.Strings.Filter%2A>|  
|부분 문자열의 지정 된 수를 반환 합니다.|<xref:Microsoft.VisualBasic.Strings.Split%2A>, <xref:Microsoft.VisualBasic.Strings.Join%2A>|  

...
|작업|언어 요소|  
|------------|----------------------|  
|ANSI 값을 문자열로 변환 합니다.|<xref:Microsoft.VisualBasic.Strings.Chr%2A>, <xref:Microsoft.VisualBasic.Strings.ChrW%2A>|  
|문자열을 소문자 또는 대문자로 변환 합니다.|<xref:Microsoft.VisualBasic.Strings.Format%2A>, <xref:Microsoft.VisualBasic.Strings.LCase%2A>,<xref:Microsoft.VisualBasic.Strings.UCase%2A>|  

...
|작업|언어 요소|  
|------------|----------------------|  
|값을 할당 합니다.|[가져오기](../../../visual-basic/language-reference/statements/get-statement.md), [속성](../../../visual-basic/language-reference/statements/property-statement.md)|  
...
|명시적 변수 선언이 필요 합니다.|[Option Explicit](../../../visual-basic/language-reference/statements/option-explicit-statement.md), [Strict 옵션](../../../visual-basic/language-reference/statements/option-strict-statement.md)|  

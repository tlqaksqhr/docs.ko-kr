...
## 설명  
 ...
 [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort_md.md)] 리소스 파일을 참조하려면 [\/linkresource](../../../visual-basic/reference/command-line-compiler/linkresource.md)를 참조하고, [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort_md.md)] 리소스 파일을 연결하려면 [\/resource](../../../visual-basic/reference/command-line-compiler/resource.md)를 참조하십시오.  

...
```  
 ...
 Visual Basic에서 Vbc.exe 파일과 동일한 디렉터리에 있는 Vbc.rsp 파일을 제공 합니다. Vbc.rsp 파일은 않는 한 기본적으로 포함 된 `/noconfig` 옵션을 사용 합니다. 자세한 내용은 참조 [/noconfig](../../../visual-basic/reference/command-line-compiler/noconfig.md)합니다.  

...
|`identifier`|선택 사항입니다. 리소스에 대 한 논리적 이름 로드 하는 데 사용 하는 이름입니다. 기본값은 파일 이름입니다. 리소스 인지 공개 또는 개인 어셈블리 매니페스트에 다음와 같이 지정할 수 있습니다: `/res:``filename.res`,`myname.res`,`public`|  

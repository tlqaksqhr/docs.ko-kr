...
|용어|정의|  
|--------|--------|  
|[Visual Basic 언어](http://go.microsoft.com/fwlink/?LinkId=145963)|[!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 언어 구문 및 컴파일러에 대해 설명합니다.|  
|[Visual Basic Interop 및 업그레이드](http://go.microsoft.com/fwlink/?LinkId=145966)|[!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]으로 업그레이드하고 상호 운용성 기능을 사용하는 방법에 대해 설명합니다.|  
|[Visual Basic IDE](http://go.microsoft.com/fwlink/?LinkId=145971)|[!INCLUDE[vsprvs](../../csharp/includes/vsprvs_md.md)] 통합 개발 환경에서 작업하는 방법에 대해 설명합니다.|  

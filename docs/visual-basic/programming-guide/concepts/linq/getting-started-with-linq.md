...
## <a name="related-sections"></a>관련 단원  
 ...
 Visual Basic에서는 LINQ to XML 지원 하는 방법을 설명 합니다.  
 ...
 디자인, 코딩 및 LINQ 사용 응용 프로그램 디버깅에 대 한 Visual Studio 환경에서 사용할 수 있는 도구에 설명 합니다.  

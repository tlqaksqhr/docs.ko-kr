...
## <a name="differences-between-xpath-and-linq-to-xml"></a>XPath와 LINQ to XML의 차이점  
 ...
 XPath 식은 문자열 내에 분리되어 존재합니다. Visual Basic 컴파일러는 컴파일 타임에 XPath 식을 구문 분석할 수 없습니다. 반면, [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] 쿼리 구문 분석 되 고 theVisual 기본 컴파일러에 의해 컴파일됩니다. 컴파일러에서는 많은 쿼리 오류를 catch할 수 있습니다.  

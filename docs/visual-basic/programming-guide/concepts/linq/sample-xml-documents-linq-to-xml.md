...
다음 예제 파일 코드 샘플 및 전체에서 코드 조각에 사용 되는 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] 설명서입니다.  
...
|[샘플 XSD 파일: Customers 및 Orders](../../../../visual-basic/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders.md)|Xml XSD (스키마 정의) 유효성을 검사 하는 [샘플 XML 파일: Customers 및 Orders (LINQ to XML)](http://msdn.microsoft.com/library/26790c41-5976-4558-a096-d0f67bfc4d92)합니다.|  

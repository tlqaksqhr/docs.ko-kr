...
이 항목의 코드는 `Student` 클래스를 정의하고 클래스의 인스턴스 목록을 만듭니다.  이 목록은 [연습: Visual Basic에서 쿼리 작성](../../../../visual-basic/programming-guide/concepts/linq/walkthrough-writing-queries.md) 항목을 지원하도록 설계되었습니다.  또한 개체 목록이 필요한 모든 응용 프로그램에도 사용할 수 있습니다.  코드는 개체 이니셜라이저를 사용하여 학생 목록에 항목을 정의합니다.  

...
|[방법: 요소 (LINQ to XML)의 컬렉션을 검색 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-retrieve-a-collection-of-elements-linq-to-xml.md)|<xref:System.Xml.Linq.XContainer.Elements%2A> 메서드에 대해 소개합니다. 이 메서드는 요소의 자식 요소 컬렉션을 검색합니다.|  
...
|[방법: 특성 (LINQ to XML)의 컬렉션을 검색 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-retrieve-a-collection-of-attributes-linq-to-xml.md)|<xref:System.Xml.Linq.XElement.Attributes%2A> 메서드에 대해 소개합니다. 이 메서드는 요소의 특성을 검색합니다.|  
...
|[방법: 검색 (LINQ to XML) 특성의 값 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-retrieve-the-value-of-an-attribute-linq-to-xml.md)|특성의 값을 가져오는 방법을 보여 줍니다.|  
...
|[Visual Basic (LINQ to XML)의 언어 통합 축](../../../../visual-basic/programming-guide/concepts/linq/language-integrated-axes.md)|Visual Basic 통합 축에 요약 되어 있습니다.|  

...
|[LINQ to XML과 DOM (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-vs-dom.md)|LINQ to XML을 DOM(문서 개체 모델)과 비교합니다.|  
|[LINQ to XML과 기타 XML 기술 비교](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-vs-other-xml-technologies.md)|LINQ to XML을 XmlReader, XSLT, MSXML, XmlLite 등의 다른 XML 구문 분석 및 조작 기술과 비교합니다.|  

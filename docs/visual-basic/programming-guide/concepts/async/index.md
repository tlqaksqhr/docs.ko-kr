...
-   <xref:Windows.Foundation.IAsyncOperationWithProgress%602>  
 ...
 자세한 내용 및 예제에 대 한 참조 [C# 또는 Visual Basic의 비동기 Api 호출](/windows/uwp/threading-async/call-asynchronous-apis-in-csharp-or-visual-basic)합니다.  

...
> [!NOTE]
>  XML to Schema 마법사를 실행하기 전에 마법사에서 이전에 생성한 기존 XSD 파일을 프로젝트에서 제거하는 것이 좋습니다.  기존 스키마 집합과 일치하는 XML 스키마 집합을 유추하는 경우 충돌이 발생할 수 있으며 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서 XML 속성에 대한 IntelliSense를 제공할 수 없습니다.  

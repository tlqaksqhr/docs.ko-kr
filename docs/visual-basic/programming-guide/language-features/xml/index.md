...
|항목|설명|  
|-----------|-----------------|  
|[Visual Basic의 LINQ to XML 개요](../../../../visual-basic/programming-guide/language-features/xml/overview-of-linq-to-xml.md)|Visual Basic에서 지 원하는 방법에 대해 설명 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)]합니다.|  

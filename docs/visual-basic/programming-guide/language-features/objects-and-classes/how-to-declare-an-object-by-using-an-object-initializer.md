...
개체 이니셜라이저를 사용하여 단일 문에서 클래스의 인스턴스를 선언하고 인스턴스화할 수 있습니다.  또한 매개 변수화된 생성자를 호출하지 않고 동시에 하나 이상의 인스턴스 멤버를 초기화할 수 있습니다.  
 ...
 `Student` 클래스의 구현은 [How to: Create a List of Items](../Topic/How%20to:%20Create%20a%20List%20of%20Items.md)를 참조하십시오.  해당 항목에서 코드를 복사하여 클래스를 설정하고 작업할 `Student` 개체의 목록을 만들 수 있습니다.  

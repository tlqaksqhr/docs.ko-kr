...
2.  Windows 응용 프로그램의 목록에서 선택 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 프로젝트 새 프로젝트를 표시 하는 템플릿.  
...
5.  클래스의 새 이름을 `UserNameInfo.vb`, 클릭 하 고 **추가** 새 클래스에 대 한 코드를 표시 합니다.  
    ...
    > [!NOTE]
    >  사용할 수 있습니다는 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] **코드 편집기** 시작 폼에 입력 하 여 클래스를 추가 하는 `Class` 키워드 다음 새 클래스의 이름을 입력 합니다. **코드 편집기** 해당 제공 `End Class` 문이 있습니다.  

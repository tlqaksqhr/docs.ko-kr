...
-   다중 상속을 허용하는 언어와 달리 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 클래스의 단일 상속만 허용합니다. 즉, 파생 클래스는 하나의 기본 클래스만 가질 수 있습니다.  클래스에서는 다중 상속이 허용되지 않지만 같은 결과를 효과적으로 얻을 수 있도록 여러 인터페이스를 구현할 수 있습니다.  
...
## 상속 한정자  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 클래스에 다음과 같은 클래스 수준 문과 한정자를 제공하여 상속을 지원합니다.  

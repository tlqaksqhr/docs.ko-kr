...
## 마스킹 언어 설명  
 표준 <xref:System.Windows.Forms.MaskedTextBox> 마스킹 언어는 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 6.0의 `Masked Edit` 컨트롤에서 사용하는 마스킹 언어를 기반으로 하며 해당 플랫폼에서 마이그레이션하는 사용자는 이러한 마스킹 언어에 익숙해야 합니다.  

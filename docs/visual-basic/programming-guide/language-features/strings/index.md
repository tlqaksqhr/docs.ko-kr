...
이 단원에서는 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서의 문자열 사용에 대한 기본 개념을 설명합니다.  
  
## 단원 내용  
 [Introduction to Strings in Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/introduction-to-strings.md)  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서 문자열을 사용하는 데 필요한 기본 개념을 설명하는 항목을 나열합니다.  
 ...
 문자열을 다른 데이터 형식으로 변환하는 방법에 대해 설명하는 항목을 나열합니다.  
  
 [Validating Strings in Visual Basic](../../../../visual-basic/programming-guide/language-features/strings/validating-strings.md)  
 문자열 유효성 검사 방법에 대해 설명하는 항목을 나열합니다.  
 ...
 암호화 및 암호화 서비스 공급자 버전 3 중 데이터 암호화 표준 알고리즘을 사용 하 여 문자열을 해독 하는 방법을 보여 줍니다.  

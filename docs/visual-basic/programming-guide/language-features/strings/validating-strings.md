...
이 단원에서는 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서 문자열의 유효성을 검사하는 방법을 설명합니다.  
...
## 단원 내용  
 ...
 문자열이 파일 이름을 나타내는지, 아니면 경로를 나타내는지를 확인하는 방법을 설명합니다.  
 ...
 문자열이 올바른 날짜를 나타내는지 여부를 확인하는 방법을 설명합니다.  
 ...
 <xref:System.Windows.Forms.MaskedTextBox> 컨트롤과 함께 사용할 수 있도록 간단한 정규식을 변환하는 방법을 보여 줍니다.  
 ...
 문자열에 강력한 암호의 특징이 있는지 여부를 확인하는 방법을 설명합니다.  

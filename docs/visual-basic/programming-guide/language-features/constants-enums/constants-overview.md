...
## <a name="how-to-create-and-use-constants"></a>만들기 및 상수를 사용 하는 방법  
 Visual Basic을 인쇄 하 고 표시를 주로 사용 하 여 다양 한 미리 정의 된 상수를 포함 합니다. 사용자 고유의 상수를 만들 수도 있습니다는 `Const` 변수 이름을 만들 때와 동일한 방법을 사용 하 여 문입니다. 경우 `Option Strict` 은 `On`, 상수 형식을 명시적으로 선언 해야 합니다.  
...
|[상수 및 리터럴 데이터 형식](../../../../visual-basic/programming-guide/language-features/constants-enums/constant-and-literal-data-types.md)|Visual Basic 컴파일러를 상수를 초기화 하는 방법에 대해 설명 때 `Option Explicit` 꺼져 있습니다.|  

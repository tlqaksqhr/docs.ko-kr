...
*프로시저*는 선언문\(`Function`, `Sub`, `Operator`, `Get`, `Set`\)과 짝이 되는 `End` 선언 사이에 포함된 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 문 블록입니다.  [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]의 모든 실행문은 일부 프로시저 안에 있어야 합니다.  
...
## 프로시저 유형  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 다음과 같은 여러 유형의 프로시저를 사용합니다.  

...
1.  프로시저 선언에서 인수에 해당하는 매개 변수에 대해 [ByVal](../../../../visual-basic/language-reference/modifiers/byval.md)을 지정합니다.  
     ...
     호출 코드에서 인수 목록의 인수를 괄호로 묶습니다.  이렇게 하면 해당 매개 변수에서 `ByRef`를 지정하더라도 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 인수를 값으로 전달합니다.  

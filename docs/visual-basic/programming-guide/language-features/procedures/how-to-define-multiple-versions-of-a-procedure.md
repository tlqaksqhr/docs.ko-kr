...
3.  각 선언문 뒤에 버전의 매개 변수 목록과 일치하는 인수를 호출 코드에서 제공하는 특별한 경우를 처리하기 위한 프로시저 코드를 작성합니다.  호출 코드에서 제공한 매개 변수를 테스트할 필요는 없습니다.  [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서는 프로시저의 일치하는 버전에 컨트롤을 전달합니다.  

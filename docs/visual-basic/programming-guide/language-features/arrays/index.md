...
##  <a name="BKMK_Collections"></a> 배열의 대안으로 사용되는 컬렉션  
 ...
 배열 크기를 변경해야 하는 경우 [ReDim 문](../../../../visual-basic/language-reference/statements/redim-statement.md)을 사용해야 합니다. 이렇게 하면 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]에서 새 배열을 만들고 이전 배열을 삭제하도록 해제합니다. 이 경우 실행 시간이 걸립니다. 따라서 작업하는 항목 수가 자주 변경되거나 필요한 항목의 최대 개수를 예측할 수 없는 경우 컬렉션을 사용하여 성능을 개선할 수 있습니다.  

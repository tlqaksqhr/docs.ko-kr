 ...
 *Result* \= `CallByName`\(*Object*, *ProcedureName*, *CallType*, *Arguments*\(\)\)  
 ...
 현재 솔루션의 클래스에 `CallByName`을 사용할 수도 있지만 일반적으로 이 함수는 COM 개체 또는 [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)] 어셈블리의 개체에 액세스하는 데 사용됩니다.  

---
title: "인터페이스(Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
|[제네릭 인터페이스의 가변성](http://msdn.microsoft.com/library/e14322da-1db3-42f2-9a67-397daddd6b6a)|제네릭 인터페이스의 공분산 및 반공분산에 대해 설명하고 .NET Framework의 Variant 제네릭 인터페이스의 목록을 제공합니다.|

...
-   *범위* — 요소 이름을 한정하지 않고 이를 참조할 수 있는 모든 코드 집합  자세한 내용은 [How to: Control the Scope of a Variable](../Topic/How%20to:%20Control%20the%20Scope%20of%20a%20Variable%20\(Visual%20Basic\).md)를 참조하십시오.  

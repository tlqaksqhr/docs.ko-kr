...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 루프 구조를 사용하면 한 줄 이상의 코드를 반복해서 실행할 수 있습니다.  조건이 `True` 또는 `False`일 때까지 루프 구조에서 지정된 횟수만큼 또는 컬렉션의 각 요소에 대해 한 번씩 문을 반복할 수 있습니다.  

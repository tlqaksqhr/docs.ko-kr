...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 조건을 테스트하고 테스트 결과에 따라 여러 가지 작업을 수행할 수 있습니다.  조건이 true인지 아니면 false인지 그리고 식의 여러 가지 값을 테스트하거나 문을 실행할 때 생성되는 여러 가지 예외를 테스트할 수 있습니다.  

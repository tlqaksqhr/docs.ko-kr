...
## 컴파일러 오류를 생성하는 문자 리터럴  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 형식 문자가 없는 경우 리터럴에 대한 기본 데이터 형식을 사용합니다.  큰따옴표\(`" "`\)로 묶인 문자 리터럴의 기본 형식은 `String`입니다.  

...
## 문자열을 숫자로 변환  
 ...
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 문자열을 숫자 값으로 변환할 때 Windows **제어판**에 지정된 **국가별 옵션** 설정을 사용하여 1000 단위 구분 기호, 소수 구분 기호 및 통화 기호를 해석합니다.  이것은 한 설정에서 변환에 성공해도 다른 설정에서는 실패할 수 있다는 것을 의미합니다.  예를 들어, `"$14.20"`은 영어\(미국\) 로캘에서는 허용되지만 프랑스어 로캘에서는 허용되지 않습니다.  

...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서는 인쇄하거나 표시할 수 있는 문자를 다루는 데 사용되는 *문자 데이터 형식*을 제공합니다.  이 형식은 모두 유니코드 문자를 다루지만 `Char`은 문자를 하나만 포함하고 `String`은 문자를 무한대로 포함합니다.  

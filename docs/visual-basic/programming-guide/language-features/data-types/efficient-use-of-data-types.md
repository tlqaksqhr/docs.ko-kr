...
## 가장 효율적인 데이터 형식  
 소수를 포함하지 않은 변수의 경우 정수 계열 데이터 형식이 비정수 계열 형식보다 효율적입니다.  [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]에서는 `Integer`와 `UInteger`가 가장 효율적인 숫자 형식입니다.  

...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)]에서는 구조체와 클래스에 대한 구문이 단일화되었습니다. 그 결과 두 엔터티는 동일한 기능을 대부분 지원하지만,  구조체와 클래스 사이에는 중요한 차이점 또한 존재합니다.  

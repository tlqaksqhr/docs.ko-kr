...
-   개체, 변수 및 프로시저에 대 한 명명 규칙입니다.  
 ...
 다음 항목은 일련의 올바른 사용의 예제와 함께 Visual Basic 프로그램에 대 한 프로그래밍 지침을 제공합니다.  

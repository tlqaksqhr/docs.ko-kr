...
-   줄 연속 시퀀스를 사용한 후에는 같은 줄에 주석을 쓸 수 없습니다.  
 ...
 추가 하거나 하나 이상의 코드 줄을 선택 하 고 선택 하 여 코드 블록에 대 한 주석 기호를 제거할 수 있습니다는 **주석** (![VisualBasicWinAppCodeEditorCommentButton](../../../visual-basic/programming-guide/program-structure/media/vacommentbutton.gif "vaCommentButton ")) 및 **주석 제거** (![VisualStudioWinAppProjectUncommentButton](../../../visual-basic/programming-guide/program-structure/media/vauncommentbutton.gif "vaUncommentButton"))에 단추는 **편집**  도구 모음입니다.  

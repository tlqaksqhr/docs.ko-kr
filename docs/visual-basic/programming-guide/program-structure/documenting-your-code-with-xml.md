...
-   개발자는 자유롭게 자체 태그 집합을 만들 수 있습니다.  권장 태그 집합을 보려면 이 항목에서 "관련 단원"을 참조하십시오.  권장 태그 중에는 특별한 의미가 있는 것도 있습니다.  
    ...
    -   \<summary\> 태그는 [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)]의 IntelliSense에 의해 사용되어 형식이나 멤버에 대한 추가 정보를 표시합니다.  

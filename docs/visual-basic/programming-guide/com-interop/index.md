...
## 단원 내용  
 ...
 기존의 ActiveX 컨트롤을 사용하여 [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)] 도구 상자에 기능을 추가하는 방법을 보여 줍니다.  

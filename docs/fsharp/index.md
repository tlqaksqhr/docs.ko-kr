...
[Visual Studio에서 F #으로 시작 하려면](get-started/get-started-visual-studio.md) Windows 환경에서 Visual Studio IDE (Integraded Development Environment) 사용을 원한다면 해당 문서를 참고하십시오.

[Mac 용 Visual Studio에서 F #으로 시작](get-started/get-started-with-visual-studio-for-mac.md) macOS 환경에서 Visual Studio IDE 사용을 원한다면 해당 문서를 참고하십시오.

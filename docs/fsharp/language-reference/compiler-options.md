...
|**--baseaddress:&lt;string&gt;**|빌드할 라이브러리의 기본 주소를 지정 합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; baseaddress &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/2fdbz5xd.aspx).|
|**--codepage:&lt;int&gt;**|소스 파일을 읽는 데 사용 되는 코드 페이지를 지정 합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; 코드 페이지 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/w0kyekyh.aspx).|
|**--consolecolors**|오류 및 경고 사용 콘솔에 색으로 구분 된 텍스트를 지정 합니다.|
|**--crossoptimize**[**+**&#124;**-**]|크로스 모듈을 최적화를 사용 하지 않도록 설정 하거나 사용 합니다.|
|**--delaysign**[**+**&#124;**-**]|서명을 연기 강력한 이름 키의 공개 부분만 사용 하 여 어셈블리입니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; delaysign &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/ta1sxwy8.aspx).|
|**--checked**[**+**&#124;**-**]|오버플로 검사의 생성을 비활성화 하거나 사용 합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; 확인 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/h25wtyxf.aspx).|
|**--debug**[**+**&#124;**-**]<br /><br />**-g**[**+**&#124;**-**]<br /><br />**--debug**:[**full**&#124;**pdbonly**]<br /><br />**-g:** [**full**&#124;**pdbonly**]|또는 디버그 정보 생성을 비활성화 하거나 생성 하는 디버그 정보의 유형을 지정 합니다. 기본값은 full, 실행 중인 프로그램에 연결할 수 있습니다. 선택 **pdbonly** pdb (프로그램 데이터베이스) 파일에 저장 하는 제한 된 디버깅 정보를 얻을 수 있습니다.<br /><br />이름이 같은 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 다음 항목을 참조하세요.<br /><br />[&#47; 디버그 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/8cw0bt21.aspx).|
...
|**--doc:&lt;xmldoc-filename&gt;**|지정 된 파일에 XML 문서 주석 생성 하도록 컴파일러에 지시 합니다. 자세한 내용은 참조 [XML 문서](xml-documentation.md)합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; doc &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/3260k4x7.aspx).|
|**--fullpaths**|정규화 된 경로 생성 하도록 컴파일러에 지시 합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; fullpaths &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/d315xc66.aspx).|
...
|**--lib:&lt;folder-name&gt;**<br /><br />**-I:&lt;folder-name&gt;**|참조 되는 어셈블리에 대 한 검색할 디렉터리를 지정 합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; lib &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/s5bac5fx.aspx).|
|**--linkresource**:**&lt;resource-info&gt;**|어셈블리에 지정된 된 리소스를 연결합니다. 리소스 정보 형식이 *filename*[,*이름*[,*공용*&#124; *개인*]]<br /><br />전체 리소스 파일을 포함 하는 대신은이 옵션을 사용 하 여 단일 리소스 링크는 **-리소스** 옵션입니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; linkresource &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/xawyf94k.aspx).|
...
|**--nowarn:&lt;int-list&gt;**|번호 순으로 나열 하는 특정 경고를 해제 합니다. 각 경고 번호를 쉼표로 구분 합니다. 컴파일 출력에서 모든 경고에 대 한 경고 번호를 검색할 수 있습니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; nowarn &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/7f28x9z3.aspx).|
...
|**--out:&lt;output-filename&gt;**<br /><br />**-o:&lt;output-filename&gt;**|컴파일된 어셈블리 또는 모듈의 이름을 지정합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; 아웃 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/bw3t50f3.aspx).|
|**--pdb:&lt;pdb-filename&gt;**|출력 디버그 PDB (프로그램 데이터베이스) 파일의 이름을 지정 합니다. 이 옵션 적용 될 때 **-디버그** 옵션도 사용할 수 있습니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; pdb &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/ms228625.aspx).|
|**--platform:&lt;platform-name&gt;**|생성 된 코드에 지정된 된 플랫폼에만 실행 되도록 지정 (**x86**, **Itanium**, 또는 **x64**), 또는 경우에 플랫폼 이름을 **anycpu**선택 하 든, 생성 된 코드는 모든 플랫폼에서 실행할 수를 지정 합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; 플랫폼 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/zekwfyz4.aspx).|
...
|**--reference:&lt;assembly-filename&gt;**<br /><br />**-r** &lt;**assembly-filename&gt;**|코드에서 F # 또는.NET Framework 어셈블리를 사용할 수 있게 컴파일되는 코드입니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; 참조 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/yabyz3h4.aspx).|
|**--resource:&lt;resource-filename&gt;**|생성된 된 어셈블리에 관리 되는 리소스 파일을 포함합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; 리소스 &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/c0tyye07.aspx).|
...
|**--warnaserror**[**+**&#124;**-**] [**&lt;int-list&gt;**]|경고를 오류로 보고 하는 옵션을 사용 하지 않도록 설정 하거나 사용 합니다. 특정 경고 번호 비활성화 되거나 활성화 될를 제공할 수 있습니다. 명령줄의 뒷부분에 나오는 옵션은 명령줄의 앞부분에 나오는 옵션을 무시 합니다. 예를 들어 오류로 보고 싶지 않은 경고를 지정 하려면 지정 **-warnaserror +-warnaserror-:&lt;int 목록&gt;**합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; warnaserror &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/406xhdz3.aspx).|
|**--win32manifest:manifest-filename**|컴파일에 Win32 매니페스트 파일을 추가합니다. 이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; win32manifest &#40; &#35; 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/bb545961.aspx).|
|**--win32res:resource-filename**|컴파일에 Win32 리소스 파일을 추가합니다.<br /><br />이 컴파일러 옵션은 이름이 동일한 C# 컴파일러 옵션에 해당 합니다. 자세한 내용은 참조 [&#47; win32res (&#40; C 및 #35); 컴파일러 옵션 &#41; ](https://msdn.microsoft.com/library/8f2f5x2e.aspx).|

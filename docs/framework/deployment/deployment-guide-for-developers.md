...
이 항목에서는 설치 하려는 개발자에 대 한 정보는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2는 [!INCLUDE[net_v46](../../../includes/net-v46-md.md)], 4.6.1, 4.6.2, 또는.NET Framework 4.7 또는 앱과 함께 4.7.1 합니다.

다운로드 링크를 확인하려면 [재배포 가능 패키지](#redistributable-packages) 섹션을 참조하세요. 재배포 가능 패키지 및 언어 팩은 다음 Microsoft 다운로드 센터 페이지에서 다운로드할 수도 있습니다.

- 모든 운영 체제용.NET framework 4.7.1 ([웹 설치 관리자](http://go.microsoft.com/fwlink/?LinkId=852095) 또는 [오프 라인 설치 관리자](http://go.microsoft.com/fwlink/p/?LinkId=852107))
...
> [!NOTE]
> 구 "는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] 및 해당 포인트 릴리스" 참조 하는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] 그 이후의 모든 버전.

- [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 및 4.7.1은에 대 한 현재 위치 업데이트는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 이므로 동일한 런타임 버전을 사용 하지만 어셈블리 버전이 업데이트 되 고 새 형식과 멤버를 포함 합니다.

- [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] 및 해당 포인트 릴리스는 [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)]에서 증분 방식으로 빌드됩니다. 설치 하는 경우는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 또는 4.7.1 있는 시스템에는 [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] 설치 버전 4 어셈블리가 새 버전으로 교체 됩니다.
...
## <a name="deployment-options-for-your-app"></a>앱용 배포 옵션
 응용 프로그램을 사용자가 설치할 수 있도록 웹 서버나 다른 중앙 위치에 게시할 준비가 되면 몇 가지 배포 방법 중에서 선택할 수 있습니다. 이러한 방법 중 몇 가지는 Visual Studio에서 제공됩니다. 다음 표에서 앱에 대 한 배포 옵션을 나열 하 고 각 옵션을 지 원하는.NET Framework 재배포 가능 패키지를 지정 합니다. 또한 응용 프로그램을 위한 사용자 지정 설치 프로그램을 작성할 수 있습니다. 자세한 내용은 [응용 프로그램 설치를 위해 .NET Framework 설치 연결](#chaining)섹션을 참조하세요.
...
|ClickOnce 배포를 위한 다운로드 위치|Microsoft 다운로드 센터:<br /><br /> - [.NET framework 4.7.1](http://go.microsoft.com/fwlink/?LinkId=852092) <br/> - [.NET Framework 4.7](http://go.microsoft.com/fwlink/?LinkId=825298) <br/> - [.NET Framework 4.6.2](http://go.microsoft.com/fwlink/?LinkId=780596)<br />- [.NET Framework 4.6.1](http://go.microsoft.com/fwlink/?LinkId=671728)<br />- [.NET Framework 4.6](http://go.microsoft.com/fwlink/?LinkId=528222)<br />- [.NET Framework 4.5.2](http://go.microsoft.com/fwlink/?LinkId=397703)<br />- [.NET Framework 4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=310158)<br />- [.NET Framework 4.5](http://go.microsoft.com/fwlink/p/?LinkId=245484)|사용자의 서버 또는 Microsoft 다운로드 센터:<br /><br /> - [.NET framework 4.7.1](http://go.microsoft.com/fwlink/?LinkId=852104)<br /> - [.NET Framework 4.7](http://go.microsoft.com/fwlink/?LinkId=825302)<br /> - [.NET Framework 4.6.2](http://go.microsoft.com/fwlink/?LinkId=780600)<br />- [.NET Framework 4.6.1](http://go.microsoft.com/fwlink/?LinkId=671743)<br />- [.NET Framework 4.6](http://go.microsoft.com/fwlink/?LinkId=528232)<br />- [.NET Framework 4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706)<br />- [.NET Framework 4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=310159)<br />- [.NET Framework 4.5](http://go.microsoft.com/fwlink/p/?LinkId=245484)|
 ...
 \* 오프라인 설치 관리자는 모든 대상 플랫폼의 구성 요소를 포함하기 때문에 더 큽니다. 설치 프로그램의 실행을 마치면 Windows 운영 체제에서는 사용한 설치 관리자만 캐시합니다. 설치 후에 오프라인 설치 관리자를 삭제하는 경우 사용된 디스크 공간은 웹 설치 관리자에서 사용하는 것과 동일합니다. 도구 사용 하는 경우 (예를 들어 [InstallAware](#installaware-deployment) 또는 [InstallShield](#installshield-deployment)) 앱의 설치 프로그램을 만드는 설치 후에 제거 되는 설치 파일 폴더를 제공, 오프 라인 설치 관리자 수 있습니다. 설치 폴더에 배치 하 여 자동으로 삭제 합니다.
...
- .NET Framework에 대한 종속성을 설정할 수 있습니다. 다음 방법 중 하나를 사용하여 응용 프로그램 설치 시 필수 구성 요소로 .NET Framework를 지정할 수 있습니다.
    ...
    - 만들기는 [InstallAware 프로젝트](#installaware-deployment) (Visual Studio 사용자에 사용할 수 있는 무료 버전)
...
ClickOnce, InstallAware, InstallShield 또는 WiX를 사용 하 여 앱을 배포 하는 경우 응용 프로그램의 일부로 설치할 수 있도록.NET Framework에 대 한 종속성을 추가할 수 있습니다.
...
InstallAware는 Windows 앱 (APPX), Windows Installer (MSI), 네이티브 코드 (EXE) 및 단일 소스에서 App-v (Application Virtualization) 패키지를 작성합니다. 쉽게 [모든 버전의.NET Framework가 포함 되어](https://www.installaware.com/one-click-pre-requisite-installer.htm) 설치 프로그램에 필요에 따라 설치를 사용자 지정 하 여 [기본 스크립트 편집](https://www.installaware.com/msicode.htm)합니다. 예를 들어 InstallAware 미리 Windows 7,.NET Framework 4.7 설치에 실패 하면 관계 없이 인증서를 설치 합니다. InstallAware에 자세한 내용은 참조는 [Windows Installer InstallAware](https://www.installaware.com/) 웹 사이트입니다.
...
4.  처음으로 설치 및 배포 프로젝트를 만드는 경우 선택 **InstallShield로 이동** 또는 **InstallShield Limited Edition** 버전의 InstallShield Limited Edition을 다운로드 하려면 Microsoft Visual Studio입니다. Visual Studio를 다시 시작합니다.
...
|.NET framework 4.7.1 Windows 10 년 작성자 업데이트 이외의 다른 모든 OS 버전에 설치|461310|
...
```
 ...
 최종 릴리스 버전의 언어 팩에 대 한 설치 되어 있는지 확인 하는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 또는 4.7.1, 검사 릴리스의 값 키 이전 섹션에 설명 된 DWORD 값 [.NET 검색 프레임 워크](#detect_net)합니다.
...
## <a name="uninstalling-the-net-framework"></a>.NET Framework 제거
 부터는 [!INCLUDE[win8](../../../includes/win8-md.md)]를 제거할 수 있습니다는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 또는 사용 하 여 4.7.1 **Windows 기능 설정 및 해제** 제어판에서. 이전 버전의 Windows에서 제거할 수 있습니다는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 또는 사용 하 여 4.7.1 **프로그램 추가 / 제거** 제어판에서.

> [!IMPORTANT]
> Windows 7 및 이전 운영 체제에서는 제거는 [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 또는 4.7.1 복원 되지 않고 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] 파일 및 제거는 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] 복원 되지 않고 [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] 파일입니다. 이전 버전으로 돌아가려면 해당 프로그램과 업데이트를 다시 설치해야 합니다.

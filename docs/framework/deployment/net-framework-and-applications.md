---
title: ".NET Framework 및 응용 프로그램 배포 | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
helpviewer_keywords: 
  ...
  - ".NET Framework, 배포"
  - "응용 프로그램 배포[.NET Framework]"
  - "응용 프로그램 배포[.NET Framework], 배포"
  - "응용 프로그램 배포[.NET Framework], 기능"
  - "응용 프로그램 배포[.NET Framework], 패키징"
...
이 문서는 응용 프로그램과 함께 .NET Framework 배포를 시작하는 데 도움이 됩니다.  대부분의 정보는 개발자, OEM 및 엔터프라이즈 관리자를 위한 것입니다.  컴퓨터에 .NET Framework를 설치하려는 사용자는 [.NET Framework 4.5 설치](../../../docs/framework/install/guide-for-developers.md)를 읽어야 합니다.  
...
-   일반적인 설치 관리자 및 배포 정보:  
    ...
    -   설치 관리자 옵션:  
        ...
        -   [웹 설치 관리자](../../../docs/framework/install/guide-for-developers.md#choices)  
  
        -   [오프라인 설치 관리자](../../../docs/framework/install/guide-for-developers.md#choices)  
    ...
    -   [차단된 .NET Framework 설치 문제 해결](../../../docs/framework/install/troubleshoot-blocked-installations-and-uninstallations.md)  
...
-   .NET Framework 배포\(OEM 및 관리자용\):  
    ...
    -   [Windows ADK\(평가 및 배포 키트\)](http://go.microsoft.com/fwlink/p/?LinkId=254976)\(영문\)  
  
    -   [관리자 가이드](../../../docs/framework/deployment/guide-for-administrators.md)  
  
 **서비스**  
  
-   일반적인 내용은 [.NET Framework 블로그](http://go.microsoft.com/fwlink/p/?LinkId=254977)\(영문\)를 참조하세요.  
...
|[응용 프로그램, 서비스 및 구성 요소 배포](../Topic/Deploying%20Applications,%20Services,%20and%20Components.md)|ClickOnce 및 Windows Installer 기술을 사용하여 응용 프로그램을 게시하기 위한 지침을 포함하여 Visual Studio의 배포 옵션을 설명합니다.|  
|[ClickOnce 응용 프로그램 게시](../Topic/Publishing%20ClickOnce%20Applications.md)|Windows Forms 응용 프로그램을 패키징하고 ClickOnce로 네트워크의 클라이언트 컴퓨터에 배포하는 방법을 설명합니다.|  

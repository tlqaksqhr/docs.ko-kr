...
## <a name="see-also"></a>참고 항목  
 ...
 [HTTP Server](http://go.microsoft.com/fwlink/?LinkID=178285) (HTTP 서버)  
 [인터넷 정보의 향상된 보안 기능](http://go.microsoft.com/fwlink/?LinkID=178286)   
 [HttpListener ASPX Host Application Sample](http://go.microsoft.com/fwlink/?LinkID=179560) (HttpListener ASPX 호스트 응용 프로그램 샘플)  
 [HttpListener Technology Sample](http://go.microsoft.com/fwlink/?LinkID=179558) (HttpListener 기술 샘플)  

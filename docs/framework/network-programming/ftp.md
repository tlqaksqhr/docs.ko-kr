...
## <a name="see-also"></a>참고 항목  
 ...
 [FTP Client Technology Sample](http://go.microsoft.com/fwlink/?LinkID=179557) (FTP 클라이언트 기술 샘플)  
 [FTP Explorer Technology Sample](http://go.microsoft.com/fwlink/?LinkID=179569) (FTP 탐색기 기술 샘플)  

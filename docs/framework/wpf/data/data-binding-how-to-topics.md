---
title: "데이터 바인딩 방법 항목 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 데이터 바인딩 방법 항목
이 단원의 항목에서는 데이터 바인딩을 사용하여 요소를 CLR\(공용 언어 런타임\) 개체 및 XML의 형태로 다양한 데이터 소스의 데이터에 바인딩하는 방법을 설명합니다.  

...
|<xref:System.Windows.DependencyObject> 개체|바인딩할 수 있습니다 종속성 중인 모든 <xref:System.Windows.DependencyObject>합니다. 예제는 [두 컨트롤의 속성 바인딩](../../../../docs/framework/wpf/data/how-to-bind-the-properties-of-two-controls.md)을 참조하세요.|  

...
helpviewer_keywords: 
  - "이벤트, windows"
  - "Windows Presentation Foundation, 이벤트"
  - "WPF, 이벤트"
...
---
# 이벤트(WPF)
[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)]에는 응용 프로그램 요소 트리의 다양한 수신기에 있는 처리기를 호출할 수 있는 [라우트된 이벤트](GTMT)라는 개념이 새로 도입되었습니다.  

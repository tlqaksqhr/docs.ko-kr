...
1.  라는 Windows 응용 프로그램 프로젝트를 추가 `WpfUserControlHost` 솔루션에 있습니다. 자세한 내용은 [방법: 새 WPF 응용 프로그램 프로젝트 만들기](http://msdn.microsoft.com/en-us/1f6aea7a-33e1-4d3f-8555-1daa42e95d82)를 참조하세요.  

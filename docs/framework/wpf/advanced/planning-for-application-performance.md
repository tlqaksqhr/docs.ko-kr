...
## <a name="make-performance-tuning-an-iterative-process"></a>성능 튜닝 방법으로 반복적인 프로세스를 확인 합니다.  
 사용 하 여 각 기능의 상대적 비용을 알고 있어야 합니다. 예를 들어 Microsoft.NET Framework의 리플렉션에 사용은 일반적으로 컴퓨팅 리소스의 측면에서 성능 주의 해 서 사용 하려고 합니다. 그렇다고 리플렉션 사용을 방지 하기 위해 사용 하는 기능의 성능 요구 응용 프로그램의 성능 요구 사항을 균형을 조정 하는 주의 해야 하에 합니다.  

...
-   다음과 같은 고급 기능이 포함된 플러그 인 serializer 지원:  
    ...
    -   모든 [!INCLUDE[TLA2#tla_winfx](../../../../includes/tla2sharptla-winfx-md.md)] 응용 프로그램에서 사용하는 시스템 차원 액세스.  

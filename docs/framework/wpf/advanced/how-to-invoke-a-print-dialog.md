...
> [!NOTE]
>  <xref:System.Windows.Controls.PrintDialog?displayProperty=nameWithType> 제어 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)],이 항목에 설명 된 대로 혼동 해서는 안 된는 <xref:System.Windows.Forms.PrintDialog?displayProperty=nameWithType> 구성 요소인 [!INCLUDE[TLA2#tla_winforms](../../../../includes/tla2sharptla-winforms-md.md)]합니다.  

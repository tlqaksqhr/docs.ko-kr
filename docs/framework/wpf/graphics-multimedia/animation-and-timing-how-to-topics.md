---
title: "애니메이션 및 타이밍 방법 항목 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 애니메이션 및 타이밍 방법 항목
다음 항목에서는 응용 프로그램에서 [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] 애니메이션 및 타이밍 시스템을 사용하는 방법을 보여 줍니다.  
...
## 단원 내용  
 ...
 [해당 Timeline의 속도를 변경하지 않고 시계의 속도 변경](../../../../docs/framework/wpf/graphics-multimedia/change-the-speed-of-a-clock.md)  
 ...
 [시계의 상태가 변경될 때 알림 받기](../../../../docs/framework/wpf/graphics-multimedia/how-to-receive-notification-when-clock-state-changes.md)  
 [How to: Remove a Storyboard](http://msdn.microsoft.com/ko-kr/7fe39531-de2f-46a0-a69f-b783d04235ee)  
 ...
 [Storyboard를 사용하여 애니메이션 효과를 적용한 후 속성 설정](../../../../docs/framework/wpf/graphics-multimedia/how-to-set-a-property-after-animating-it-with-a-storyboard.md)  
 [자식 Timeline을 사용하여 애니메이션 단순화](../../../../docs/framework/wpf/graphics-multimedia/how-to-simplify-animations-by-using-child-timelines.md)  
 ...
 [활성 기간이 끝난 Timeline의 FillBehavior 지정](../../../../docs/framework/wpf/graphics-multimedia/specify-the-fillbehavior-for-a-timeline.md)  

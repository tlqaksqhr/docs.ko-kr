...
비틀 회전 ""를 사용 하 여 3D 개체 하는 방법을 보여 주는 다음 예제 <xref:System.Windows.Media.Animation.Rotation3DAnimation> 애니메이션 효과를 주는 <xref:System.Windows.Media.Media3D.RotateTransform3D.Rotation%2A> 의 속성은 <xref:System.Windows.Media.Media3D.RotateTransform3D> 3D 개체에 적용 되는 개체입니다.  

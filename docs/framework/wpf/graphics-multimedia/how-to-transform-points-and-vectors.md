...
---
# <a name="how-to-transform-points-and-vectors"></a>방법: 점 및 벡터 변환
사용 하는 방법을 보여 주는이 예제는 <xref:System.Windows.Media.Matrix> 변환할 <xref:System.Windows.Point> 및 <xref:System.Windows.Vector> 개체입니다.  

...
-   <xref:System.Windows.Media.Animation.PowerEase>: 및/또는 수식을 사용 하 여 감속 하는 애니메이션 만듭니다 *f*(*t*) = *t*<sup>p</sup> p가 인는 <xref:System.Windows.Media.Animation.PowerEase.Power%2A>속성입니다.  

...
## <a name="example"></a>예제  
 다음 예제에서는 <xref:System.Windows.Controls.MediaElement> 및 <xref:System.Windows.Media.MediaTimeline> 에 <xref:System.Windows.Media.Animation.Storyboard> 미디어 클립 무한 루프가 재생 하는 데 있습니다.  

---
title: "3차원 그래픽 방법 항목 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 3차원 그래픽 방법 항목
이 단원의 항목에서는 [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] 응용 프로그램에서 [!INCLUDE[TLA#tla_3d](../../../../includes/tlasharptla-3d-md.md)] 그래픽을 사용하는 방법을 보여 줍니다.  

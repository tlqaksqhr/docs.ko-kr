...
1.  Visual Studio 메뉴 모음에서 **도구**, **확장 및 업데이트**를 선택합니다\(Visual Studio 2010에서는 **확장 관리자** 선택.\)  
...
3.  다운로드가 완료된 후 Visual Studio를 다시 시작합니다.  
 ...
 자세한 설치 지침은 NuGet 문서 웹 사이트에서 [NuGet 설치](http://docs.nuget.org/docs/start-here/installing-nuget)를 참조하세요.  NuGet에 대한 자세한 내용은 [NuGet 설명서](http://docs.nuget.org/)를 참조하십시오.  
...
3.  시험판 패키지를 사용할 경우 중간 창의 드롭다운 목록 상자에서 **Stable Only** 대신 **Include Prerelease**를 선택합니다.  

...
> [!NOTE]
>  사용자와 개발자 모두를 위한 .NET Framework에 대한 일반적인 소개는 [시작](../../../docs/framework/get-started/index.md)을 참조하세요.  .NET Framework를 다운로드하려면 [설치 가이드](../../../docs/framework/install/guide-for-developers.md)를 참조하세요.  
...
-   WCF\(Windows Communcation Foundation\)를 사용하는 서비스 기반 응용 프로그램.  [WCF를 사용하여 개발한 서비스 기반 응용 프로그램](../../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md)을 참조하세요.  
  
-   Windows WF\(Workflow Foundation\)를 사용하는 워크플로 사용 응용 프로그램  [.NET Framework에서 워크플로 만들기](http://msdn.microsoft.com/ko-kr/cbf3880f-dc7b-466d-b808-1109b1223f4a)를 참조하세요.  
...
## 참고 항목  
 ...
 [.NET Framework 샘플](http://msdn.microsoft.com/ko-kr/177055f8-4a1f-43e7-aee6-995c196079b1)   

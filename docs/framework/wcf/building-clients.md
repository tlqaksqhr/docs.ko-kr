...
이 단원의 항목에서는 [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] 클라이언트를 만들고 사용하는 방법에 대해 보여 줍니다.  
  
## <a name="in-this-section"></a>단원 내용  
 [WCF 클라이언트 개요](../../../docs/framework/wcf/wcf-client-overview.md)  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 클라이언트의 개요 및 작동 방법을 설명합니다.  
  
 [WCF 클라이언트를 사용하여 서비스 액세스](../../../docs/framework/wcf/accessing-services-using-a-wcf-client.md)  
 클라이언트 응용 프로그램에서 사용할 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 클라이언트 개체를 만드는 기본 방법에 대해 간략하게 설명합니다.  
  
 [클라이언트에 보안 설정](../../../docs/framework/wcf/securing-clients.md)  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 클라이언트의 보안을 구성하는 방법에 대해 설명합니다.  

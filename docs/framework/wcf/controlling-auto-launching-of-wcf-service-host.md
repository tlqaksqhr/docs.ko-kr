...
자동 시작 기능을 제어할 수 있습니다 [!INCLUDE[indigo1](../../../includes/indigo1-md.md)] 에 대 한 서비스 호스트 (WcfSvcHost.exe)를 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 서비스 라이브러리 프로젝트에 여러 프로젝트가 포함 된 같은 Visual Studio 솔루션의 다른 프로젝트를 디버깅할 때.  

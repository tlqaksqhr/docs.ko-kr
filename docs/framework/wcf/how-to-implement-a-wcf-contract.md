...
```  
 ...
 이제 서비스 계약이 만들어지고 구현되었습니다. 컴파일 오류가 없는지 확인 하려면 솔루션을 빌드한 다음 진행 [하는 방법: 기본 서비스 호스트 및 실행](../../../docs/framework/wcf/how-to-host-and-run-a-basic-wcf-service.md) 서비스를 실행 합니다. 문제 해결 정보를 참조 하세요. [초보자를 위한 자습서 문제 해결](../../../docs/framework/wcf/troubleshooting-the-getting-started-tutorial.md)합니다.  
  
## <a name="compiling-the-code"></a>코드 컴파일  
 Visual Studio를 사용 하는 경우 빌드 메뉴에서 솔루션 빌드를 클릭 (또는 CTRL + SHIFT + b).  

...
2.  **보기** 메뉴에서 **솔루션 탐색기**를 선택하여 **솔루션 탐색기**를 엽니다.  
  
3.  [!INCLUDE[vs_current_short](../../../../includes/vs-current-short-md.md)]에서 **F5** 키 또는 **Ctrl\+Shift\+B**를 누릅니다.  
  
    1.  **F5** 키를 누를 때 필요한 프로젝트가 자동으로 시작되도록 하려면 솔루션을 마우스 오른쪽 단추로 클릭하고 **속성**을 선택합니다.왼쪽 창의 **공용 속성**에서 **시작 프로젝트** 노드를 선택합니다.**여러 개의 시작 프로젝트** 라디오 단추를 선택하고 모든 프로젝트의 동작을 **시작**으로 설정합니다.  
  
    2.  **Ctrl\+Shift\+B**를 사용하여 프로젝트를 빌드할 경우에는 다음 응용 프로그램을 시작해야 합니다.  
...
7.  클라이언트 콘솔 창에서 “quit”를 입력하고 Enter 키를 눌러 종료합니다.  

...
1.  > [!IMPORTANT]
    >  이 샘플을 실행하기 전에 MSMQ를 설치합니다.  MSMQ가 설치되어 있지 않은 경우 이 샘플을 실행하면 예외 메시지가 반환됩니다.  MSMQ 설치에 대한 지침은 [메시지 큐\(MSMQ\) 설치](http://go.microsoft.com/fwlink/?LinkId=166437)에서 찾을 수 있습니다.  
  
     [!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)]에서 AdvancedErrorHandling.sln을 엽니다.  
  
2.  [!INCLUDE[vs_current_short](../../../../includes/vs-current-short-md.md)]에서 **F5** 키 또는 **Ctrl\+Shift\+B**를 누릅니다.  

...
1.  [Windows Communication Foundation 샘플 빌드](../../../../docs/framework/wcf/samples/building-the-samples.md)에 설명된 대로 JsonSerialization.sln 솔루션을 빌드합니다.  

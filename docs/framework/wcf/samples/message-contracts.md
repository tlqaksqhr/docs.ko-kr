...
이 단원에는 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]의 메시지 계약을 보여 주는 샘플이 포함되어 있습니다.  
...
## <a name="in-this-section"></a>단원 내용  
 ...
 [사용 및 스타일 속성 설정](../../../../docs/framework/wcf/samples/setting-the-use-and-style-properties.md)  

---
title: "사용자 지정 WSDL 게시 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   <xref:System.ServiceModel.Description.IWsdlExportExtension?displayProperty=fullName>을 사용자 지정 <xref:System.ServiceModel.Description.IContractBehavior?displayProperty=fullName> 특성에 구현하여 특성 속성을 WSDL 주석으로 내보내기.  
  
-   <xref:System.ServiceModel.Description.IWsdlImportExtension?displayProperty=fullName>을 구현하여 사용자 지정 WSDL 주석 가져오기.  
  
-   사용자 지정 계약 동작과 사용자 지정 작업 동작에 각각 <xref:System.ServiceModel.Description.IServiceContractGenerationExtension?displayProperty=fullName> 및 <xref:System.ServiceModel.Description.IOperationContractGenerationExtension?displayProperty=fullName>을 구현하여 가져온 주석을 가져온 계약 및 작업의 CodeDom에 주석으로 씁니다.  
  
-   <xref:System.ServiceModel.Description.MetadataExchangeClient?displayProperty=fullName>를 사용하여 WSDL을 다운로드하고, <xref:System.ServiceModel.Description.WsdlImporter?displayProperty=fullName>를 사용하여 사용자 지정 WSDL 가져오기로 WSDL을 가져오고, <xref:System.ServiceModel.Description.ServiceContractGenerator?displayProperty=fullName>를 사용하여 C\# 및 Visual Basic에서 \/\/\/ 및 ''' 주석으로 WSDL 주석에 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 클라이언트 코드를 생성합니다.  

...
## <a name="in-this-section"></a>단원 내용  
 ...
 명령적 코드를 작성하여 구성 파일이나 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]에서 생성한 클라이언트를 사용하지 않고 사용자 지정 바인딩을 정의 및 사용하는 방법을 보여 줍니다.  
 ...
 [HTTPS를 통해 신뢰할 수 있는 세션 바인딩 사용자 지정](../../../../docs/framework/wcf/samples/custom-binding-reliable-session-over-https.md)  

---
title: "브리징과 오류 처리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  Visual Studio에서 F5 키나 Ctrl\+Shift\+B를 누릅니다.  
    ...
    1.  F5 키를 누를 때 필요한 프로젝트가 자동으로 시작되도록 하려면 솔루션을 마우스 오른쪽 단추로 클릭하고 **속성**을 선택한 다음 **공용 속성**의 **시작 프로젝트** 노드에서 **여러 개의 시작 프로젝트**를 선택하고 모든 프로젝트를 **시작**으로 설정합니다.  

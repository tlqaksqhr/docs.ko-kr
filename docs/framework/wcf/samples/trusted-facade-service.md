---
title: "신뢰된 외관 서비스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 [\<security\>](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-custombinding.md) 바인딩 요소는 초기 호출자의 사용자 이름 전송과 추출을 처리합니다.[\<windowsStreamSecurity\>](../../../../docs/framework/configure-apps/file-schema/wcf/windowsstreamsecurity.md) 및 [\<tcpTransport\>](../../../../docs/framework/configure-apps/file-schema/wcf/tcptransport.md)는 외관 및 백 엔드 서비스 인증과 메시지 보호를 처리합니다.  
...
6.  클라이언트와 서비스가 통신할 수 없는 경우 [Troubleshooting Tips](http://msdn.microsoft.com/ko-kr/8787c877-5e96-42da-8214-fa737a38f10b)을 참조하세요.  

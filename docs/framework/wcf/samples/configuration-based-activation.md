---
title: "구성 기반 활성화 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### .svc 파일 없이 서비스 활성화  
 ...
 [!INCLUDE[netfx40_short](../../../../includes/netfx40-short-md.md)]에서는 응용 프로그램 구성 파일의 <xref:System.ServiceModel.Configuration.ServiceHostingEnvironmentSection>에 새 구성 요소\(<xref:System.ServiceModel.Configuration.ServiceActivationElement>\)가 도입되었습니다.<xref:System.ServiceModel.Configuration.ServiceHostingEnvironmentSection> 컬렉션은 다음 코드 예제와 같이 서비스 컬렉션을 받아들여 활성화합니다.  

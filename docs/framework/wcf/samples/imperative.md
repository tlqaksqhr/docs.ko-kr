...
---
# 명령적
이 샘플에서는 구성에서 `wsHttpBinding` 바인딩을 정의하는 대신 코드를 사용하여 서비스에 대한 <xref:System.ServiceModel.WsHttpBinding>을 정의하는 방법을 보여 줍니다.이 샘플은 계산기 서비스를 구현하는 [시작](../../../../docs/framework/wcf/samples/getting-started-sample.md)을 기반으로 합니다.  

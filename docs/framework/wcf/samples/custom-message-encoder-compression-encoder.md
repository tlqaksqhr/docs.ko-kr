---
title: "사용자 지정 메시지 인코더: 압축 인코더 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 이 구성 처리기를 사용하려면 다음 샘플 구성에서와 같이 [\<system.serviceModel\>](../../../../docs/framework/configure-apps/file-schema/wcf/system-servicemodel.md) 요소 내부에 등록되어야 합니다.  

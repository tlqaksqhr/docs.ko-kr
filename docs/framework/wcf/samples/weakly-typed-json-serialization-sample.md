---
title: "약한형 JSON Serialization 샘플 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 컴파일할 때 해당 형식을 선언하지 않고 JSON 개체와 배열을 '찾아볼' 수 있습니다. 최상위 `["root"]` 개체의 요구 사항에 대한 설명은 [JSON과 XML 간의 매핑](../../../../docs/framework/wcf/feature-details/mapping-between-json-and-xml.md) 항목을 참조하십시오.  
...
2.  [Windows Communication Foundation 샘플 빌드](../../../../docs/framework/wcf/samples/building-the-samples.md)에 설명된 대로 WeaklyTypedJson.sln 솔루션을 빌드합니다.  

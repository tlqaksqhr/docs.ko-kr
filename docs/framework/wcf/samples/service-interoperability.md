...
## <a name="in-this-section"></a>섹션 내용  
 ...
 웹 서비스 응용 프로그램 (Office VBA)에 대 한 Microsoft Office Visual Basic 또는 Visual Basic 6.0 등의 COM 기반 개발 환경에 통합 하는 WCF 서비스 모니커를 사용 하는 방법을 보여 줍니다.  
  
 [WCF 서비스를 사용한 ASMX 클라이언트](../../../../docs/framework/wcf/samples/asmx-client-with-a-wcf-service.md)  
 WCF를 사용 하 여 서비스를 만들고 다음 ASMX 클라이언트와 같은 비 WCF 클라이언트에서 서비스에 액세스 하는 방법을 보여 줍니다.

...
## <a name="in-this-section"></a>섹션 내용  
 ...
 Wcf에서 분석 추적을 사용 하 여 이벤트에서 이벤트 추적에 대 한 ETW (Windows)를 내보내는 방법을 보여 줍니다.  
  
 [WCF 분석 추적](../../../../docs/framework/wcf/samples/wcf-analytic-tracing.md)  
 WCF ETW에 기록 하는 분석 추적 스트림에 추적 이벤트를 추가 하는 방법을 보여 줍니다. [!INCLUDE[netfx_current_long](../../../../includes/netfx-current-long-md.md)]합니다.  
 ...
 WCF 서비스의 여러 보안 관련 기능을 제어 하는 방법을 보여 줍니다.  
 ...
 WCF에 포함 된 Windows Management Instrumentation (WMI) 공급자를 사용 하 여 런타임 시 WCF 서비스에서 데이터를 수집 하는 방법을 보여 줍니다.

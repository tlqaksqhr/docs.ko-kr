...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [고유한 Uri 수신 모드를 사용한 서비스 검색 샘플](../../../../docs/framework/wcf/samples/discover-a-service-with-unique-listen-uri-mode-sample.md)  
 <xref:System.ServiceModel.Channels.BindingContext.ListenUriMode%2A> 속성이 <xref:System.ServiceModel.Description.ListenUriMode.Unique>로 설정된 서비스를 검색하는 방법을 보여 줍니다.  
 ...
 [워크플로 검색 샘플](../../../../docs/framework/wcf/samples/workflow-discovery-sample.md)  

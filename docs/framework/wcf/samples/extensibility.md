...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [검색 확장성](../../../../docs/framework/wcf/samples/discovery-extensibility.md)  
 사용자 지정 검색을 보여 줍니다.  
  
 [인스턴스 만들기 확장성](../../../../docs/framework/wcf/samples/instancing-extensibility.md)  
 사용자 지정 확장성을 보여 줍니다.  
  
 [Interop 확장성](../../../../docs/framework/wcf/samples/interop-extensibility.md)  
 ...
 [배포 확장성 샘플](../../../../docs/framework/wcf/samples/syndication-extensibility-samples.md)  
 사용자 지정 배포를 보여 줍니다.  
  
 [전송 확장성](../../../../docs/framework/wcf/samples/transport-extensibility.md)  
 사용자 지정 전송을 보여 줍니다.  
  
 [웹 확장성](../../../../docs/framework/wcf/samples/web-extensibility.md)  
 사용자 지정 웹 기능을 보여 줍니다.  
  
 [작업 포맷터와 작업 선택기](../../../../docs/framework/wcf/samples/operation-formatter-and-operation-selector.md)  
 ...
 오류 처리 및 오류 보고 사용 하 여 WCF 서비스에 대 한 제어를 확장 하는 방법을 보여 줍니다.는 <xref:System.ServiceModel.Dispatcher.IErrorHandler> 인터페이스입니다.  
 ...
 WCF 메시지 본문 형식에 새 콘텐츠 형식을 매핑하는 방법을 보여 줍니다.

---
title: "서비스 계약 구현 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 서비스 및 작업 구현 수준에서 동시성 및 인스턴스 등을 설정할 수 있습니다.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][서비스 디자인 및 구현](../../../docs/framework/wcf/designing-and-implementing-services.md).  
  
 서비스 계약을 구현하고 나면 서비스에 하나 이상의 끝점을 만들어야 합니다.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][끝점 만들기 개요](../../../docs/framework/wcf/endpoint-creation-overview.md).서비스를 실행하는 방법[!INCLUDE[crabout](../../../includes/crabout-md.md)][서비스 호스팅](../../../docs/framework/wcf/hosting-services.md)을 참조하십시오.  

...
## <a name="methods"></a>메서드  
 SslStreamSecurityBindingElement 클래스는 메서드를 정의하지 않습니다.  
  
## <a name="properties"></a>속성  
 SslStreamSecurityBindingElement 클래스에는 다음과 같은 속성이 있습니다.  
...
### <a name="requireclientcertificate"></a>RequireClientCertificate  
 ...
 이 바인딩에 클라이언트 인증서가 필요한지 여부를 지정합니다.  

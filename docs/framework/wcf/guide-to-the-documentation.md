...
-   WCF 사용한 프로그래밍을 처음 사용 하려는 작업에 나열 된 항목을 참조 하십시오는 샘플 응용 프로그램을 확인 하려는 경우 [Windows Communication Foundation 샘플](../../../docs/framework/wcf/samples/index.md)합니다.  
  
-   에서 WCF 서비스 및 클라이언트를 만드는 기본 단계를 안내 하는 방법에 대 한 참조 [초보자를 위한 자습서](../../../docs/framework/wcf/getting-started-tutorial.md)합니다.  
  
-   WCF는 개념에 관심이의 항목을 참조는 [개념적 개요](../../../docs/framework/wcf/conceptual-overview.md) 섹션.  
...
-   특정 기능 또는 WCF의 기능에 대 한 지침을 찾고 경우 아래 항목을 참조 하십시오. [WCF 기능 정보](../../../docs/framework/wcf/feature-details/index.md)합니다.  
  
-   확장 요구 사항에 따라 즉, WCF 사용자 지정 하거나 원하는 경우 [WCF 확장](../../../docs/framework/wcf/extending/index.md)합니다.  
  
-   만들고 WCF 응용 프로그램을 디버깅 하는 데 도움이 되는 도구에 대 한 정보를 참조 하십시오. [Windows Communication Foundation 도구](../../../docs/framework/wcf/tools.md)합니다.  
  
-   구성 XML 파일을 사용 하는 WCF 서비스와 클라이언트를 프로그래밍 하는 기본적인 방법입니다. 구성 파일에 사용 되는 XML 요소에 대 한 참조 설명서를 참조 하십시오. [WCF 구성 스키마](../../../docs/framework/configure-apps/file-schema/wcf/index.md)합니다.  
  
## <a name="troubleshooting"></a>문제 해결  
 일반적인 WCF 문제 해결에 대 한 정보를 참조 하십시오. [WCF 문제 해결 퀵 스타트](../../../docs/framework/wcf/wcf-troubleshooting-quickstart.md)합니다.  
...
-   기존 COM + 응용 프로그램을 WCF 서비스 또는 클라이언트와 통합 하려면 참조 [COM + 응용 프로그램 개요와 통합](../../../docs/framework/wcf/feature-details/integrating-with-com-plus-applications-overview.md)합니다.  
  
-   기존 COM 응용 프로그램을 WCF 서비스 또는 클라이언트와 통합 하려면 참조 [COM 응용 프로그램과 통합](../../../docs/framework/wcf/feature-details/integrating-with-com-applications.md)합니다.  
  
-   기존 MSMQ 응용 프로그램을 WCF 서비스 또는 클라이언트와 통합 하려면 참조 [하는 방법: WCF 끝점으로 메시지 큐에 대기를 교환](../../../docs/framework/wcf/feature-details/how-to-exchange-queued-messages-with-wcf-endpoints.md) 및 [하는 방법: WCF 끝점에서 메시지 큐 응용 프로그램와메시지를교환](../../../docs/framework/wcf/feature-details/how-to-exchange-messages-with-wcf-endpoints-and-message-queuing-applications.md).  
  
-   서비스를 호스팅하는 인터넷 정보 서비스 (IIS)를 사용 하려면 참조 [호스팅 서비스](../../../docs/framework/wcf/hosting-services.md)합니다.  
  
-   WCF를 통해 웹 서비스 확장 (WSE) 3.0 서비스를 사용 하려면 참조 [하는 방법: WSE 3.0 서비스 액세스](../../../docs/framework/wcf/feature-details/how-to-access-a-wse-3-0-service-with-a-wcf-client.md)합니다.  

---
title: "방법: 사용자 지정 WS-Metadata Exchange 바인딩 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "WS-Metadata Exchange [WCF], 사용자 지정 바인딩 구성"
...
이 항목에서는 사용자 지정 WS\-Metadata 교환 바인딩을 구성하는 방법에 대해 설명합니다.  [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]에는 시스템 정의 메타데이터 바인딩이 포함되어 있지만 원하는 모든 바인딩을 사용하여 메타데이터를 게시할 수 있습니다.  이 항목에서는 `wsHttpBinding`을 사용하여 메타데이터를 게시하는 방법을 보여 줍니다.  이 바인딩은 메타데이터를 보안 방법으로 노출하는 옵션을 제공합니다.  이 문서의 코드는 [시작](../../../../docs/framework/wcf/samples/getting-started-sample.md)을 기반으로 합니다.  
...
4.  앞에서 만든 <xref:System.ServiceModel.WSHttpBinding>을 지정하여 메타데이터 교환 끝점을 추가합니다.  

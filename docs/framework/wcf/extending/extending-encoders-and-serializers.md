...
## <a name="in-this-section"></a>단원 내용  
 ...
 [사용자 지정 메시지 포맷터](../../../../docs/framework/wcf/extending/custom-message-formatters.md)  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 메시지의 serialization 및 deserialization을 CLR 형식으로 제어하는 데 사용할 수 있는 사용자 지정 메시지 포맷터에 대해 설명합니다.

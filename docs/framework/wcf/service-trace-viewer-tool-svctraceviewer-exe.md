...
|오류|-모든 예외를 기록 합니다. 다음과 같은 경우에 Error 수준을 사용할 수 있습니다.<br />-잘못 된 캐스팅 예외 인해 코드가 손상 되었습니다.<br />-A "끝점을 만들지 못했습니다." 라는 예외로 인해 응용 프로그램을 시작할 때 실패 합니다.|  

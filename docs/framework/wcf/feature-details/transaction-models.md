...
## System.Transactions 트랜잭션  
 ...
 이러한 두 모델을 사용하여 트랜잭션 응용 프로그램을 만드는 방법[!INCLUDE[crabout](../../../../includes/crabout-md.md)][트랜잭션 응용 프로그램 작성](http://go.microsoft.com/fwlink/?LinkId=94947)을 참조하십시오.  
...
## MSDTC 트랜잭션  
 ...
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [DTC Programmer's Reference](http://go.microsoft.com/fwlink/?LinkId=94948)를 참조하십시오.  

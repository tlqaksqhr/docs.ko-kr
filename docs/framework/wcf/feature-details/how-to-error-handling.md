...
5.  필터 테이블에 포함된 필터에 대해 들어오는 메시지를 평가하려면 라우팅 동작을 사용하여 필터 테이블을 서비스 끝점과 연결해야 합니다.  다음 예제에서는 “filterTable1”을 서비스 끝점과 연결하는 방법을 보여 줍니다.  

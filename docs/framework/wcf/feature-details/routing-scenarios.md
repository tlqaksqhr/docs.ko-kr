...
### 서비스 버전 관리  
 ...
 서비스 버전 관리 구성을 만드는 데 사용되는 단계는 [방법: 서비스 버전 관리](../../../../docs/framework/wcf/feature-details/how-to-service-versioning.md)를 참조하세요.  XPathMessageFilter를 사용하여 사용자 지정 헤더를 기반으로 메시지를 라우트하는 예제는 [고급 필터](../../../../docs/framework/wcf/samples/advanced-filters.md) 샘플을 참조하세요.  
...
### 서비스 데이터 분할  
 ...
 서비스 데이터 분할 구성을 만드는 데 사용되는 단계는 [방법: 서비스 데이터 분할](../../../../docs/framework/wcf/feature-details/how-to-service-data-partitioning.md)을 참조하세요.  필터를 사용하여 URL 및 사용자 지정 헤더를 기반으로 데이터를 분할하는 예제는 [고급 필터](../../../../docs/framework/wcf/samples/advanced-filters.md) 샘플을 참조하세요.  
...
### 동적 라우팅  
 ...
 동적 라우팅을 구현하는 데 사용되는 단계는 [방법: 동적 업데이트](../../../../docs/framework/wcf/feature-details/how-to-dynamic-update.md)을 참조하세요.  동적 라우팅 사용 예제는 [동적 재구성](../../../../docs/framework/wcf/samples/dynamic-reconfiguration.md) 샘플을 참조하세요.  
...
### 프로토콜 브리징  
 ...
 .  라우팅 서비스를 사용하여 프로토콜 간에 메시지를 변환하는 예제는 [브리징과 오류 처리](../../../../docs/framework/wcf/samples/bridging-and-error-handling.md) 샘플을 참조하세요.  
...
### 오류 처리  
 ...
 오류 처리를 구성하는 데 사용되는 단계는 [방법: 오류 처리](../../../../docs/framework/wcf/feature-details/how-to-error-handling.md)를 참조하세요.  오류 처리를 구현하는 예제는 [브리징과 오류 처리](../../../../docs/framework/wcf/samples/bridging-and-error-handling.md) 및 [고급 오류 처리](../../../../docs/framework/wcf/samples/advanced-error-handling.md) 샘플을 참조하세요.  

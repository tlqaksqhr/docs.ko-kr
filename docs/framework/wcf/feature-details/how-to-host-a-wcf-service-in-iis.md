---
title: "방법: IIS에서의 WCF 서비스 호스팅 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
이 항목에서는 IIS(인터넷 정보 서비스)에서 호스팅되는 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 서비스를 만드는 데 필요한 기본 단계에 대해 간략하게 설명합니다. 이 항목에서는 사용자가 IIS에 대해 잘 알고 있으며 IIS 관리 도구를 사용해 IIS 응용 프로그램을 만들고 관리하는 방법을 이해하고 있다고 가정합니다. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]IIS 참조 [인터넷 정보 서비스](http://go.microsoft.com/fwlink/?LinkId=132449) A [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] IIS 환경에서 실행 되는 서비스에서는 프로세스 재활용, 유휴 상태 이면 종료, 프로세스 상태 모니터링 및 메시지 기반 활성화와 같은 IIS 기능을 활용 합니다. 이 호스팅 옵션을 사용하려면 IIS를 적절히 구성해야 하지만 호스팅 코드를 응용 프로그램의 일부로 작성하지 않아도 됩니다. HTTP 전송을 사용하는 경우에만 IIS 호스팅을 사용할 수 있습니다.  
  
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]어떻게 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 및 [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] 상호 작용을 참조 하십시오. [WCF 서비스 및 ASP.NET](../../../../docs/framework/wcf/feature-details/wcf-services-and-aspnet.md)합니다. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]보안 구성, 참조 [보안](../../../../docs/framework/wcf/feature-details/security.md)합니다.  
  
 이 예제의 소스 복사에 대 한 참조 [IIS 호스팅를 사용 하 여 인라인 코드](../../../../docs/framework/wcf/samples/iis-hosting-using-inline-code.md)합니다.  
  
### <a name="to-create-a-service-hosted-by-iis"></a>IIS에 의해 호스팅되는 서비스를 만들려면  
  
1.  IIS가 컴퓨터에 설치되어 실행되고 있는지 확인합니다. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]IIS 설치 및 구성 참조 [설치 및 IIS 7.0 구성](http://go.microsoft.com/fwlink/?LinkID=132128)  
...
10. 응용 프로그램 디렉터리에 “Web.config”라는 파일을 만들고 다음 구성 코드를 파일에 추가합니다. 런타임에 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 인프라에서는 이 정보를 사용하여 클라이언트 응용 프로그램이 통신할 수 있는 끝점을 생성합니다.  
    ...
    ```  
     ...
     다음 예제에서는 구성 파일의 끝점을 명시적으로 지정합니다. 서비스에 끝점을 추가하지 않으면 런타임에서 기본 끝점을 자동으로 추가합니다. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]기본 끝점, 바인딩 및 동작 참조 [단순화 된 구성](../../../../docs/framework/wcf/simplified-configuration.md) 및 [WCF 서비스를 위한 단순화 된 구성](../../../../docs/framework/wcf/samples/simplified-configuration-for-wcf-services.md)합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [호스팅 서비스](../../../../docs/framework/wcf/hosting-services.md)   

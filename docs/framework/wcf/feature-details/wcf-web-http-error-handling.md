---
title: "WCF 웹 HTTP 오류 처리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   서비스 작업에 지정된 <xref:System.ServiceModel.Web.WebGetAttribute> 또는 <xref:System.ServiceModel.Web.WebInvokeAttribute> 특성의 `ResponseFormat` 매개 변수 값  
  
-   <xref:System.ServiceModel.Description.WebHttpBehavior.AutomaticFormatSelectionEnabled%2A>의 값  
  
-   <xref:System.ServiceModel.Web.OutgoingWebResponseContext>에 액세스하는 <xref:System.ServiceModel.Web.OutgoingWebResponseContext.Format%2A> 속성의 값  
  
 이러한 값이 작업의 형식에 영향을 주는 방법[!INCLUDE[crabout](../../../../includes/crabout-md.md)][WCF 웹 HTTP 형식 지정](../../../../docs/framework/wcf/feature-details/wcf-web-http-formatting.md)을 참조하십시오.  

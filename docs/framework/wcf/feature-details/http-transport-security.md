...
#### <a name="iis-70"></a>IIS 7.0  
 설정 하려면 [!INCLUDE[iisver](../../../../includes/iisver-md.md)] 보안 호스트 (SSL 사용), 참조 [IIS 7.0 베타: IIS 7.0에서 Secure Sockets Layer 구성](http://go.microsoft.com/fwlink/?LinkId=88600)합니다.  
  
 사용할 인증서를 구성 하려면 [!INCLUDE[iisver](../../../../includes/iisver-md.md)], 참조 [IIS 7.0 베타: IIS 7.0에서 서버 인증서 구성](http://go.microsoft.com/fwlink/?LinkID=88595)합니다.  
  
#### <a name="iis-60"></a>IIS 6.0  
 설정 하려면 [!INCLUDE[iis601](../../../../includes/iis601-md.md)] 보안 호스트 (SSL 사용), 참조 [Secure Sockets Layer 구성](http://go.microsoft.com/fwlink/?LinkId=88601)합니다.  

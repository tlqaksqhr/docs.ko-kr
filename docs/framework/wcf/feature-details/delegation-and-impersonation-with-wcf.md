...
> [!NOTE]
>  Visual Basic을 사용 해야`Using` 문 또는 C# `using` 문을 가장 동작을 자동으로 되돌립니다. 문을 사용 하지 않는 경우 또는 Visual Basic 또는 C# 이외의 프로그래밍 언어를 사용 하는 경우에 가장 수준이 되돌려야 해야 합니다. 이 작업에 실패하면 서비스 거부 및 권한 상승 공격이 발생할 수 있습니다.  

...
-   <xref:System.ServiceModel.Syndication.SyndicationPerson>  
 ...
 배포 지원은 피드를 서비스로 사용할 수 있도록 <xref:System.ServiceModel.Description.WebHttpBehavior>와 함께 사용되는 <xref:System.ServiceModel.WebHttpBinding> 바인딩을 정의하는 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] REST 프로그래밍 모델을 기반으로 빌드됩니다.  [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] REST 프로그래밍 모델에 대한 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]는 [WCF 웹 HTTP 프로그래밍 모델 개요](../../../../docs/framework/wcf/feature-details/wcf-web-http-programming-model-overview.md)를 참조하세요.  

---
title: "상호 인증서를 사용하는 메시지 보안 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  이 시나리오에서는 서비스 인증서의 협상을 수행하지 않습니다.서비스 인증서는 통신을 수행하기 전에 클라이언트에 제공해야 합니다.서버 인증서는 응용 프로그램과 함께 배포하거나 대역 외 통신에 제공할 수 있습니다.  
 ...
 ![상호 인증서를 사용하는 메시지 보안](../../../../docs/framework/wcf/feature-details/media/f4157312-b17c-416c-a5ee-fa7b54db211b.gif "f4157312\-b17c\-416c\-a5ee\-fa7b54db211b")  
...
### 구성  
 다음과 같이 클라이언트를 구성합니다.클라이언트 인증서는 [\<clientCertificate\>](../../../../docs/framework/configure-apps/file-schema/wcf/clientcertificate-of-clientcredentials-element.md)를 사용하여 지정해야 합니다.또한 서비스 인증서는 [\<defaultCertificate\>](../../../../docs/framework/configure-apps/file-schema/wcf/defaultcertificate-element.md)를 사용하여 지정합니다.  
...
## 참고 항목  
 ...
 [Windows Server App Fabric 보안 모드](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x412)   
 [방법: 개발 중 전송 보안을 위해 WCF에서 임시 인증서 만들기 및 설치](http://go.microsoft.com/fwlink/?LinkId=244264)
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 보안에 사용되는 기본 용어와 개념을 설명합니다.  
  
 [일반적인 보안 시나리오](../../../../docs/framework/wcf/feature-details/common-security-scenarios.md)  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]로 구성할 수 있는 시나리오와 토폴로지를 설명합니다.  
 ...
 부분적으로 신뢰할 수 있는 시나리오를 실행하는 방법과 그러한 시나리오를 실행할 때의 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 제한 사항을 설명합니다.  

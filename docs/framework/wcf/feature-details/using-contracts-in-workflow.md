---
title: "워크플로에서 계약 사용 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 계약 유추  
 <xref:System.ServiceModel.Activities.WorkflowServiceHost>를 사용하여 워크플로 서비스가 호스팅되면 워크플로 정의가 검사되고 워크플로에 있는 메시징 작업 집합을 기반으로 계약이 생성됩니다.특히 계약을 생성하는 데는 다음 작업과 속성이 사용됩니다.  

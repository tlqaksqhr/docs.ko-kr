---
title: "액세스 제어 메커니즘 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
[!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]에서는 여러 방식으로 액세스를 제어할 수 있습니다.이 항목에서는 여러 메커니즘에 대해 간략하게 설명하고 올바른 메커니즘을 선택하여 사용하도록 각 메커니즘을 사용하는 시기에 대해 설명합니다.액세스 기술은 복잡성 순서대로 나열되어 있습니다.<xref:System.Security.Permissions.PrincipalPermissionAttribute>가 가장 단순하며 ID 모델이 가장 복잡합니다.  
 ...
 이러한 메커니즘 이외에 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]를 사용한 가장 및 위임은 [위임 및 가장](../../../../docs/framework/wcf/feature-details/delegation-and-impersonation-with-wcf.md)에 설명되어 있습니다.  
...
## PrincipalPermissionAttribute  
 ...
 특성 사용[!INCLUDE[crabout](../../../../includes/crabout-md.md)][방법: PrincipalPermissionAttribute 클래스를 사용하여 액세스 제한](../../../../docs/framework/wcf/how-to-restrict-access-with-the-principalpermissionattribute-class.md)을 참조하십시오.ID[!INCLUDE[crabout](../../../../includes/crabout-md.md)][서비스 ID 및 인증](../../../../docs/framework/wcf/feature-details/service-identity-and-authentication.md)를 참조하십시오.  
...
>  [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] 기능을 사용하여 데이터베이스를 먼저 채워야지만 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스에서 인증을 위해 해당 데이터베이스를 사용할 수 있습니다.  
 ...
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스에서 멤버 자격 기능 사용[!INCLUDE[crabout](../../../../includes/crabout-md.md)][방법: ASP.NET 멤버 자격 공급자 사용](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-membership-provider.md)을 참조하십시오.  
...
## ASP.NET 역할 공급자  
 ...
 또한 기존 [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] 역할 공급자 데이터베이스가 있고 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스에서 동일한 역할 및 사용자 할당 집합을 사용하려는 경우 [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] 역할 공급자를 사용할 수 있습니다.  
  
 역할 공급자 기능 사용[!INCLUDE[crabout](../../../../includes/crabout-md.md)][방법: 서비스에서 ASP.NET 역할 공급자 사용](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-role-provider-with-a-service.md)을 참조하십시오.  
...
## 권한 부여 관리자  
 ...
 AzMan 및 [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] 역할 공급자에 대한 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]는 [방법: ASP.NET 2.0에서 AxMan\(권한 부여 관리자\) 사용](http://go.microsoft.com/fwlink/?LinkId=88951)\(영문 페이지일 수 있음\)을 참조하십시오.[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스를 위한 AzMan 및 역할 공급자 사용에 대한 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]는 [방법: 서비스에서 ASP.NET 권한 부여 관리자 역할 공급자 사용](../../../../docs/framework/wcf/feature-details/how-to-use-the-aspnet-authorization-manager-role-provider-with-a-service.md)을 참조하십시오.  
...
## ID 모델  
 ...
 ID 모델 클레임 기반 액세스 제어가 유용한 한 가지 예는 발급된 토큰 시나리오에서 페더레이션 자격 증명을 사용하는 경우입니다.페더레이션 및 발급된 토큰에 대한 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]는 [페더레이션 및 발급된 토큰](../../../../docs/framework/wcf/feature-details/federation-and-issued-tokens.md)을 참조하십시오.  
  
 ID 모델[!INCLUDE[crabout](../../../../includes/crabout-md.md)][ID 모델을 사용하여 클레임 및 권한 부여 관리](../../../../docs/framework/wcf/feature-details/managing-claims-and-authorization-with-the-identity-model.md)를 참조하십시오.  

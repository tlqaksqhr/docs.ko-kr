...
## <a name="in-this-section"></a>단원 내용  
 ...
 [JSON과 XML 간 매핑](../../../../docs/framework/wcf/feature-details/mapping-between-json-and-xml.md)  
 JSON 인코딩된 데이터와 문서를 표현하기 위해 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]에서 내부적으로 사용되는 JSON(JavaScript Object Notation) 인코딩과 XML infoset 간의 대응에 대해 설명합니다.  

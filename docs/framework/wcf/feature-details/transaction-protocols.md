---
title: "트랜잭션 프로토콜 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 트랜잭션 프로토콜
[!INCLUDE[indigo1](../../../../includes/indigo1-md.md)]에서는 WS\-Atomic Transaction 및 WS\-Coordination 프로토콜을 구현합니다.  
...
#### 2PC 프로토콜 바인딩 구성  
 ...
 B1131: 구현은 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]의 2PC 메시지 상관 관계를 수행하기 위해 WS\-Addressing에서 설명하는 것처럼`wsa:ReferenceParameters`를 지원해야 합니다.  
...
#### 활성화 메시지 바인딩 구성  
 ...
 B1221: [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]에서는 활성화 메시지에 대해 이중 HTTPS 바인딩\([메시징 프로토콜](../../../../docs/framework/wcf/feature-details/messaging-protocols.md) 참조\)을 사용합니다.요청 및 회신 메시지는 WS\-AT 1.0용 WS\-Addressing 2004\/08 및 WS\-AT 1.1용 WS\-Addressing 2005\/08을 사용하여 상호 관련됩니다.  
...
#### 등록 메시지 바인딩 구성  
 B1231: [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]에서는 이중 HTTPS 바인딩\([메시징 프로토콜](../../../../docs/framework/wcf/feature-details/messaging-protocols.md) 참조\)을 사용합니다.요청 및 회신 메시지는 WS\-AT 1.0용 WS\-Addressing 2004\/08 및 WS\-AT 1.1용 WS\-Addressing 2005\/08을 사용하여 상호 관련됩니다.  
...
#### 2PC 프로토콜 바인딩 구성  
 ...
 B1241: 구현은 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]의 2PC 메시지 상관 관계를 수행하기 위해 WS\-Addressing에서 설명하는 것처럼`wsa:ReferenceParameters`를 지원해야 합니다.  
...
-   R2002: `t:IssuedToken`의 무결성 및 기밀성이 제공되어야 합니다.  
 ...
 B2003: `wscoor:CoordinationContext`의 `wscoor:Identifier`가 상대 URI이면 트랜잭션 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스에서 오류가 반환됩니다.  

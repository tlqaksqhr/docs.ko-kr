...
#### <a name="2pc-protocol-binding-configuration"></a>2PC 프로토콜 바인딩 구성  
 ...
 B1131: 구현에서 지원 해야 `wsa:ReferenceParameters` 의 상관 관계를 달성 하기 위해 Ws-addressing에서 설명 된 대로 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]의 2PC 메시지입니다.  
...
#### <a name="activation-message-binding-configuration"></a>활성화 메시지 바인딩 구성  
 ...
 B1221: [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 이중 HTTPS 바인딩을 사용 하 여 (에 설명 된 [메시징 프로토콜](../../../../docs/framework/wcf/feature-details/messaging-protocols.md)) 활성화 메시지에 대 한 합니다. 요청 및 회신 메시지는 WS-AT 1.0용 WS-Addressing 2004/08 및 WS-AT 1.1용 WS-Addressing 2005/08을 사용하여 상호 관련됩니다.  
...
#### <a name="registration-message-binding-configuration"></a>등록 메시지 바인딩 구성  
 B1231: [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 이중 HTTPS 바인딩을 사용 하 여 (에 설명 된 [메시징 프로토콜](../../../../docs/framework/wcf/feature-details/messaging-protocols.md)). 요청 및 회신 메시지는 WS-AT 1.0용 WS-Addressing 2004/08 및 WS-AT 1.1용 WS-Addressing 2005/08을 사용하여 상호 관련됩니다.  
...
#### <a name="2pc-protocol-binding-configuration"></a>2PC 프로토콜 바인딩 구성  
 ...
 B1241: 구현은 `wsa:ReferenceParameters`의 2PC 메시지 상관 관계를 수행하기 위해 WS-Addressing에서 설명하는 것처럼[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]를 지원해야 합니다.  
...
-   R2002: `t:IssuedToken`의 무결성 및 기밀성이 제공되어야 합니다.  
 ...
 B2003: `wscoor:Identifier`의 `wscoor:CoordinationContext`가 상대 URI이면 트랜잭션 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스에서 오류가 반환됩니다.  

---
title: "Windows Communication Foundation 채택 예상: 이후의 마이그레이션을 용이하게 함 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Windows Communication Foundation 채택 예상: 이후의 마이그레이션을 용이하게 함
...
-   <xref:System.Web.Services.WebMethodAttribute>의 `MessageName` 매개 변수를 사용하여 서비스 작업에 명시적 이름을 제공합니다.  

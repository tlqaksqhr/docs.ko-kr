...
## <a name="in-this-section"></a>단원 내용  
 ...
 [서비스 메타 데이터에서 WCF 클라이언트 생성](../../../../docs/framework/wcf/feature-details/generating-a-wcf-client-from-service-metadata.md)  
 Svcutil.exe를 사용하여 메타데이터를 검색하는 방법과 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 클라이언트를 생성하는 방법을 보여 줍니다.  

---
title: "COM 응용 프로그램과 통합 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "COM [WCF]"
  - "COM [WCF], Windows Communication Foundation 통합"
  - "WCF, COM 통합"
  - "WCF, 코드 다시 사용"
  - "Windows Communication Foundation, COM 통합"
  - "Windows Communication Foundation, 코드 다시 사용"
...
---
# COM 응용 프로그램과 통합
[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스 모니커를 사용하여 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 서비스를 직접 기존 코드에 통합할 수 있습니다.  서비스 모니커는 Office VBA, Visual Basic 6.0 또는 Visual C\+\+ 6.0과 같은 다양한 범위의 COM 기반 개발 환경에서 사용할 수 있습니다.  

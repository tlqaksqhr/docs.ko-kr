...
## <a name="in-this-section"></a>섹션 내용  
 ...
 COM 응용 프로그램 내의 WCF 서비스 모니커를 사용 하려면 필요한 특성 사용된 하는 형식을 COM에 등록 하 고 필요한 바인딩 구성을 사용 하 여 COM 응용 프로그램과 모니커를 구성 합니다.  
 ...
 WCF WSDL 모니커를 사용 하는 WCF 샘플을 호출 하는 방법을 설명 합니다.  
 ...
 Mex 끝점을 지정 하는 WCF 모니커를 사용 하는 WCF 샘플을 호출 하는 방법을 설명 합니다.  
  
 [방법: 채널 보안 자격 증명 지정](../../../../docs/framework/wcf/feature-details/how-to-specify-channel-security-credentials.md)  
 WCF 서비스 모니커에 지원는 `IChannelCredentials` 채널 자격 증명을 지정 하기 위한 대체 방법의 범위를 허용 하는 인터페이스입니다.  

...
## <a name="in-this-section"></a>단원 내용  
 ...
 [방법: 서비스 모니커를 사용 하 여 메타 데이터 교환 계약](../../../../docs/framework/wcf/feature-details/how-to-use-a-service-moniker-with-metadata-exchange-contracts.md)  
 ...
 [방법: 채널 보안 자격 증명을 지정 합니다.](../../../../docs/framework/wcf/feature-details/how-to-specify-channel-security-credentials.md)  

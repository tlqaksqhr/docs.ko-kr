...
ms.locfileid: "33496590"
---
# <a name="queues-in-windows-communication-foundation"></a>Windows Communication Foundation의 큐
이 섹션의 항목 큐에 대 한 Windows Communication Foundation (WCF) 지원에 설명 합니다. WCF 활용 Microsoft 메시지 큐 (이전의 MSMQ)를 전송 하 여 큐에 대 한 지원 하며 다음과 같은 시나리오를 지원 합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 사용 하는 방법에 설명 된 <xref:System.ServiceModel.NetMsmqBinding> WCF 클라이언트와 WCF 서비스 간에 통신 하는 클래스입니다.  
 ...
 사용 하는 방법에 설명 된 <xref:System.ServiceModel.MsmqIntegration.MsmqIntegrationBinding> WCF 및 메시지 큐 응용 프로그램 간에 통신 합니다.  
 ...
 WCF 큐 기능 간의 차이점을 요약 [!INCLUDE[wv](../../../../includes/wv-md.md)], [!INCLUDE[ws2003](../../../../includes/ws2003-md.md)], 및 [!INCLUDE[wxp](../../../../includes/wxp-md.md)]합니다.  
 ...
 WCF를 사용 하는 것에 대 한 유용한 대기 중인 통신에 설명 합니다.  

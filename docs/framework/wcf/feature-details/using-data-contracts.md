---
title: "데이터 계약 사용 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   유효한 데이터 계약에서는 모든 데이터 멤버를 serialize할 수 있어야 합니다. 모든 serialize 가능 형식의 목록은 [데이터 계약 Serializer에서 지원하는 형식](../../../../docs/framework/wcf/feature-details/types-supported-by-the-data-contract-serializer.md)을 참조하십시오.  
 ...
 데이터 계약을 정의하는 WCF 서비스의 전체 코드 샘플을 보려면 [기본 데이터 계약](../../../../docs/framework/wcf/samples/basic-data-contract.md) 샘플을 참조하십시오.  

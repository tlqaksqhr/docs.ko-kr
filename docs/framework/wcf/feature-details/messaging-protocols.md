...
```  
 ...
 많은 MIME 구현 내에 포함 된 값에 대 한 요구 사항 완화 "\<" 및 ">" 전자 메일 주소를 사용 및 `absoluteURI` 로 묶인 "\<", ">" 전자 메일 주소와 함께 합니다. 이 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 버전에서는 다음과 같은 형식의 Content-ID MIME 헤더 값을 사용합니다.  

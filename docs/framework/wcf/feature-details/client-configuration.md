...
### <a name="configuring-metadata"></a>메타데이터 구성  
 [ \<메타 데이터 >](../../../../docs/framework/configure-apps/file-schema/wcf/metadata.md) 메타 데이터를 등록 하는 데 사용 되는 설정을 가져오기 확장을 지정 하려면 요소를 사용 합니다. [!INCLUDE[crabout](../../../../includes/crabout-md.md)]참조 메타 데이터 시스템 확장[메타 데이터 시스템 확장](../../../../docs/framework/wcf/extending/extending-the-metadata-system.md)합니다.  

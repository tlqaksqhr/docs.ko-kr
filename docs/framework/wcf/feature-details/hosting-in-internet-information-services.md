...
-   IIS에서 호스트되는 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스는 [!INCLUDE[vstecasplong](../../../../includes/vstecasplong-md.md)]과 동일한 동적 컴파일 모델을 사용하여 호스트된 서비스의 개발 및 배포를 단순화합니다.  
 ...
 IIS에서 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 서비스를 호스트하는 경우 IIS 5.1 및 [!INCLUDE[iis601](../../../../includes/iis601-md.md)]은 HTTP 통신으로만 제한됩니다. 호스팅 환경 선택 하는 방법에 대 한 자세한 내용은 참조 [호스팅 서비스](../../../../docs/framework/wcf/hosting-services.md)합니다.  

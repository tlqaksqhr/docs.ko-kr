---
title: "방법: 이중 계약 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  변수를 <xref:System.ServiceModel.OperationContext> 클래스의 <xref:System.ServiceModel.OperationContext.GetCallbackChannel%2A> 메서드에서 반환한 개체 참조로 설정합니다.  
...
-   [ServiceModel Metadata 유틸리티 도구\(Svcutil.exe\)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md)를 사용하여 클라이언트의 WSDL 문서 및 \(선택적\) 코드와 구성을 검색합니다.  

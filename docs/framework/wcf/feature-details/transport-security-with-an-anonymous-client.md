---
title: "익명 클라이언트를 사용하는 전송 보안 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
이 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 시나리오에서는 기밀성 및 무결성 확보를 위해 전송 보안\(HTTPS\)을 사용합니다.서버는 SSL\(Secure Sockets Layer\) 인증서로 인증되어야 하며 클라이언트는 서버의 인증서를 신뢰해야 합니다.클라이언트는 어떤 메커니즘으로도 인증되지 않는 익명 클라이언트입니다.  
 ...
 샘플 응용 프로그램을 보려면 [WS 전송 보안](../../../../docs/framework/wcf/samples/ws-transport-security.md)을 참조하십시오.전송 보안[!INCLUDE[crabout](../../../../includes/crabout-md.md)][전송 보안 개요](../../../../docs/framework/wcf/feature-details/transport-security-overview.md)를 참조하십시오.  
  
 서비스에서 인증서를 사용하는 방법에 대한 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]는 [인증서 작업](../../../../docs/framework/wcf/feature-details/working-with-certificates.md) 및 [방법: SSL 인증서를 사용하여 포트 구성](../../../../docs/framework/wcf/feature-details/how-to-configure-a-port-with-an-ssl-certificate.md)을 참조하십시오.  
  
 ![익명 클라이언트에서 전송 보안 사용](../../../../docs/framework/wcf/feature-details/media/8fa2e931-0cfb-4aaa-9272-91d652b85d8d.gif "8fa2e931\-0cfb\-4aaa\-9272\-91d652b85d8d")  

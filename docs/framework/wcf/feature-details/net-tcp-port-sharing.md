---
title: "Net.TCP 포트 공유 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 포트 공유 설치  
 Net.TCP Port Sharing Service는 [!INCLUDE[vstecwinfx](../../../../includes/vstecwinfx-md.md)]을 지원하는 모든 운영 체제에서 사용할 수 있지만 기본적으로 서비스가 활성화되어 있지는 않습니다.  보안 예방 조치로 관리자는 Net.TCP Port Sharing Service를 처음 사용하기 전에 수동으로 활성화해야 합니다.  Net.TCP Port Sharing Service는 포트 공유 서비스에서 소유한 네트워크 소켓의 여러 특징을 조작할 수 있는 구성 옵션을 노출합니다.  [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [방법: Net.TCP Port Sharing Service 사용](../../../../docs/framework/wcf/feature-details/how-to-enable-the-net-tcp-port-sharing-service.md).  
  
## 응용 프로그램에서 Net.tcp 포트 공유 사용  
 ...
 이 작업을 수행하는 방법에 대한 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]는 [방법: 포트 공유 사용하도록 WCF 서비스 구성](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-service-to-use-port-sharing.md)을 참조하세요.  
...
## 참고 항목  
 ...
 [방법: 포트 공유 사용하도록 WCF 서비스 구성](../../../../docs/framework/wcf/feature-details/how-to-configure-a-wcf-service-to-use-port-sharing.md)   

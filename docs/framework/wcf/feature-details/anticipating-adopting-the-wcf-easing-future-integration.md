---
title: "Windows Communication Foundation 채택 예상: 이후의 통합을 용이하게 함 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 WS\-I Basic Profile 1.1을 준수하는 ASP.NET 웹 서비스는 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]의 미리 정의된 바인딩인 <xref:System.ServiceModel.BasicHttpBinding>을 사용하여 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 클라이언트와 상호 운용 가능합니다.  

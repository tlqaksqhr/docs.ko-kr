...
-   사용 가능한 메서드를 식별하는 계약  
 ...
 끝점의 개별 부분을 지정하는 방법에 대한 자세한 내용은 다음을 참조하세요.  

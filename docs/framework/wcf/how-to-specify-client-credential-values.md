...
Windows Communication Foundation (WCF)를 사용 하 여 서비스 클라이언트가 서비스에 인증 하는 방법을 지정할 수 있습니다. 예를 들면 서비스는 클라이언트가 인증서를 사용하여 인증하도록 규정할 수 있습니다.  
...
2.  생성된 된 코드를 사용 하 여 WCF 클라이언트의 인스턴스를 만듭니다.  

...
### <a name="wcf-service-item-template"></a>WCF 서비스 항목 템플릿  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 서비스 항목 템플릿을 추가 하는 빠른 방법을 제공 하는 사용자 지정 템플릿을 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 기존 Visual Studio 프로젝트에는 서비스입니다.  

---
title: ".NET Framework 개발 가이드 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 단원 내용  
 ...
 [WCF를 사용하여 개발한 서비스 기반 응용 프로그램](../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md)  
 ...
 .NET Framework 를 사용하여 여러 플랫폼과 휴대폰, 데스크톱 및 웹 등 여러 장치 간에 공유할 수 있는 어셈블리를 빌드하는 방법에 대한 정보를 제공합니다.  
 ...
 [Building Workflows in the .NET Framework](http://msdn.microsoft.com/ko-kr/cbf3880f-dc7b-466d-b808-1109b1223f4a)  
 Windows WF\(Workflow Foundation\) 사용을 위한 프로그래밍 모델, 샘플 및 도구에 대한 정보를 제공합니다.  
  
 [Advanced Reading for the .NET Framework](http://msdn.microsoft.com/ko-kr/faae8083-fecb-4514-b133-b0a5a32a7c3c)  
 확장성, 상호 운용성 및 리플렉션을 비롯한 .NET Framework의 고급 개발 작업 및 기술에 대한 정보를 제공합니다.  런타임 호스트, 컴파일러, 디스어셈블러, 디버거, 프로파일러 등 관리되는 앱에서 사용할 수 있는 관리되지 않는 API에 대한 참조 항목도 포함되어 있습니다.  
  
## 참조  
 [.NET Framework 클래스 라이브러리](http://go.microsoft.com/fwlink/p/?LinkID=227195)  

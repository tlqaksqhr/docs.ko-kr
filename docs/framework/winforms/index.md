...
## <a name="related-sections"></a>관련 단원  
 ...
 [ClickOnce 보안 및 배포](http://msdn.microsoft.com/library/abab6d34-c3c2-45c1-a8b6-43c7d3131e7a)  
 ClickOnce 배포의 원칙을 설명합니다.  
  
 [Windows Forms/MFC 프로그래밍의 차이점](http://msdn.microsoft.com/library/f3bfcf45-cfd4-45a4-8cde-5f4dbb18ee51)  
 MFC 응용 프로그램과 Windows Forms 간의 차이점을 설명합니다.  
  
 [Visual Studio에서 데이터 액세스](http://msdn.microsoft.com/library/9812a6d5-23d2-4427-8b98-70a2abfec3bc)  
 응용 프로그램에 데이터 액세스 기능을 통합하는 방법을 설명합니다.  
  
 [Windows Forms 응용 프로그램](http://msdn.microsoft.com/library/7092ee7f-8378-4def-aef8-1695bd97cf14)  
 ...
 <xref:System.Console> 클래스를 사용하여 콘솔 응용 프로그램을 만드는 방법에 대한 기본 사항을 설명합니다.

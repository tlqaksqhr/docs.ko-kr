---
title: "NotifyIcon 구성 요소 개요(Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "NotifyIcon 구성 요소, NotifyIcon 구성 요소 정보"
  - "시스템 트레이 아이콘, 시스템 트레이 아이콘 정보"
  - "시스템 트레이 아이콘, Windows Forms에서 사용"
...
---
# NotifyIcon 구성 요소 개요(Windows Forms)

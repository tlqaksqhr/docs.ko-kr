...
## <a name="in-this-section"></a>섹션 내용  
 ...
 컨트롤에 열 머리글이 표시 되지 않게 하는 방법을 설명 합니다.  
 ...
 사용자가 컨트롤에서 열을 다시 정렬할 수 있도록 하는 방법에 설명 합니다.  
 ...
 컨트롤의 특정 열을 편집 하 여 사용자가 방지 하는 방법에 설명 합니다.  
 ...
 사용자가 행을 추가 하지 못하도록 하려면 컨트롤의 아래쪽에 있는 새 레코드에 대 한 행을 제거 하는 방법에 설명 합니다. 또한 사용자가 행을 삭제 하지 못하도록 하는 방법을 설명 합니다.  

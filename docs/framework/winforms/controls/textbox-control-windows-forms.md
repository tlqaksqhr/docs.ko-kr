...
## <a name="in-this-section"></a>섹션 내용  
 ...
 편집 컨트롤의 포커스를 처음 가져오면 삽입 포인터가 표시 하는 위치를 지정 하기 위한 지침을 제공 합니다.  
 ...
 만들기 텍스트 상자를 스크롤할 수 있는 방법을 설명 합니다.  

---
title: "파일 대화 상자의 사용자 지정 위치에 대한 알려진 폴더 GUID | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "사용자 지정 위치, 알려진 폴더 GUID"
  - "알려진 폴더 GUID, 사용자 지정 위치"
  - "Windows Vista 알려진 폴더 GUID, 사용자 지정 위치"
...
<xref:System.Windows.Forms.FileDialog.CustomPlaces%2A> 컬렉션에 폴더를 추가하는 경우 <xref:System.Guid>를 사용하여 [!INCLUDE[wiprlhext](../../../../includes/wiprlhext-md.md)] 알려진 폴더를 지정합니다.  알려진 폴더 GUID는 대\/소문자를 구분하지 않으며 [!INCLUDE[winSDK](../../../../includes/winsdk-md.md)]의 KnownFolders.h 파일에 정의되어 있습니다.  
  
> [!NOTE]
>  경우에 따라 <xref:System.Windows.Forms.FileDialogCustomPlacesCollection>에 추가된 알려진 폴더가 **즐겨찾기 링크** 영역에 나타나지 않을 수도 있습니다.  예를 들어 지정된 알려진 폴더가 응용 프로그램을 실행 중인 컴퓨터에 표시되지 않으면 알려진 폴더가 나타나지 않습니다.  
  
## GUID 목록  
 다음 표에서는 [!INCLUDE[wiprlhext](../../../../includes/wiprlhext-md.md)]의 알려진 폴더 및 관련 <xref:System.Guid>를 보여 줍니다.  

...
2.  에 **도구 상자**구성 요소를 클릭 하 고 폼으로 끕니다.  
 ...
 또한 런타임 시 구성 요소는 폼에 추가할 수 있습니다. 이것이 일반적인 시나리오에서 특히 않기 때문에 구성 요소 사용자 인터페이스가 있는 컨트롤과 달리 visual 식입니다. 다음 예제에는 <xref:System.Windows.Forms.Timer> 런타임 시 구성 요소를 추가 합니다. (유의 [!INCLUDE[vsprvs](../../../../includes/vsprvs-md.md)] 다른 타이머의 수를 포함 됩니다;이 경우 Windows Forms를 사용 하 여 <xref:System.Windows.Forms.Timer> 구성 요소입니다. 다양 한 타이머에 대 한 자세한 내용은 [!INCLUDE[vsprvs](../../../../includes/vsprvs-md.md)], 참조 [서버 기반 타이머 소개](http://msdn.microsoft.com/library/adc0bc0a-a519-4812-bafc-fb9d1a5801fc).)  

...
## <a name="in-this-section"></a>섹션 내용  
 ...
 프로그래밍 방식으로 항목을 목록에 지정된 된 위치에 표시를 결정 하기 위한 지침을 제공 합니다.  
 ...
 추가 또는 항목 컨트롤의 목록에서 항목을 제거 하기 위한 지침을 제공 합니다.  
 ...
 표시 및 유용한 형식에 양식 데이터를 저장 하기 위한 지침을 제공 합니다.  
 ...
 데이터 원본 목록 기반 컨트롤에 바인딩하는 방법을 설명 합니다.  
 ...
 데이터 소스에서 목록 데이터를 정렬 하는 방법을 설명 합니다.  

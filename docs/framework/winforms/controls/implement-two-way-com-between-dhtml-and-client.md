---
title: "방법: DHTML 코드와 클라이언트 응용 프로그램 코드 간의 양방향 통신 구현 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "통신, DHTML과 클라이언트 응용 프로그램"
  - "DHTML, Windows Forms에 포함"
  - "예제[Windows Forms], WebBrowser 컨트롤"
  - "WebBrowser 컨트롤[Windows Forms], DHTML과 클라이언트 응용 프로그램 간의 통신"

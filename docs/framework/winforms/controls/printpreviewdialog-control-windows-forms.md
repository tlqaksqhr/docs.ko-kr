---
title: "PrintPreviewDialog 컨트롤(Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "인쇄 미리 보기, 기본 인터페이스(디자이너 사용)"
  - "인쇄[Windows Forms], 인쇄 미리 보기(디자이너 사용)"
  - "PrintPreview 컨트롤(디자이너 사용)"
  - "PrintPreviewDialog 컨트롤(디자이너 사용)"
...
---
# PrintPreviewDialog 컨트롤(Windows Forms)

---
title: "컨트롤 형식 권장 사항 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "사용자 지정 컨트롤[Windows Forms], 형식"
  - "상속, Windows Forms 사용자 지정 컨트롤"
  - "사용자 정의 컨트롤[Windows Forms], 사용 시기"
...
> [!NOTE]
>  Web Forms에서 사용할 컨트롤을 작성하려는 경우 [Developing Custom ASP.NET Server Controls](../Topic/Developing%20Custom%20ASP.NET%20Server%20Controls.md)을 참조하세요.  

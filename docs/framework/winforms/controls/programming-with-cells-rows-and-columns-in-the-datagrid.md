...
## <a name="in-this-section"></a>섹션 내용  
 ...
 처리 하는 방법에 설명 된 <xref:System.Windows.Forms.DataGridView.CellValueChanged> 및 <xref:System.Windows.Forms.DataGridView.CellStateChanged> 이벤트입니다.  
  
 [방법: Windows Forms DataGridView 컨트롤에서 밴드 조작](../../../../docs/framework/winforms/controls/how-to-manipulate-bands-in-the-windows-forms-datagridview-control.md)  
 형식의 개체를 사용 하 여 프로그래밍 하는 방법을 설명 <xref:System.Windows.Forms.DataGridViewBand>, 행과 열에 대 한 기본 형식입니다.입니다.  
  
 [방법: Windows Forms DataGridView 컨트롤에서 행 조작](../../../../docs/framework/winforms/controls/how-to-manipulate-rows-in-the-windows-forms-datagridview-control.md)  
 형식의 개체를 사용 하 여 프로그래밍 하는 방법을 설명 `DataGridViewRow`합니다.  
 ...
 형식의 개체를 사용 하 여 프로그래밍 하는 방법을 설명 `DataGridViewColumn`합니다.  
 ...
 사용 하 여 프로그래밍 하는 방법에 설명 된 `DataGridViewImageColumn` 클래스입니다.  

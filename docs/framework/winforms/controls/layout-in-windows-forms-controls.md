...
## <a name="in-this-section"></a>섹션 내용  
 ...
 설명의 <xref:System.Windows.Forms.Control.Margin%2A> 및 <xref:System.Windows.Forms.Control.Padding%2A> 속성 및 레이아웃에서의 역할입니다.  
 ...
 [방법: 안쪽 여백을 사용하여 Windows Forms 컨트롤 주위에 테두리 만들기](../../../../docs/framework/winforms/controls/how-to-create-a-border-around-a-windows-forms-control-using-padding.md)  
 사용 하는 방법을 보여 줍니다.는 <xref:System.Windows.Forms.Control.Padding%2A> 속성을 컨트롤에 간략하게 설명 합니다.  
  
 [방법: 사용자 지정 레이아웃 엔진 구현](../../../../docs/framework/winforms/controls/how-to-implement-a-custom-layout-engine.md)  
 구현 하는 방법을 보여 줍니다.는 <xref:System.Windows.Forms.Layout.LayoutEngine> 을 Windows Forms 컨트롤을 정렬 합니다.  

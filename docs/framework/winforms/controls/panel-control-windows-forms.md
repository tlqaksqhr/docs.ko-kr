...
## <a name="in-this-section"></a>섹션 내용  
 ...
 컨트롤 디자이너를 사용 하는 패널을 그룹화 하는 방법을 설명 합니다.  
...
## <a name="related-sections"></a>관련 단원  
 ...
 컨트롤을 추가 하 고 폼의 컨테이너 컨트롤에서 컨트롤을 제거 하는 방법에 설명 합니다.

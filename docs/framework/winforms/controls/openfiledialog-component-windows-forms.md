---
title: "OpenFileDialog 구성 요소(Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Windows Forms <xref:System.Windows.Forms.OpenFileDialog> 구성 요소는 미리 구성된 대화 상자입니다.  Windows 운영 체제에서 노출되는 것과 같은 **파일 열기** 대화 상자입니다.  <xref:System.Windows.Forms.CommonDialog> 클래스에서 상속됩니다.  
...
## 단원 내용  
 ...
 [방법: OpenFileDialog 구성 요소를 사용하여 파일 열기](../../../../docs/framework/winforms/controls/how-to-open-files-using-the-openfiledialog-component.md)  
...
## 관련 단원  
 ...
 [Windows Forms 대화 상자의 필수 코드](http://go.microsoft.com/fwlink/?LinkID=102575)  

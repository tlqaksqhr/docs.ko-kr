...
## <a name="working-with-tabcontrol"></a>TabControl 작업  
 가장 중요 한 속성은 <xref:System.Windows.Forms.TabControl> 은 <xref:System.Windows.Forms.TabControl.TabPages%2A>를 개별 탭에 포함 된 합니다. 각 개별 탭은는 <xref:System.Windows.Forms.TabPage> 개체입니다. 탭을 클릭 하면 발생는 <xref:System.Windows.Forms.Control.Click> 이벤트에 대 한 <xref:System.Windows.Forms.TabPage> 개체입니다.  

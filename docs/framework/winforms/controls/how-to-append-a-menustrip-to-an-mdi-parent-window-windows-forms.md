---
title: "방법: MDI 부모 창에 MenuStrip 추가(Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "MDI, 메뉴 항목 병합"
  - "MenuStrip 컨트롤[Windows Forms], 추가"
...
일부 응용 프로그램에서는 MDI\(다중 문서 인터페이스\) 자식 창의 종류가 MDI 부모 창과 다를 수 있습니다.  예를 들어 MDI 부모는 스프레드시트이고 MDI 자식은 차트일 수 있습니다.  이 경우 다른 종류의 MDI 자식 창이 활성화될 때 MDI 부모 메뉴의 내용을 MDI 자식 메뉴의 내용으로 업데이트하려고 합니다.  
 ...
 [MDI\(다중 문서 인터페이스\) 응용 프로그램](http://msdn.microsoft.com/library/xyhh2e7e\(v=vs.110\))을 참조하세요.  
...
9. `&Special`, `Command&1` 및 `Command&2` 메뉴 항목의 <xref:System.Windows.Forms.MergeAction> 속성을 <xref:System.Windows.Forms.MergeAction>로 설정합니다.  

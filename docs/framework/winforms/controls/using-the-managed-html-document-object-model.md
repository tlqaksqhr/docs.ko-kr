...
## <a name="in-this-section"></a>섹션 내용  
 ...
 원래, 수정 되지 않은 HTML 소스를 가져오는 방법 및 DOM의 현재 상태를 반영 하는 "라이브" 소스를 가져오는 방법에 설명  
 ...
 프레임 및 프레임 세트 이란, 및 프레임의 DOM에 액세스 하는 방법을 설명 합니다.  
 ...
 관리 되는 항목을 갖지 않는 내부 DOM의 멤버에 액세스 하는 방법을 설명 합니다.  
...
## <a name="see-also"></a>참고 항목  
 [DHTML 개체 모델에 대 한](http://msdn.microsoft.com/library/default.asp?url=/workshop/author/om/doc_object.asp)

...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [GDI+의 메타파일](../../../../docs/framework/winforms/advanced/metafiles-in-gdi.md)  
 메타파일에 대한 [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)] 지원을 설명합니다.  
  
 [GDI+에서 이미지 그리기, 위치 지정 및 복제](../../../../docs/framework/winforms/advanced/drawing-positioning-and-cloning-images-in-gdi.md)  

---
title: "방법: 버퍼링된 그래픽 수동 렌더링 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "BufferedGraphics 클래스"
  - "깜빡임, 그래픽을 수동으로 렌더링하여 줄이기"
  - "그래픽[Windows Forms], 렌더링"
...
1.  <xref:System.Drawing.BufferedGraphicsContext> 클래스의 인스턴스에 대한 참조를 가져옵니다.  자세한 내용은 [방법: 버퍼링된 그래픽 수동 관리](../../../../docs/framework/winforms/advanced/how-to-manually-manage-buffered-graphics.md)를 참조하세요.  
...
3.  <xref:System.Drawing.BufferedGraphics.Graphics%2A> 속성을 설정하여 그래픽 버퍼에 그래픽을 그립니다.  예를 들면 다음과 같습니다.  

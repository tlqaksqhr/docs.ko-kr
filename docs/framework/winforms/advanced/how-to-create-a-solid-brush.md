---
title: "방법: 단색 브러시 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 방법: 단색 브러시 만들기
이 예제에서는 도형을 채우기 위해 <xref:System.Drawing.Graphics> 개체에서 사용할 수 있는 <xref:System.Drawing.SolidBrush> 개체를 만듭니다.  
...
## 강력한 프로그래밍  
 브러시 개체와 같이 시스템 리소스를 사용하는 개체에 대해서는 사용 후 항상 <xref:System.IDisposable.Dispose%2A>를 호출해야 합니다.  

---
title: "방법: 자식 테이블에서 선택된 행이 올바른 위치에 유지되도록 설정 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "캐시[.NET Framework], 자식 위치"
  - "자식 위치"
  - "자식 테이블 행 선택"
  - "현재 자식 위치"
  - "데이터 바인딩[.NET Framework], 행 선택"
  - "마스터/자세히 보기[Windows Forms]"
  - "마스터-세부 사항 뷰"
  - "부모/자식 뷰[Windows Forms]"
  - "자식 위치 다시 설정"
  - "행 위치[Windows Forms]"
...
2.  바인딩의 <xref:System.Windows.Forms.CurrencyManager>에 대한 <xref:System.Windows.Forms.CurrencyManager.ListChanged> 이벤트를 처리하고 <xref:System.ComponentModel.ListChangedType>의 <xref:System.ComponentModel.ListChangedType>을 확인합니다.  

---
title: "Windows Forms에 사용자 입력 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "키보드 입력, Windows Forms에서 사용"
  - "키보드, 키보드 입력"
  - "마우스 입력, Windows Forms에서 사용"
...
## 단원 내용  
 ...
 [방법: 코드에서 마우스 및 키보드 이벤트 시뮬레이션](../../../docs/framework/winforms/how-to-simulate-mouse-and-keyboard-events-in-code.md)  
 마우스 및 키보드 입력을 프로그래밍 방식으로 시뮬레이션하는 여러 가지 방법을 보여 줍니다.  
  
 [방법: Windows Forms 컨트롤에서 사용자 입력 이벤트 처리](../../../docs/framework/winforms/how-to-handle-user-input-events-in-windows-forms-controls.md)  
...
## 관련 단원  
 [Windows Forms에서 이벤트 처리기 만들기](http://msdn.microsoft.com/library/dacysss4\(v=vs.110\))를 참조하세요.
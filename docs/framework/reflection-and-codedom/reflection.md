---
title: ".NET Framework의 리플렉션 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "어셈블리[.NET Framework], 리플렉션"
  - "Assembly 클래스, 리플렉션"
  - "공용 언어 런타임, 리플렉션"
  - "ConstructorInfo 클래스, 리플렉션"
  - "런타임에 형식 정보 검색"
  - "EventInfo 클래스, 리플렉션"
  - "FieldInfo 클래스, 리플렉션"
  - "MethodInfo 클래스, 리플렉션"
  - "Module 클래스, 리플렉션"
  - "모듈, 리플렉션"
  - "ParameterInfo 클래스, 리플렉션"
  - "PropertyInfo 클래스, 리플렉션"
  - "리플렉션"
  - "리플렉션, 리플렉션 정보"
  - "런타임, 리플렉션"
  - "형식 브라우저"
...
|[동적으로 형식 로드 및 사용](../../../docs/framework/reflection-and-codedom/dynamically-loading-and-using-types.md)|런타임 바인딩을 지원하는 리플렉션 사용자 지정 바인딩 인터페이스를 설명합니다.|  
...
|[동적 메서드 및 어셈블리 생성](../../../docs/framework/reflection-and-codedom/emitting-dynamic-methods-and-assemblies.md)|동적 어셈블리 및 동적 메서드를 생성하는 방법을 설명합니다.|  

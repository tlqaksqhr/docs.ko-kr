---
title: "스레드 풀 ETW 이벤트 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### ThreadPoolWorkerThreadStart 및 ThreadPoolWorkerThreadStop  
 다음 표에서는 이러한 이벤트의 키워드 및 수준을 보여 줍니다. 자세한 내용은 [CLR ETW 키워드 및 수준](../../../docs/framework/performance/clr-etw-keywords-and-levels.md)을 참조하세요.  

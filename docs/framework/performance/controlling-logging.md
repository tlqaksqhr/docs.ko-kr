...
-   [Windows 성능 도구 키트](http://msdn.microsoft.com/library/windows/hardware/hh162945.aspx)에 있는 [Xperf](http://msdn.microsoft.com/library/windows/hardware/hh162920.aspx) 도구 Xperf에 대한 자세한 내용은 [Windows Performance 블로그](http://go.microsoft.com/fwlink/?LinkId=179509)를 참조하세요.  

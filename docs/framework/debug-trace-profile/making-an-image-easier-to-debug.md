...
> [!NOTE]
>  <xref:System.Diagnostics.DebuggableAttribute?displayProperty=fullName>을 통해 어셈블리의 설정을 제어합니다. **DebuggableAttribute**에는 JIT 컴파일러를 최적화해야 하는지와 추적 정보를 생성해야 하는지에 관한 설정을 기록하는 두 개의 필드가 있습니다. .NET Framework 버전 2.0에서 JIT 컴파일러는 항상 추적 정보를 생성합니다.  

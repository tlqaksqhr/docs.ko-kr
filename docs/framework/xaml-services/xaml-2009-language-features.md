...
## <a name="xaml-2009-support-in-wpf-and-visual-studio"></a>WPF 및 Visual Studio의 XAML 2009 지원  
 ...
 WPF에서 느슨한 XAML을 로드하는 기존 기술은 태그 컴파일된 XAML보다 제한적인 CLR 형식 및 형식 시스템에 대해 가능한 보안 및 액세스 제한이 있을 수도 있습니다. 자세한 내용은 [보안(WPF)](../../../docs/framework/wpf/security-wpf.md) 또는 [WPF 보안 전략 - 플랫폼 보안](../../../docs/framework/wpf/wpf-security-strategy-platform-security.md)을 참조하세요.  

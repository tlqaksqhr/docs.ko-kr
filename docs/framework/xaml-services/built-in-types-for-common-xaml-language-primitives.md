...
### x:Boolean  
 ...
 XAML은 `x:Boolean`에 대한 값을 대\/소문자 구분 없이 구문 분석합니다. 이때 `x:Bool`로 대체할 수 없습니다. XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.17 및 5.4.11](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
  
### x:Char  
 CLR 백업의 경우 `x:Char` 기본 형식은 <xref:System.Char>에 해당합니다.  
  
 String 및 char 형식은 XML 수준에서 파일의 전체 인코딩과 상호 작용합니다. XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.7 및 5.4.1](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
  
### x:String  
 CLR 백업의 경우 `x:String` 기본 형식은 <xref:System.String>에 해당합니다.  
  
 String 및 char 형식은 XML 수준에서 파일의 전체 인코딩과 상호 작용합니다. XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.6](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
### x:Decimal  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.14 및 5.4.8](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
### x:Single  
 ...
 텍스트 구문의 첫 번째 문자가 `e` 또는 `E`인 경우 `x:Single`은 과학적 표기법 형식의 값을 지원할 수 있습니다.  
  
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.8 및 5.4.2](http://go.microsoft.com/fwlink/?LinkId=114525)를 참조하세요.  
...
### x:Double  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.9 및 5.4.3](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
### x:Int16  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.11 및 5.4.5](http://go.microsoft.com/fwlink/?LinkId=114525)를 참조하세요.  
...
### x:Int32  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.12 및 5.4.6](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
### x:Int64  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.13 및 5.4.7](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
### x:TimeSpan  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.16 및 5.4.10](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
### x:Uri  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.15 및 5.4.9](http://go.microsoft.com/fwlink/?LinkId=114525)를 참조하세요.  
  
### x:Byte  
 CLR 백업의 경우 `x:Byte` 기본 형식은 <xref:System.Byte>에 해당합니다.<xref:System.Byte> \/ `x:Byte`는 부호가 없는 것으로 처리됩니다.  
  
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.10 및 5.4.4](http://go.microsoft.com/fwlink/?LinkId=114525)를 참조하세요.  
...
### x:Array  
 ...
 XAML 언어 사양 정의에 대해서는 [\[MS\-XAML\] 섹션 5.2.18](http://go.microsoft.com/fwlink/?LinkId=114525)을 참조하세요.  
...
## WPF 지원  
 ...
 WPF와 함께 XAML 2009 기능을 사용할 수 있는 시나리오는 느슨한 XAML을 작성한 다음 <xref:System.Windows.Markup.XamlReader.Load%2A?displayProperty=fullName>를 사용하여 해당 XAML을 WPF 런타임 및 개체 그래프로 로드하는 경우입니다. WPF <xref:System.Windows.Markup.XamlReader?displayProperty=fullName> 및 해당 <xref:System.Windows.Markup.XamlReader.Load%2A>는 XAML 2009 언어 키워드 및 기능을 유효한 개체 그래프 표현으로 처리할 수 있습니다.
...
> [!NOTE]
>  중괄호를 사용 하지 마십시오 ({}), 특히 여는 중괄호 ({)와 문자열 형식의 요소로 합니다. 이러한 문자는 태그 확장 시퀀스의 시작 및 종료로 예약되어 있습니다.  

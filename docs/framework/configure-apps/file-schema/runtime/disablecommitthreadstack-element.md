---
title: "&lt;disableCommitThreadStack&gt; 요소 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  관리되지 않는 호스트는 [STARTUP\_FLAGS](../../../../../ocs/framework/unmanaged-api/hosting/startup-flags-enumeration.md) 열거형에서 `STARTUP_DISABLE_COMMITTHREADSTACK` 시작 플래그를 사용하면 동일한 결과를 얻을 수 있습니다.  

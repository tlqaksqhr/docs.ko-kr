...
## 시스템 제공 바인딩  
 ...
 시스템 제공 바인딩 목록에 대한 내용은 [시스템 제공 바인딩](../../../../../docs/framework/wcf/system-provided-bindings.md)을 참조하세요.  
...
5.  전송  
 ...
 사용자 지정 바인딩은 `name` 특성으로 식별됩니다.  사용자 지정 바인딩에 대한 자세한 내용은 [사용자 지정 바인딩](../../../../../docs/framework/wcf/extending/custom-bindings.md)을 참조하세요.  

...
|전송|TCP, 명명된 파이프, HTTP, HTTPS, MSMQ 버전, 사용자 지정|예|  
 ...
 사용자 지정 바인딩을 사용하여 시스템 제공 바인딩을 수정하는 방법에 대한 자세한 내용은 [방법: 시스템 제공 바인딩 사용자 지정](../../../../../docs/framework/wcf/extending/how-to-customize-a-system-provided-binding.md)을 참조하세요.  

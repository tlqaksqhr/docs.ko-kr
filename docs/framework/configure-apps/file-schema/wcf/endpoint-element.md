---
title: "&lt;endpoint&gt; 요소 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|listenUriMode|서비스에서 수신하도록 제공된 `ListenUri`를 전송에서 처리하는 방법을 지정합니다.  유효한 값은 다음과 같습니다.<br /><br /> -   명시적 방법<br />-   Unique<br /><br /> 기본값은 Explicit입니다.|  

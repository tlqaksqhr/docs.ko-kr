...
## 설명  
 ...
 바인딩은 바인딩 요소의 스택으로 구성됩니다.  [\<security\>](../../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wsfederationhttpbinding.md)가 기본값인 <xref:System.ServiceModel.WSFederationHttpSecurityMode>로 설정된 경우  
  
 `wsFederationHttpBinding` 에 있는 바인딩 요소의 스택은 `wsHttpBinding`  
  
 에 포함된 스택과 같습니다.  
  
 `wsFederationHttpBinding`은 [\<message\>](../../../../../docs/framework/configure-apps/file-schema/wcf/message-element-of-wsfederationhttpbinding.md)에서 메시지 보안 설정의 세부 내용을 제어합니다.  [\<security\>](../../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wsfederationhttpbinding.md) 요소는 바인딩이 만들어지면 바인딩에서 사용하는 보안을 변경할 수 없을 때에만 get 액세스를 제공합니다.  
 ...
 이 바인딩에 대한 자세한 내용은 [방법: WSFederationHttpBinding 만들기](../../../../../docs/framework/wcf/feature-details/how-to-create-a-wsfederationhttpbinding.md)를 참조하세요.  

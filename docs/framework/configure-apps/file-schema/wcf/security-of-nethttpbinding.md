---
title: "&lt;netHttpBinding&gt;의 &lt;security&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|특성|설명|  
|--------|--------|  
|모드|선택 사항입니다.  사용되는 보안 형식을 지정합니다.  기본값은 `None`입니다.  이 특성은 <xref:System.ServiceModel.NetHttpSecurityMode> 형식입니다.|  
...
|[\<message\>](../../../../../docs/framework/configure-apps/file-schema/wcf/message-of-nethttpbinding.md)|기본 HTTP 서비스에 대한 메시지 보안 설정을 정의합니다.  이 요소는 <xref:System.ServiceModel.NetHttpMessageSecurity>에 해당합니다.|  

---
title: "WCF의 &lt;tracking&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
워크플로 서비스에 대한 추적 설정을 정의하기 위한 구성 섹션을 나타냅니다.  
 ...
 워크플로 추적 및 구성에 대한 자세한 내용은 [워크플로 추적](../../../../../docs/framework/windows-workflow-foundation//workflow-tracking-and-tracing.md) 및 [워크플로 추적 구성](../../../../../docs/framework/windows-workflow-foundation//configuring-tracking-for-a-workflow.md)을 참조하세요.  

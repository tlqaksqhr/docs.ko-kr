---
title: "&lt;allowedAudienceUris&gt;의 &lt;add&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
<xref:System.IdentityModel.Selectors.SamlSecurityTokenAuthenticator> 인스턴스에서 유효한 대상으로 지정할 수 있는 <xref:System.IdentityModel.Tokens.SamlSecurityToken> 보안 토큰의 대상 URI를 추가합니다.  
...
|특성|설명|  
|--------|--------|  
|allowedAudienceUri|<xref:System.IdentityModel.Selectors.SamlSecurityTokenAuthenticator> 인스턴스에서 유효한 대상으로 지정할 수 있는 <xref:System.IdentityModel.Tokens.SamlSecurityToken> 보안 토큰의 대상 URI를 포함하는 문자열입니다.|  
...
|요소|설명|  
|--------|--------|  
|[\<allowedAudienceUris\>](../../../../../docs/framework/configure-apps/file-schema/wcf/allowedaudienceuris.md)|<xref:System.IdentityModel.Selectors.SamlSecurityTokenAuthenticator> 인스턴스에서 유효한 대상으로 지정할 수 있는 <xref:System.IdentityModel.Tokens.SamlSecurityToken> 보안 토큰의 대상 URI 컬렉션을 나타냅니다.|  

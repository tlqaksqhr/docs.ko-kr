---
title: "&lt;netHttpBinding&gt;의 &lt;message&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|요소|설명|  
|--------|--------|  
|\<\<`netHttpBinding`\>의 `security`\> 요소|\<`netHttpBinding`\> 요소의 보안 기능을 정의합니다.|  

...
######## [<add>의<defaultPorts>](add-of-defaultports.md)
...
####### [<connectionPoolSettings>의<namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add>의<namespaceTable>](add-of-namespacetable.md)

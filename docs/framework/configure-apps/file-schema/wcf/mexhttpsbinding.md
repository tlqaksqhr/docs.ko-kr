...
## 설명  
 이 바인딩은 기본적으로 인증서를 사용하여 전송 수준에서 보안을 지원할 수 있는 `WSHttpBinding` 바인딩입니다.  해당 메타데이터 끝점의 구성과 사용에 대한 자세한 내용은 [방법: 사용자 지정 WS\-Metadata Exchange 바인딩 구성](../../../../../docs/framework/wcf/extending/how-to-configure-a-custom-ws-metadata-exchange-binding.md), [방법: MEX가 아닌 바인딩을 통해 메타데이터 검색](../../../../../docs/framework/wcf/extending/how-to-retrieve-metadata-over-a-non-mex-binding.md) 및 예제 [Custom Secure Metadata Endpoint](../../../../../docs/framework/wcf/samples/custom-secure-metadata-endpoint.md)을\(를\) 참조하세요.  

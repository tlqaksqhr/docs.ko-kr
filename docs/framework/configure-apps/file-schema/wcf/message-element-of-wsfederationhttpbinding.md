---
title: "&lt;wsFederationHttpBinding&gt;의 &lt;message&gt; 요소 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# &lt;wsFederationHttpBinding&gt;의 &lt;message&gt; 요소
[\<wsFederationHttpBinding\>](../../../../../docs/framework/configure-apps/file-schema/wcf/wsfederationhttpbinding.md)의 메시지 수준 보안 설정을 정의합니다.  
...
|issuer|보안 토큰을 발급하는 끝점을 지정합니다.  이 요소는 <xref:System.ServiceModel.Configuration.IssuedTokenParametersEndpointAddressElement> 형식입니다.|  
|issuerMetadata|발급자의 끝점 주소를 지정합니다.|  

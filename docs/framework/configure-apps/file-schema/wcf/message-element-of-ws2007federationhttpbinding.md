---
title: "&lt;ws2007FederationHttpBinding&gt;의 &lt;message&gt; 요소 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
[\<ws2007FederationHttpBinding\>](../../../../../docs/framework/configure-apps/file-schema/wcf/ws2007federationhttpbinding.md) 요소의 메시지 수준 보안 설정을 정의합니다.  
...
|[\<issuer\>](../../../../../docs/framework/configure-apps/file-schema/wcf/issuer.md)|보안 토큰을 발급하는 끝점을 지정합니다.  이 요소는 <xref:System.ServiceModel.Configuration.IssuedTokenParametersEndpointAddressElement> 형식입니다.|  
...
|요소|설명|  
|--------|--------|  
|[\<security\>](../../../../../docs/framework/configure-apps/file-schema/wcf/security-element-of-ws2007federationhttpbinding.md)|바인딩에 대한 보안 설정을 정의합니다.|  

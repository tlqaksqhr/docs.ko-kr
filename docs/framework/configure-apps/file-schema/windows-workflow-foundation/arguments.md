...
ms.locfileid: "32757413"
---
# <a name="ltargumentsgt"></a>&lt;인수&gt;
...
|요소|설명|  
|-------------|-----------------|  
|[\<인수 >](../../../../../docs/framework/configure-apps/file-schema/windows-workflow-foundation/argument.md)|활동 상태 쿼리와 연결되는 인수입니다.|  

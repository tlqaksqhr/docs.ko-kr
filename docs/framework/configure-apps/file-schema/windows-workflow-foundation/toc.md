# [Windows Workflow Foundation 구성 스키마](index.md)
## [< system.serviceModel >](system-servicemodel-of-workflow.md)
### [<behaviors>](behaviors-of-workflow.md)
#### [<serviceBehaviors>](servicebehaviors-of-workflow.md)
##### [<behavior>의<serviceBehaviors>](behavior-of-servicebehaviors-of-workflow.md)
...
######## [<states>](states.md)
######### [<state>](state.md)
###### [주석을 사용 하 여 쿼리에서](using-annotation-in-queries.md)
## [추가 관리 되는 참조](additional-managed-reference.md)

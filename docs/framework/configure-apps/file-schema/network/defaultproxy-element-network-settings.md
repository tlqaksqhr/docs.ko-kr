---
title: "&lt;defaultProxy&gt; 요소(네트워크 설정) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 설명  
 ...
 [module](../../../../../docs/framework/configure-apps/file-schema/network/module-element-network-settings.md) 요소가 public이 아닌 형식을 지정하거나, 형식이 <xref:System.Net.IWebProxy> 클래스에서 파생되지 않거나, 이 개체의 기본 생성자에서 예외가 발생하지 않거나, 시스템 지정 기본 프록시를 검색하는 동안 예외가 발생한 경우 예외가 발생합니다.  예외의 <xref:System.Exception.InnerException%2A> 속성에는 오류의 근본 원인에 대한 추가 정보가 있어야 합니다.  
  
## 구성 파일  
 이 요소는 응용 프로그램 구성 파일 또는 컴퓨터 구성 파일\(Machine.config\)에서 사용할 수 있습니다.  
  
## 예제  
 다음 코드 예제에서는 Internet Explorer 프록시의 기본값을 사용하고, 프록시 주소를 지정하고, 로컬 액세스 및 contoso.com에 대한 프록시를 무시합니다.  

---
title: "schemeSettings에 대한 &lt;add&gt; 요소(URI 설정) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# schemeSettings에 대한 &lt;add&gt; 요소(URI 설정)
구성표 이름에 대해 구성표 설정을 추가합니다.  
...
|값|설명|  
|-------|--------|  
|genericUriParserOptions|이 구성표의 파서 옵션입니다.  지원되는 유일한 값은 genericUriParserOptions\= "DontUnescapePathDotsAndSlashes"입니다.|  

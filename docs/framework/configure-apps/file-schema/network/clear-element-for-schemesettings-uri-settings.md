---
title: "schemeSettings에 대한 &lt;clear&gt; 요소(URI 설정) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# schemeSettings에 대한 &lt;clear&gt; 요소(URI 설정)
기존의 모든 구성표 설정을 지웁니다.  
...
## 예제  
 다음 코드 예제에서는 모든 스키마 설정을 지운 다음, http 스키마에서 백분율 기호로 인코딩된 경로 구분 기호를 이스케이프하지 않아도 되도록 지원을 추가하는 <xref:System.Uri> 클래스에서 사용하는 구성을 보여줍니다.  

---
title: "방법: 개체 Serialize | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 방법: 개체 Serialize
개체를 serialize하려면 먼저 serialize될 개체를 만들고 해당 public 속성과 필드를 설정합니다.이렇게 하려면 XML 스트림이 저장될 전송 형식을 스트림 또는 파일 중에서 결정합니다.예를 들어 XML 스트림을 영구적 형태로 저장해야 하는 경우에는 [FileStream](frlrfSystemIOFileStreamClassTopic) 개체를 만듭니다.  
  
> [!NOTE]
>  XML serialization의 예제를 보려면 [XML Serialization 예제](../../../docs/framework/serialization/examples-of-xml-serialization.md)를 참조하십시오.  

---
title: "방법: 인코딩된 SOAP XML Serialization 재정의 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
[코드 예제](#tskhowtooverrideencodedsoapxmlserializationanchor1)  
 ...
 개체의 XML serialization을 SOAP 메시지로 재정의하는 프로세스는 표준 XML serialization을 재정의하는 프로세스와 비슷합니다.표준 XML serialization 재정의에 대한 자세한 내용은 [방법: XML 스트림의 대체 요소 이름 지정](../../../docs/framework/serialization/how-to-specify-an-alternate-element-name-for-an-xml-stream.md)을 참조하십시오.  
  
### 개체의 serialization을 SOAP 메시지로 재정의하려면  
  
1.  [SoapAttributeOverrides](frlrfSystemXmlSerializationSoapAttributeOverridesClassTopic) 클래스의 인스턴스를 만듭니다.  
...
6.  **SoapAttributeOverrides**를 사용하여 **XmlTypeMapping**을 만듭니다.**SoapReflectionImporter.ImportTypeMapping** 메서드를 사용합니다.  
  
7.  **XmlTypeMapping**을 사용하여 **XmlSerializer**를 만듭니다.  

---
title: "보안 투명 코드, 수준 1 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 보안 투명 코드, 수준 1
투명도를 통해 개발자는 부분적으로 신뢰할 수 있는 코드에 기능을 노출하는 더 안전한 .NET Framework 라이브러리를 작성할 수 있습니다. 수준 1 투명도는 .NET Framework 버전 2.0에서 새로 추가되었고 주로 Microsoft 내에서만 사용됩니다.[!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)]부터 [수준 2 투명도](../../../docs/framework/misc/security-transparent-code-level-2.md)를 사용할 수 있습니다. 그러나 이전 보안 규칙과 함께 실행되어야 하는 레거시 코드를 식별할 수 있도록 수준 1 투명도가 유지되었습니다.  
...
-   보안 투명 코드는 <xref:System.Security.Permissions.SecurityAction> 작업을 수행할 수 없습니다.  
  
-   보안 투명 코드로 충족되는 링크 요청은 전체 요청이 됩니다.  
  
-   보안 투명 코드에서 실행되어야 하는 안전하지 않은\(확인할 수 없는\) 코드로 인해 <xref:System.Security.Permissions.SecurityPermissionFlag> 보안 권한에 대한 전체 요청이 발생합니다.  

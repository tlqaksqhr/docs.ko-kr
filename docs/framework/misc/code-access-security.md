---
title: "코드 액세스 보안 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 호출 스택 워크  
 ...
 ![코드 액세스 보안](../../../docs/framework/misc/media/slide-10a.gif "slide\_10a")  
보안 스택 워크  
...
|[부분 신뢰 코드에서 라이브러리 사용](../../../docs/framework/misc/using-libraries-from-partially-trusted-code.md)|비관리 코드에 라이브러리를 사용할 수 있도록 하는 방법 및 비관리 코드에서 라이브러리를 사용하는 방법을 설명합니다.|  
...
|[암호화 서비스](../../../docs/standard/security/cryptographic-services.md)|응용 프로그램에 암호화를 통합하는 방법을 설명합니다.|
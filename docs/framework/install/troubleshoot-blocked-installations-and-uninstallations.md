...
이 표에서 4.5.*x*는 .NET Framework 4.5 및 해당 포인트 릴리스 4.5.1 및 4.5.2를 참조하고, 4.6.*x*는 .NET Framework 4.6 및 해당 포인트 릴리스 4.6.1 및 4.6.2을 참조합니다. 4.7.*x*는 .NET Framework 4.7 및 해당 포인트 릴리스, 4.7.1을 참조합니다.
...
|.NET Framework 4.5*.x*/4.6*.x*/4.7*.x* 재배포 가능 패키지는 이 운영 체제에 적용되지 않습니다. Microsoft 다운로드 센터에서 해당 운영 체제용 .NET Framework 4.5*.x*/4.6*.x*/4.7*.x*를 다운로드하십시오.|지원되지 않는 플랫폼에 [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 또는 4.7.1을 설치하려고 했거나 지원되는 모든 운영 체제에 대한 구성 요소가 포함되지 않은 설치 패키지를 선택했을 수 있습니다. 오프라인 설치 관리자([4.5.1용](http://go.microsoft.com/fwlink/p/?LinkId=309493), [4.5.2용](http://go.microsoft.com/fwlink/p/?LinkId=397706), [4.6용](http://go.microsoft.com/fwlink/p/?LinkId=528233), [4.6.1용](http://go.microsoft.com/fwlink/p/?LinkId=671744), [4.6.2용](http://go.microsoft.com/fwlink/p/?LinkId=780604), [4.7용](http://go.microsoft.com/fwlink/p/?LinkId=825306)) 또는 [4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090)용을 사용하여 설치를 다시 실행합니다. 자세한 내용은 지원되는 운영 체제의 [설치 가이드](../../../docs/framework/install/guide-for-developers.md) 및 [시스템 요구 사항](../../../docs/framework/get-started/system-requirements.md)을 참조하십시오.|  
...
1. 이름 열에서 설치하는 버전에 따라 [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 또는 4.7.1 다운로드 이름을 찾아 이러한 항목을 삭제합니다. 다운로드 이름에 대해서는 [개발자용 .NET Framework 설치](../../../docs/framework/install/guide-for-developers.md) 문서를 참조하세요.

1. 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 또는 4.7.1 버전용 .NET Framework 설치 관리자를 다시 실행합니다.

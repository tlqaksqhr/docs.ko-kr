---
title: "Windows 8, Windows 8.1 또는 Windows 10에서 .NET Framework 1.1 앱 실행 | Microsoft 문서"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="running-net-framework-11-apps-on-windows-8-windows-81-or-windows-10"></a>Windows 8, Windows 8.1 또는 Windows 10에서 .NET Framework 1.1 앱 실행
...
## <a name="installing-the-net-framework-11-from-a-cd-or-download-center"></a>CD 또는 다운로드 센터에서 .NET Framework 1.1 설치  

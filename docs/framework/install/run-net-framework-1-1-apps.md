...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 1.1, Windows 8에서 실행"
  - "Windows 8, .NET Framework 1.1 응용 프로그램 실행"
...
---
# Windows 8, Windows 8.1 또는 Windows 10에서 .NET Framework 1.1 앱 실행
...
## CD 또는 다운로드 센터에서 .NET Framework 1.1 설치  

...
.NET Framework 4.7.2에는 다음이 포함되어 있습니다.
...
.NET Framework 4.7.2는 다음에서 지원되지 않습니다.

* Windows 10 1507
* Windows 10 1511

Windows 10 1507 또는 1511을 사용 중인 경우 .NET Framework 4.7.2를 설치하려면 먼저 이후 Windows 10 버전으로 업그레이드해야 합니다.

---
title: "Windows 8, Windows 8.1 및 Windows 10에 .NET Framework 3.5 설치의 문제 해결"
ms.custom: 
ms.date: 04/20/2017
...
2.  **.NET Framework 3.5(.NET 2.0 및 3.0 포함)** 확인란을 선택하고, 확인을 누르고, 메시지가 표시되면 컴퓨터를 다시 부팅합니다.  
 ...
 ![Windows 8 또는 8.1에 .NET Framework 설치](../../../docs/framework/get-started/media/clr-net35-win8.png "CLR_NET35_Win8")  

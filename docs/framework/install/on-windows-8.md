...
---
# <a name="install-the-net-framework-on-windows-8-and-windows-server-2012"></a>Windows 8 및 Windows Server 2012에서.NET Framework를 설치 합니다.
...
.NET Framework 4.7.1 Windows Server 2012에서 지원 됩니다. Windows 8에서 지원 되지 않습니다.
...
[.NET Framework 4.6](https://www.microsoft.com/en-us/download/details.aspx?id=48130) 최신 지원 되는 버전이.NET Framework Windows 8에서 합니다.

.NET Framework 4.6 4.6를 통해.NET Framework 4.0 용으로 작성 된 앱을 지원 합니다.

## <a name="net-framework-35"></a>.NET Framework 3.5

지침에 따라 설치는 [10 및 Windows 8에서.NET Framework 3.5](dotnet-35-windows-10.md)합니다.

...
-   서버에 있는 사용자별 응용 프로그램 설정을 저장하고 액세스합니다. 웹 설정 서비스(프로필 서비스라고도 함)를 통해 여러 응용 프로그램과 위치에서 설정을 공유할 수 있습니다.  
 ...
 [!INCLUDE[ajax_current_short](../../../includes/ajax-current-short-md.md)] 응용 프로그램 서비스에 대한 자세한 내용은 [ASP.NET 응용 프로그램 서비스 개요](http://msdn.microsoft.com/library/1162e529-0d70-44b2-b3ab-83e60c695013)를 참조하세요.  

...
---
# <a name="full-code-listings"></a>전체 코드 목록
이 항목에는 [조작 및 관성](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md) 프로세서를 사용하는 응용 프로그램에 대한 전체 코드 목록이 들어 있습니다.  
  
## <a name="gamepiece-class"></a>GamePiece 클래스  
 다음 코드에서는 전체 **GamePiece** 클래스를 보여 줍니다.  
...
## <a name="gamepiececollection-class"></a>GamePieceCollection 클래스  
 다음 코드에서는 전체 **GamePieceCollection** 클래스를 보여 줍니다.  
...
## <a name="game1-class"></a>Game1 클래스  
 다음 코드에서는 전체 **Game1** 클래스를 보여 줍니다.  

---
title: "&lt;속성&gt; 요소(.NET 네이티브) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|값|설명|  
|-----------|-----------------|  
|*method_name*|속성 이름입니다. 속성의 형식은 부모에 의해 정의 됩니다 [ <> \> ](../../../docs/framework/net-native/type-element-net-native.md) 또는 [ <> \> ](../../../docs/framework/net-native/typeinstantiation-element-net-native.md) 요소입니다.|  
  
## <a name="all-other-attributes"></a>기타 모든 특성  
  
|값|설명|  
|-----------|-----------------|  
|*policy_setting*|속성에 대해 이 정책 형식에 적용할 설정입니다. 가능한 값은 `Auto`, `Excluded`, `Included` 및 `Required`입니다. 자세한 내용은 참조 [런타임 지시문 정책 설정](../../../docs/framework/net-native/runtime-directive-policy-settings.md)합니다.|  
...
```  
 ...
 다음은 예제의 소스 코드입니다. `outputBlock` 변수 나타냅니다는 [TextBlock](http://msdn.microsoft.com/library/windows.ui.xaml.controls.textblock.aspx) 제어 합니다.  
  
 [!code-csharp[ProjectN_Reflection#6](../../../samples/snippets/csharp/VS_Snippets_CLR/projectn_reflection/cs/property1.cs#6)]  
  
 그러나 컴파일 및 실행 하는이 예제에서는 throw 한 [MissingRuntimeArtifactException](../../../docs/framework/net-native/missingruntimeartifactexception-class-net-native.md) 예외입니다. `Book` 형식에 대해 메타데이터는 제공했지만 속성 getter의 구현은 동적으로 제공하지 못했기 때문입니다. 두 가지 방법 중 하나를 사용하여 이 오류를 해결할 수 있습니다.  
  
-   정의 하 여는 `Dynamic` 에 대 한 정책을 `Book` 입력 해당 [ <> \> ](../../../docs/framework/net-native/type-element-net-native.md) 요소입니다.  
  
-   중첩 된 추가 하 여 [ <> \> ](../../../docs/framework/net-native/property-element-net-native.md) 같이 호출 하려면 다음 default.rd.xml 파일 getter 각 속성에 대 한 요소입니다.  

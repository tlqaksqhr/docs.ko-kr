...
#### <a name="the-effect-of-xmlserializer-datacontractserializer-and-datacontractjsonserialier-policies"></a>XmlSerializer, DataContractSerializer 및 DataContractJsonSerialier 정책의 영향  

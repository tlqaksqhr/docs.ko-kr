...
-   앱 UI 스레드에서 <xref:System.GC.WaitForPendingFinalizers%2A?displayProperty=nameWithType> 메서드를 호출해서는 안 됩니다. 이렇게 호출하는 경우 [!INCLUDE[net_native](../../../includes/net-native-md.md)]에서 교착 상태가 발생할 수 있습니다.  

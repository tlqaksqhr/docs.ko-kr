---
title: "&lt;이벤트&gt; 요소(.NET 네이티브) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|값|설명|  
|-----------|-----------------|  
|*method_name*|이벤트 이름입니다. 이벤트의 형식은 부모에 의해 정의 됩니다 [ <> \> ](../../../docs/framework/net-native/type-element-net-native.md) 또는 [ <> \> ](../../../docs/framework/net-native/typeinstantiation-element-net-native.md) 요소입니다.|  
  
## <a name="all-other-attributes"></a>기타 모든 특성  
  
|값|설명|  
|-----------|-----------------|  
|*policy_setting*|이벤트에 대해 이 정책 형식에 적용할 설정입니다. 가능한 값은 `Auto`, `Excluded`, `Included` 및 `Required`입니다. 자세한 내용은 참조 [런타임 지시문 정책 설정](../../../docs/framework/net-native/runtime-directive-policy-settings.md)합니다.|  

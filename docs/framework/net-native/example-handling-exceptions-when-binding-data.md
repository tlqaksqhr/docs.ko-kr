---
title: "예: 데이터를 바인딩하는 경우 예외 처리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 앱이 수행 중이었던 작업  
 스택 베이스에서 [Windows.UI.Xaml](http://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.aspx) 네임스페이스의 프레임은 XAML 렌더링 엔진이 실행 중이었음을 나타냅니다.  또한 <xref:System.Reflection.PropertyInfo.GetValue%2A?displayProperty=fullName> 메서드가 사용되었으므로 해당 메타데이터가 제거된 형식에 대해 속성 값의 리플렉션 기반 조회를 수행했음을 알 수 있습니다.  

---
title: "&lt;라이브러리&gt; 요소(.NET 네이티브) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|값|설명|  
|-------|--------|  
|*assembly\_name*|파일 확장명이 없는 어셈블리의 단순한 이름입니다.  이 특성은 <xref:System.Reflection.AssemblyName.Name%2A?displayProperty=fullName> 속성에 해당합니다.  예를 들어 Extensions.dll 어셈블리의 이름은 "Extensions"입니다.  어셈블리에서 조건부 메타데이터 포함을 지원하는 특수 *assembly\_name* 형식에 대한 내용은 설명 섹션을 참조하세요.|  

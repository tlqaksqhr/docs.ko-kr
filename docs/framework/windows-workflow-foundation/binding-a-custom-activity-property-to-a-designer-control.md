---
title: "사용자 지정 작업 속성을 디자이너 컨트롤에 바인딩 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  ComboBoxItemConverter라는 새 클래스를 만듭니다.System.Windows.Data에 대한 참조를 추가하고 클래스가 <xref:System.Windows.Data.IValueConverter>에서 파생되도록 합니다.Visual Studio에서 <xref:System.Windows.Data.IValueConverter.Convert%2A> 및 <xref:System.Windows.Data.IValueConverter.ConvertBack%2A>에 대한 스텁을 생성하는 인터페이스를 구현하도록 합니다.  
  
3.  <xref:System.Windows.Data.IValueConverter.Convert%2A> 메서드에 다음 코드를 추가합니다.이 코드는 작업의 <xref:System.String> 형식 <xref:System.Activities.InArgument%601>를 디자이너에 배치할 값으로 변환합니다.  
    ...
    ```  
     ...
     위 코드 조각의 식은 <xref:Microsoft.VisualBasic.Activities.VisualBasicValue%601> 대신 <xref:Microsoft.CSharp.Activities.CSharpValue%601>을 사용하여 만들 수도 있습니다.  
...
4.  <xref:System.Windows.Data.IValueConverter.ConvertBack%2A> 메서드에 다음 코드를 추가합니다.이 코드는 들어오는 콤보 상자 항목을 <xref:System.Activities.InArgument%601>로 다시 변환합니다.  
...
#### 작업의 사용자 지정 디자이너에 ComboBoxItemConverter 추가  

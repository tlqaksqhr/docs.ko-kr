...
1.  열기 [!INCLUDE[vs_current_short](../../../includes/vs-current-short-md.md)] 및는 **파일** 메뉴에서 **새로**, 클릭 하 고 **프로젝트**합니다.  
...
7.  클릭 **확인** 응용 프로그램 프로젝트를 만듭니다. [!INCLUDE[vs_current_short](../../../includes/vs-current-short-md.md)]에서 응용 프로그램에 대한 기본 WPF UI를 만들고 해당 XAML 및 코드 숨김 파일을 포함합니다.  

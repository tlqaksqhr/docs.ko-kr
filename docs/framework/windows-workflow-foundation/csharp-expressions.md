...
###  <a name="WFDesigner"></a><span data-ttu-id="a2117-115">워크플로 디자이너에서 C# 식 사용</span><span class="sxs-lookup"><span data-stu-id="a2117-115">Using C# expressions in the Workflow Designer</span></span>  
...
####  <a name="BackwardCompat"></a><span data-ttu-id="a2117-124">이전 버전과 호환성</span><span class="sxs-lookup"><span data-stu-id="a2117-124">Backwards compatibility</span></span>  
...
###  <a name="CodeWorkflows"></a><span data-ttu-id="a2117-130">코드 워크플로에서 C# 식 사용</span><span class="sxs-lookup"><span data-stu-id="a2117-130">Using C# expressions in code workflows</span></span>  
...
###  <a name="XamlWorkflows"></a><span data-ttu-id="a2117-147">XAML 워크플로에서 C# 식 사용</span><span class="sxs-lookup"><span data-stu-id="a2117-147">Using C# expressions in XAML workflows</span></span>  
...
####  <a name="CompiledXaml"></a><span data-ttu-id="a2117-152">컴파일된 Xaml</span><span class="sxs-lookup"><span data-stu-id="a2117-152">Compiled Xaml</span></span>  
...
####  <a name="LooseXaml"></a><span data-ttu-id="a2117-155">느슨한 Xaml</span><span class="sxs-lookup"><span data-stu-id="a2117-155">Loose Xaml</span></span>  
...
###  <a name="WFServices"></a><span data-ttu-id="a2117-162">XAMLX 워크플로 서비스에서 C# 식 사용</span><span class="sxs-lookup"><span data-stu-id="a2117-162">Using C# expressions in XAMLX workflow services</span></span>  

---
title: "사용자 지정 활동 디자인 및 구현 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!IMPORTANT]
>  기본적으로 사용자 지정 활동은 Workflow Designer에 활동 이름과 함께 간단한 사각형으로 표시됩니다.  Workflow Designer에서 활동이 표시되는 모양을 사용자 지정하려면 사용자 지정 디자이너도 만들어야 합니다.  [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [사용자 지정 활동 디자이너 및 템플릿 사용](../../../docs/framework/windows-workflow-foundation//using-custom-activity-designers-and-templates.md).  
...
## 단원 내용  
 ...
 [활동 확장 사용](../../../docs/framework/windows-workflow-foundation//using-activity-extensions.md)  

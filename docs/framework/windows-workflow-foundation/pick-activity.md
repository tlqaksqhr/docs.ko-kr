...
## <a name="using-the-pick-activity-in-code"></a>코드에서 Pick 활동 사용  
 <xref:System.Activities.Statements.Pick.Branches%2A> 컬렉션에 <xref:System.Activities.Statements.PickBranch> 활동을 채워서 <xref:System.Activities.Statements.Pick> 활동을 사용합니다. <xref:System.Activities.Statements.PickBranch> 활동에는 각각 <xref:System.Activities.Activity> 형식의 <xref:System.Activities.Statements.PickBranch.Trigger%2A> 속성이 있습니다. 지정된 활동의 실행이 완료되면 <xref:System.Activities.Statements.PickBranch.Action%2A>이 실행됩니다.  

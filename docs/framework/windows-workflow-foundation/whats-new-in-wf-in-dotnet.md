---
title: "기능 &#39;.NET 4.5에서에서 Windows Workflow Foundation의 새로운 s"
ms.custom: 
ms.date: 03/30/2017
...
###  <a name="BKMK_DesignerSearch"></a>디자이너 검색  
 이제 대규모 워크플로를 보다 효율적으로 관리하기 위해 워크플로를 키워드로 검색할 수 있습니다. 이 기능은 [!INCLUDE[vs_current_short](../../../includes/vs-current-short-md.md)]에서만 사용할 수 있으며, 재호스트된 디자이너에서는 이 기능을 사용할 수 없습니다. 사용 가능한 검색 종류는 다음 두 가지입니다.  

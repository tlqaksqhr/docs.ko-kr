...
## <a name="in-this-section"></a>섹션 내용  
 ...
 Windows WF (Workflow Foundation) 사용 하 여 사용할 수 있는 시스템 제공 활동에 설명 하는 항목을 선택 합니다.  
 ...
 이전 버전의 Windows WF (Workflow Foundation)에서 워크플로 마이그레이션하는 방법을 설명 하는 항목입니다.  
 ...
 SQL 및 Windows Communication Foundation (WCF)를 사용 하는 경우 보안 워크플로 유지 하는 방법을 설명 합니다.  
  
 [Windows Workflow Foundation 4 성능](../../../docs/framework/windows-workflow-foundation/performance.md)  
 Windows Workflow Foundation 4 성능에 설명 하 고 이전 버전의 WF와 비교 합니다.

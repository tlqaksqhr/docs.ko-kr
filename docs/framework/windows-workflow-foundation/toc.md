...
## [Windows Workflow Foundation에서 사용되지 않는 형식](deprecated-types.md)
...
### [방법: 여러 버전의 워크플로 Side-by-Side 호스트](how-to-host-multiple-versions-of-a-workflow-side-by-side.md)
...
###### [명령형 코드 기반 유효성 검사](imperative-code-based-validation.md)
...
#### [워크플로 및 활동과 XAML 간 직렬화](serializing-workflows-and-activities-to-and-from-xaml.md)
...
### [마이그레이션 지침](wf-migration-guidance.md)
...
##### [방법: 다시 호스트된 디자이너에서 유효성 검사 오류 표시](how-to-display-validation-errors-in-a-rehosted-designer.md)

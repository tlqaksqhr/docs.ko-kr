...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [보정](../../../docs/framework/windows-workflow-foundation/compensation.md)  
 ...
 [취소](../../../docs/framework/windows-workflow-foundation/modeling-cancellation-behavior-in-workflows.md)  
 기본 제공 활동과 사용자 지정 활동을 사용하여 워크플로에서 취소를 처리하는 방법에 대해 설명합니다.  
  
 [워크플로 디버깅](../../../docs/framework/windows-workflow-foundation/debugging-workflows.md)  

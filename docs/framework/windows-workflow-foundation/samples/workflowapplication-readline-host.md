---
title: "WorkflowApplication ReadLine 호스트 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# WorkflowApplication ReadLine 호스트
...
7.  **실행** 단추 옆의 줄임표 단추를 눌러 XAML 파일에 정의된 워크플로를 찾습니다.  
  
     SampleWorkflows 폴더에 두 개의 샘플이 있습니다.parallel1.xaml 예제는 유휴 상태가 됩니다.  
  
8.  예제가 선택된 상태에서 **실행** 단추를 누릅니다.  
  
9. 워크플로가 유휴 상태가 되면 **책갈피** 콤보 상자는 사용 가능한 책갈피로 채워집니다.  
  
10. 이때 책갈피를 다시 시작하거나 워크플로를 취소, 중단 또는 종료할 수 있습니다.호스트를 종료한 후 다시 시작할 수도 있습니다.지속성이 설정되어 있으면 종료할 때 인스턴스가 언로드되고 시작할 때 다시 로드됩니다.  
  
     책갈피를 다시 시작하려면 원하는 책갈피를 선택하고 콤보 상자 옆의 텍스트 상자에 값을 입력한 다음 **책갈피 다시 시작**을 누릅니다.  

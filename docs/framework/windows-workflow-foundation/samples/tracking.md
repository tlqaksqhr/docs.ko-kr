...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [추적을 사용하여 WF 데이터 추출](../../../../docs/framework/windows-workflow-foundation/samples/extract-wf-data-using-tracking.md)  
 워크플로 추적을 사용하여 활동에서 워크플로 변수와 인수를 추출하는 방법을 보여 줍니다.  
  
 [텍스트 파일 사용 추적](../../../../docs/framework/windows-workflow-foundation/samples/tracking-using-a-text-file.md)  

---
title: "WorkflowHostingEndpoint 다시 시작 책갈피 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# WorkflowHostingEndpoint 다시 시작 책갈피
...
2.  응용 프로그램을 실행합니다.워크플로 인스턴스를 만들 때 인스턴스 ID를 포함하는 메시지가 `CreationEndpoint` 콘솔에 표시됩니다.책갈피를 다시 시작하는 데 성공하면 워크플로 인스턴스를 통해 "Hello World\!"라는 메시지가 인쇄됩니다.  

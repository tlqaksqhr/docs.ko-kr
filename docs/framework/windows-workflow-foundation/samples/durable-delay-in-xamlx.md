---
title: "XAMLX의 지속적 지연 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
6.  **솔루션 탐색기**에서 솔루션을 마우스 오른쪽 단추로 클릭하고 **속성**을 선택합니다.  
  
7.  **여러 개의 시작 프로젝트**를 선택하고 두 프로젝트를 **시작**으로 설정합니다.  

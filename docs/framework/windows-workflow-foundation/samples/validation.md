...
ms.locfileid: "33515745"
---
# <a name="validation"></a>유효성 검사
이 단원에는 활동 유효성 검사를 보여 주는 샘플이 포함되어 있습니다.  
  
## <a name="in-this-section"></a>섹션 내용  
 [외부 작업 유효성 검사](../../../../docs/framework/windows-workflow-foundation/samples/external-activity-validation.md)  
 ...
 `CreateProduct` 인수가 `Cost` 인수보다 작거나 같은지 확인하는 `Price` 활동을 보여 줍니다.  
 ...
 [작업 관계 유효성 검사](../../../../docs/framework/windows-workflow-foundation/samples/activity-relationships-validation.md)  

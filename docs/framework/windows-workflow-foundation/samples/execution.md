...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [WorkflowInvoker 클래스 사용](../../../../docs/framework/windows-workflow-foundation/samples/using-the-workflowinvoker-class.md)  
 ...
 [워크플로 인스턴스 만들기 및 실행](../../../../docs/framework/windows-workflow-foundation/samples/creating-and-running-a-workflow-instance.md)  
 ...
 [WorkflowHostingEndpoint에 대한 책갈피 확인자](../../../../docs/framework/windows-workflow-foundation/samples/bookmark-resolver-for-workflowhostingendpoint.md)  

...
> [!NOTE]
>  이 항목에서는 워크플로의 보정에 대해 설명합니다. [!INCLUDE[crabout](../../../includes/crabout-md.md)]워크플로에서 트랜잭션은 확인 [트랜잭션을](../../../docs/framework/windows-workflow-foundation/workflow-transactions.md) 및 <xref:System.Activities.Statements.TransactionScope>합니다. 트랜잭션에 대한 [!INCLUDE[crabout](../../../includes/crabout-md.md)]는 <xref:System.Transactions?displayProperty=nameWithType> 및 <xref:System.Transactions.Transaction?displayProperty=nameWithType>을 참조하세요.  
...
**워크플로가 상태와 함께 성공적으로 완료: 취소 합니다.**  [!INCLUDE[crabout](../../../includes/crabout-md.md)]취소를, 참조 [취소](../../../docs/framework/windows-workflow-foundation/modeling-cancellation-behavior-in-workflows.md)합니다.  

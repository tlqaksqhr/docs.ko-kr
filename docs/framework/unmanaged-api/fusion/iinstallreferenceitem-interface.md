...
|메서드|설명|  
|------------|-----------------|  
|[GetReference 메서드](../../../../docs/framework/unmanaged-api/fusion/iinstallreferenceitem-getreference-method.md)|에 대 한 포인터를 가져옵니다는 `FUSION_INSTALL_REFERENCE` 이 표시 되는 구조 `IInstallReferenceItem`합니다.|  

...
| [CreateClassEnumWmi function](createclassenumwmi.md) | 지정 된 선택 조건과 일치 하는 모든 클래스에 대 한 열거자를 반환 합니다. |
| [CreateInstanceEnumWmi function](createinstanceenumwmi.md) | 인스턴스로만 구성 되어 지정된 된 클래스의 지정 된 선택 기준에 맞는 반환 하는 열거자를 반환 합니다. |
...
| [GetCurrentApartmentType function](getcurrentapartmenttype.md) | 아파트 호출자에 게 실행 되는 형식을 검색 합니다. |
...
| [QualifierSet_EndEnumeration function](qualifierset-endenumeration.md) | 열거형에 대 한 호출을 시작한 종료는 `QualifierSet_BeginEnumeration` 함수입니다. |

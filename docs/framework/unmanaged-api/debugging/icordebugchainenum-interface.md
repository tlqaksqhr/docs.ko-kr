...
|메서드|설명|  
|------------|-----------------|  
|[Next 메서드](../../../../docs/framework/unmanaged-api/debugging/icordebugchainenum-next-method.md)|지정된 된 수의 가져옵니다 `ICorDebugChain` 인스턴스 현재 위치부터 시작 하는 열거형입니다.|  

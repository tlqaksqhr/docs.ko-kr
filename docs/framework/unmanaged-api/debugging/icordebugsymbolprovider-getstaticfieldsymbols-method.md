...
#### <a name="parameters"></a>매개 변수  
 ...
 `pSymbols`  
 [out] 에 대 한 포인터는 [ICorDebugStaticFieldSymbol](../../../../docs/framework/unmanaged-api/debugging/icordebugstaticfieldsymbol-interface.md) 요청 된 정적 필드 기호를 포함 된 배열입니다.  
...
## <a name="see-also"></a>참고 항목  
 [GetInstanceFieldSymbols 메서드](../../../../docs/framework/unmanaged-api/debugging/icordebugsymbolprovider-getinstancefieldsymbols-method.md)  

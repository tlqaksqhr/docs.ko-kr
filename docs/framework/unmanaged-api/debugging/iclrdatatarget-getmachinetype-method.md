...
대상 프로세스를 사용 하는 명령 집합의 종류에 대 한 식별자를 가져옵니다.  
...
#### <a name="parameters"></a>매개 변수  
 `machineType`  
 [out] 대상 프로세스는 명령 집합을 표시 하는 값에 대 한 포인터 사용 중입니다. 반환 된 `machineType` WinNT.h 헤더 파일에 정의 된 IMAGE_FILE_MACHINE 상수 중 하나입니다.  

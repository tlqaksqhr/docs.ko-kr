...
|메서드|설명|  
|------------|-----------------|  
|[EnumMemoryRegions 메서드](../../../../docs/framework/unmanaged-api/debugging/iclrdataenummemoryregions-enummemoryregions-method.md)|메모리의 지정 된 영역을 열거합니다.|  

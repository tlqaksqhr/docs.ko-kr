...
현재 [IHostSemaphore](../../../../docs/framework/unmanaged-api/hosting/ihostsemaphore-interface.md) 소유 될 때까지 대기 하는 인스턴스 또는 지정된 된 양의 시간 간격이 경과 합니다.  
...
#### <a name="parameters"></a>매개 변수  
 `dwMilliseconds`  
 [in] 경우, 반환 하기 전에 대기할 밀리초 수 현재 `IHostSemaphore` 인스턴스를 소유 하지 않습니다.  
...
|HOST_E_DEADLOCK|호스트 대기 간격 중 교착 상태를 감지 하 여 현재 `IHostSemaphore` 인스턴스 교착 상태가 발생 합니다.|  

...
현재 표시 되는 임계 영역 입력 [IHostCrst](../../../../docs/framework/unmanaged-api/hosting/ihostcrst-interface.md) 인스턴스.  
...
## <a name="remarks"></a>설명  
 `Enter` Win32 미러링 `EnterCriticalSection` 함수입니다.  
  
> [!NOTE]
>  이 메서드는 임계 영역 입력 될 때까지 반환 하지 않습니다.  

...
현재 작업의 스레드 우선 순위 수준을 가져옵니다 [IHostTask](../../../../docs/framework/unmanaged-api/hosting/ihosttask-interface.md) 인스턴스.  
...
#### <a name="parameters"></a>매개 변수  
 `pPriority`  
 [out] 현재 작업의 스레드 우선 순위 수준을 나타내는 정수에 대 한 포인터 `IHostTask` 인스턴스.  

...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [COR_PRF_CODE_INFO 구조체](../../../../docs/framework/unmanaged-api/profiling/cor-prf-code-info-structure.md)  
 메모리 내에 저장된 연속하는 네이티브 코드 블록 하나를 나타냅니다.  
  
 [COR_PRF_EX_CLAUSE_INFO 구조체](../../../../docs/framework/unmanaged-api/profiling/cor-prf-ex-clause-info-structure.md)  
 특정 예외 절 인스턴스 및 관련 프레임에 대한 정보를 저장합니다.  
  
 [COR_PRF_FUNCTION 구조체](../../../../docs/framework/unmanaged-api/profiling/cor-prf-function-structure.md)  
 함수의 ID와 다시 컴파일된 함수 버전의 ID를 결합하여 함수의 고유한 표현을 제공합니다.  
  
 [COR_PRF_FUNCTION_ARGUMENT_INFO 구조체](../../../../docs/framework/unmanaged-api/profiling/cor-prf-function-argument-info-structure.md)  
 왼쪽에서 오른쪽 순서의 함수 인수를 나타냅니다.  
  
 [COR_PRF_FUNCTION_ARGUMENT_RANGE 구조체](../../../../docs/framework/unmanaged-api/profiling/cor-prf-function-argument-range-structure.md)  

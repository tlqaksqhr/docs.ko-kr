...
## <a name="in-this-section"></a>단원 내용  
 ...
 [프로 파일링 환경 설정](../../../../docs/framework/unmanaged-api/profiling/setting-up-a-profiling-environment.md)  
 .NET Framework 응용 프로그램을 프로 파일링 하는 위해 수행 해야 하는 단계를 설명 합니다.  
  
 [CLR 프로파일러 및 Windows 스토어 앱](../../../../docs/framework/unmanaged-api/profiling/clr-profilers-and-windows-store-apps.md)  

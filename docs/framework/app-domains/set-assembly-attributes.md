---
title: "어셈블리 특성 설정 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|<xref:System.Reflection.AssemblyInformationalVersionAttribute>|전체 제품 버전 번호와 같이 공용 언어 런타임에서 사용되지 않는 버전 정보를 지정하는 문자열 값입니다. **Note:**  이 특성이 어셈블리에 적용된 경우 <xref:System.Windows.Forms.Application.ProductVersion%2A?displayProperty=fullName> 속성을 사용하여 런타임에 지정하는 문자열을 가져올 수 있습니다. 문자열은 <xref:System.Windows.Forms.Application.UserAppDataPath%2A?displayProperty=fullName> 및 <xref:System.Windows.Forms.Application.UserAppDataRegistry%2A?displayProperty=fullName> 속성이 제공하는 경로 및 레지스트리 키에서도 사용됩니다.|  

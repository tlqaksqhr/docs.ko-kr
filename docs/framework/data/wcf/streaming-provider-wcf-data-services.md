...
> [!NOTE]
>  사용 해야 합니다는 <xref:System.ServiceModel.TransferMode.Streamed?displayProperty=nameWithType> 전송 모드는 요청 및 응답 메시지의 이진 데이터 스트리밍 및 WCF에 의해 버퍼링 되지 않습니다.  

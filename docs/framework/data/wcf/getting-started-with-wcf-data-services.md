...
## <a name="in-this-section"></a>섹션 내용  
 ...
 만들고 있는 간단한 액세스 하는 방법을 보여 줍니다 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]-Northwind 샘플 데이터베이스에 따라 피드를 노출 하는 서비스를 기반으로 합니다.  
 ...
 링크를 제공 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] 및 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 리소스입니다.  

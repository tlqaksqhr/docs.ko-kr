...
-   [!INCLUDE[msCoName](../../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)]의 인스턴스입니다. 여기에는 [!INCLUDE[vs_current_short](../../../../includes/vs-current-short-md.md)]의 기본 설치에 들어 있는 SQL Server Express가 포함됩니다.  
...
## <a name="wcf-data-services-quickstart-tasks"></a>WCF Data Services 퀵 스타트 작업  
 ...
 [!INCLUDE[vs_current_short](../../../../includes/vs-current-short-md.md)] 에서 서비스를 시작하고 웹 브라우저를 통해 HTTP GET 요청을 노출된 피드로 전송하여 서비스에 액세스합니다.  

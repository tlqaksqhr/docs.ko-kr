...
|`DEGREES(` `radians` `)`|해당 각도를 도 단위로 반환합니다.<br /><br /> **인수**<br /><br /> `expression`: `Int32`, `Int64`, `Double` 또는 `Decimal`입니다.<br /><br /> **반환 값**<br /><br /> `Int32`, `Int64`, `Double`, 또는 `Decimal`합니다.<br /><br /> **예제**<br /><br /> `SqlServer.DEGREES(3.1)`|  

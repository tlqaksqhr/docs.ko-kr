---
title: "집계 함수(Entity Framework용 SqlClient) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|---------------------|---------------------|---------------------|  
|[집계 함수\(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115906)\(영문\)|[집계 함수\(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkID=115903)\(영문\)|[집계 함수\(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115907)\(영문\)|  

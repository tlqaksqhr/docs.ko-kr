...
## <a name="the-role-of-the-sql-generation-module"></a>SQL 생성 모듈의 역할  
 ...
 <!--zz<xref:System.Data.Common.DBProviderServices> --> `System.Data.Common.DBProviderServices` 클래스는로 명령 트리를 변환 하기 위해 SQL 생성 계층에 액세스 하기 위한 시작 지점 <!--zz<xref:System.Data.Common.DbCommands>--> `System.Data.Common.DbCommands`합니다.  

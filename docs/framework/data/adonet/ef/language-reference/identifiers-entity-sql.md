---
title: "식별자(Entity SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 식별자(Entity SQL)
식별자는 [!INCLUDE[esql](../../../../../../includes/esql-md.md)]에서 쿼리 식 별칭, 변수 참조, 개체 속성, 함수 등을 나타내는 데 사용됩니다.  [!INCLUDE[esql](../../../../../../includes/esql-md.md)]에서는 단순 식별자와 따옴표 붙은 식별자라는 두 가지 종류의 식별자를 제공합니다.  
...
-   추가 대괄호\(대괄호 내부에서 식별자를 나타내는 대괄호\)  
 ...
 따옴표 붙은 식별자의 비교 의미 체계는 [입력 문자 집합](../../../../../../docs/framework/data/adonet/ef/language-reference/input-character-set-entity-sql.md)을 참조하세요.  
...
### 집계 처리  
 [!INCLUDE[esql](../../../../../../includes/esql-md.md)]에서는 컬렉션 기반 집계와 그룹 기반 집계라는 두 가지 형태의 집계가 지원됩니다.  컬렉션 기반 집계는 [!INCLUDE[esql](../../../../../../includes/esql-md.md)]에서 선호하는 구문이며, 그룹 기반 집계는 SQL 호환성을 위해 지원됩니다.  

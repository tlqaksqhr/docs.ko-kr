---
title: "쿼리 식 구문 예제: 필터링 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 쿼리 식 구문 예제: 필터링
이 항목의 예제에서는 쿼리 식 구문을 사용하여 [AdventureWorks Sales 모델](http://msdn.microsoft.com/ko-kr/f16cd988-673f-4376-b034-129ca93c7832)을 쿼리하기 위해 `Where` 및 `Where…Contains` 메서드를 사용하는 방법을 보여 줍니다.  Where…`Contains`는 [컴파일된 쿼리](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md)의 일부로 사용할 수 없습니다.  

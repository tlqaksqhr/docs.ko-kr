...
|`ISNUMERIC(` `expression` `)`|식이 유효한 숫자 형식인지 확인합니다.<br /><br /> **인수**<br /><br /> `expression`: `Boolean`, `Byte`, `Int16`, `Int32`, `Int64`, `Single`, `Decimal`, `Double`, `DateTime`, `Time`, `DateTimeOffset`, `String`, `Binary` 또는 `Guid`입니다.<br /><br /> **반환 값**<br /><br /> `Int32`입니다.  입력 식이 유효한 날짜이면 1입니다.  그렇지 않으면 0입니다.<br /><br /> **예제**<br /><br /> `SqlServer.ISNUMERIC('21')`|  
...
|---------------------|---------------------|---------------------|  
|[시스템 함수\(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115918)\(영문\)|[시스템 함수\(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115917)\(영문\)|[시스템 함수\(Transact\-SQL\)](http://go.microsoft.com/fwlink/?LinkId=115919)\(영문\)|  

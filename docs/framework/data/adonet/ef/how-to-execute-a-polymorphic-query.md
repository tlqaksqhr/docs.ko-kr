...
1.  추가 [School 모델](http://msdn.microsoft.com/en-us/859a9587-81ea-4a45-9bc0-f8d330e1adac) 프로젝트에 Entity Framework를 사용 하 여 프로젝트를 구성 하 고 있습니다. 자세한 내용은 참조 [하는 방법: 엔터티 데이터 모델 마법사를 사용 하 여](http://msdn.microsoft.com/en-us/dadb058a-c5d9-4c5c-8b01-28044112231d)합니다.  
...
3.  개념적 모델의 단계를 수행 하 여 hierrachy 당 테이블 상속을 포함을 수정 [연습: 매핑 상속-계층-테이블](http://msdn.microsoft.com/en-us/49b685cf-9db8-4d6d-b885-8837ed238f55)합니다.  

---
title: "트랜잭션 및 동시성 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 단원 내용  
 ...
 분산 트랜잭션 작업을 위한 [!INCLUDE[ssNoVersion](../../../../includes/ssnoversion-md.md)]과 <xref:System.Transactions>의 통합에 대해 설명합니다.  
  
 [낙관적 동시성](../../../../docs/framework/data/adonet/optimistic-concurrency.md)  
 낙관적 및 비관적 동시성에 대해 설명하고 동시성 위반을 테스트하는 방법에 대해 살펴봅니다.  
  
## 참고 항목  
 [Transaction Fundamentals](http://msdn.microsoft.com/ko-kr/2a476b63-b94f-443f-992d-53943fdf4e5d)   

---
title: "DataSet에서 XML 사용 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 단원 내용  
 ...
 [DataSet 스키마 정보를 XSD로 작성](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/writing-dataset-schema-information-as-xsd.md)  
 ...
 <xref:System.Data.DataSet>의 내용을 XML 데이터로 표현할 경우 중첩된 <xref:System.Data.DataRelation> 개체의 중요성과 이러한 개체를 만드는 방법에 대해 설명합니다.  

...
## <a name="in-this-section"></a>섹션 내용  
 ...
 만들기에 대 한 정보를 제공는 <xref:System.Data.DataTable> 에서 [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)] 사용 하 여 쿼리는 <xref:System.Data.DataTableExtensions.CopyToDataTable%2A> 메서드.  
  
 [방법: CopyToDataTable 구현\<T > 제네릭 형식 T가 DataRow 아닙니다](../../../../docs/framework/data/adonet/implement-copytodatatable-where-type-not-a-datarow.md)  
 ...
 디버깅 및 문제 해결에 대 한 정보를 제공 [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)] 쿼리 합니다.  

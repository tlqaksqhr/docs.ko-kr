...
### 위협 모델링  
 노출되어 있는 모든 잠재적인 공격을 이해하지 못하면 시스템을 공격으로부터 보호할 수 없습니다.  ADO.NET 응용 프로그램의 보안 위험 가능성 및 그 결과를 확인하려면 *위협 모델링*이라는 보안 위협 평가 프로세스가 필요합니다.  
...
|리소스|설명|  
|---------|--------|  
|MSDN 보안 개발자 센터의 [위협 모델링](http://go.microsoft.com/fwlink/?LinkId=98353)\(영문\) 사이트|이 페이지의 리소스는 위협 모델링 프로세스를 이해하고 응용 프로그램을 안전하게 보호하는 데 사용할 수 있는 위협 모델을 만드는 데 유용한 정보를 제공합니다.|  
...
|리소스|설명|  
|---------|--------|  
|[응용 프로그램 보안](../Topic/Securing%20Applications.md)|일반 보안 항목에 대한 링크를 제공합니다.  분산 응용 프로그램, 웹 응용 프로그램, 모바일 응용 프로그램 및 데스크톱 응용 프로그램을 보호하는 방법에 대해 설명하는 항목에 대한 링크도 제공합니다.|  
...
|[Code Access Security](http://msdn.microsoft.com/ko-kr/23a20143-241d-4fe5-9d9f-3933fd594c03)|.NET Framework의 CAS에 대해 설명하는 추가 항목 링크를 제공합니다.|  
...
|리소스|설명|  
|---------|--------|  
|[NIB: Security Policy Management](http://msdn.microsoft.com/ko-kr/d754e05d-29dc-4d3a-a2c2-95eaaf1b82b9)|보안 정책을 만들고 관리하는 작업에 대한 정보를 제공합니다.|  
|[NIB: Security Policy Best Practices](http://msdn.microsoft.com/ko-kr/d49bc4d5-efb7-4caa-a2fe-e4d3cec63c05)|보안 정책을 관리하는 방법에 대해 설명하는 링크를 제공합니다.|  

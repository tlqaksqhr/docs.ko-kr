---
title: "SQL Server의 쿼리 알림 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
3.  또한 ASP.NET 2.0 이상을 사용하여 작성된 웹 응용 프로그램에서는 `SqlCacheDependency` 도우미 클래스를 사용할 수 있습니다.  
 ...
 데이터가 변경될 때 신뢰할 수 있는 하위 보조 알림이 필요한 응용 프로그램을 개발하려는 경우 SQL Server 온라인 설명서의 [알림 계획](http://go.microsoft.com/fwlink/?LinkId=211984) 항목에 있는 **효율적인 쿼리 알림 방법 계획** 및 **쿼리 알림 대체 방법** 섹션을 참조하세요.  쿼리 알림 및 SQL Server Service Broker에 대한 자세한 내용은 다음 SQL Server 온라인 설명서의 항목을 참조하세요.  
...
## 단원 내용  
 [쿼리 알림 활성화](../../../../../docs/framework/data/adonet/sql/enabling-query-notifications.md)  
 쿼리 알림 활성화 및 사용에 필요한 요구 사항 등 쿼리 알림 사용 방법을 설명합니다.  
  
 [ASP.NET 응용 프로그램에서의 SqlDependency](../../../../../docs/framework/data/adonet/sql/sqldependency-in-an-aspnet-app.md)  
 ASP.NET 응용 프로그램에서 쿼리 알림을 사용하는 방법에 대해 설명합니다.  
  
 [SqlDependency로 변경 내용 검색](../../../../../docs/framework/data/adonet/sql/detecting-changes-with-sqldependency.md)  
 쿼리 결과가 원래 수신된 결과와 다를 때 감지하는 방법에 대해 설명합니다.  
  
 [SqlNotificationRequest로 SqlCommand 실행](../../../../../docs/framework/data/adonet/sql/sqlcommand-execution-with-a-sqlnotificationrequest.md)  

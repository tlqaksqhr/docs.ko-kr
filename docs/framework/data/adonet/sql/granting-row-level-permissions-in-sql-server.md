---
title: "SQL Server에서 행 수준의 권한 부여 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   행 수준 필터링을 사용하도록 설정합니다.  
    ...
    -   SQL Server 2016 이상이나 [Azure SQL 데이터베이스](https://azure.microsoft.com/documentation/services/sql-database/)를 사용하고 있으면 반환되는 행을 현재 데이터베이스 사용자\(CURRENT\_USER\(\) 기본 제공 함수 사용\) 또는 현재 로그인 이름\(SUSER\_SNAME\(\) 기본 제공 함수 사용\)과 일치하는 행으로 제한하는 조건자를 테이블에 추가하는 보안 정책을 만듭니다.  

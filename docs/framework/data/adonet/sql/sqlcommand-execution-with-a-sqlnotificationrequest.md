---
title: "SqlNotificationRequest로 SqlCommand 실행 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# SqlNotificationRequest로 SqlCommand 실행
...
### 예제  
 다음 코드 조각에서는 <xref:System.Data.Sql.SqlNotificationRequest>를 만들어 <xref:System.Data.Sql.SqlCommand>에 연결하는 방법을 보여 줍니다.  

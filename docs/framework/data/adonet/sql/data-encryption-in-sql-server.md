---
title: "SQL Server에서의 데이터 암호화 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 키 및 알고리즘  
 ...
 데이터베이스의 암호화된 데이터 사용 방법을 보여 주는 예에 대해서는 SQL Server 온라인 설명서의 [방법: 데이터 열 암호화](http://go.microsoft.com/fwlink/?LinkID=128559)를 참조하세요.  
...
|||  
|-|-|  
|SQL Server 온라인 설명서의 [SQL Server 암호화](http://msdn.microsoft.com/library/bb510663.aspx)|SQL Server의 암호화에 대해 간략하게 설명합니다.  이 항목에는 추가 항목과 방법에 대한 링크도 포함되어 있습니다.|  
|SQL Server 온라인 설명서의 [암호화 계층](http://msdn.microsoft.com/library/ms189586.aspx) 및 [암호화 방법 항목](http://msdn.microsoft.com/library/aa337557.aspx)|SQL Server의 암호화에 대해 간략하게 설명합니다.  이 항목에는 추가 항목과 방법에 대한 링크도 포함되어 있습니다.|  

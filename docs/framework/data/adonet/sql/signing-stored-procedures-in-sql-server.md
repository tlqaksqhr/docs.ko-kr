---
title: "SQL Server에서 저장 프로시저 서명 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|리소스|설명|  
|---------|--------|  
|SQL Server 온라인 설명서의 [모듈 서명](http://go.microsoft.com/fwlink/?LinkId=98590)|모듈 서명을 설명하고 샘플 시나리오 및 관련 Transact\-SQL 항목 링크를 제공합니다.|  
|SQL Server 온라인 설명서의 [인증서로 저장 프로시저 서명](http://msdn.microsoft.com/library/bb283630.aspx)|인증서로 저장 프로시저에 서명하는 방법에 대한 자습서를 제공합니다.|  

---
title: "SQL Server에서의 소유권 및 사용자 스키마 분리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# SQL Server에서의 소유권 및 사용자 스키마 분리
...
## 사용자 스키마 분리  
 사용자 스키마 분리를 통해 데이터베이스 개체 권한을 더욱 유연하게 관리할 수 있습니다.  *스키마*는 개체를 별도 네임스페이스로 그룹화할 수 있는 데이터베이스 개체의 명명된 컨테이너입니다.  예를 들어, AdventureWorks 샘플 데이터베이스에는 Production, Sales 및 HumanResources에 대한 스키마가 들어 있습니다.  
...
|리소스|설명|  
|---------|--------|  
|SQL Server 온라인 설명서의 [사용자와 스키마 분리](http://msdn.microsoft.com/library/ms190387.aspx)|사용자 스키마 분리에서 도입된 변경 내용을 설명합니다.  새 동작, 소유권에 대한 영향, 카탈로그 뷰 및 권한이 포함되어 있습니다.|  

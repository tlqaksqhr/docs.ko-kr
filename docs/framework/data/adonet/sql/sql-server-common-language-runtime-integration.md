---
title: "SQL Server 공용 언어 런타임 통합 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
1.  [CLR\(공용 언어 런타임\) 통합 프로그래밍 개념](http://go.microsoft.com/fwlink/?LinkId=115240)  
...
## 단원 내용  
 ...
 [ADO.NET의 SQL Server In\-Process 고유 동작](../../../../../docs/framework/data/adonet/sql/sql-server-in-process-specific-behavior-of-adonet.md)  
 ADO.NET에 대한 SQL Server in\-process 고유의 확장 및 컨텍스트 연결에 대해 설명합니다.  또한 추가 항목에 대한 링크도 제공합니다.  

---
title: "LINQ to SQL을- 사용하여 할 수 있는 작업 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 선택  
 원하는 프로그래밍 언어로 [!INCLUDE[vbteclinq](../../../../../../includes/vbteclinq-md.md)] 쿼리를 작성한 다음 해당 쿼리를 실행하여 결과를 검색하는 간단한 방법으로 선택\(*프로젝션*\) 작업을 수행할 수 있습니다. 필요한 모든 작업은 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]를 통해 사용자에게 익숙한 필수 SQL 작업으로 변환됩니다. 자세한 내용은 [LINQ to SQL](../../../../../../docs/framework/data/adonet/sql/linq/index.md)을 참조하십시오.  
...
> [!NOTE]
>  [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]에서는 하위 삭제 작업을 인식하지 못합니다. 제약 조건이 있는 테이블의 행을 삭제하려면 [방법: 데이터베이스에서 행 삭제](../../../../../../docs/framework/data/adonet/sql/linq/how-to-delete-rows-from-the-database.md)를 참조하세요.  

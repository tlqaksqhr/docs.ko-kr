---
title: "부분 메서드를 사용하여 비즈니스 논리 추가 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 부분 메서드를 사용하여 비즈니스 논리 추가
[!INCLUDE[vbprvb](../../../../../../includes/vbprvb-md.md)]부분 메서드\(Partial Method\)를 사용하여 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 프로젝트에  *및 C\#에서 생성된 코드를 사용자 지정할 수 있습니다.* [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]에서 생성한 코드에는 부분 메서드의 일부로 시그니처를 정의합니다.  메서드를 구현하려면 사용자 고유의 부분 메서드를 추가합니다.  사용자 고유의 구현을 추가하지 않으면 컴파일러에서는 부분 메서드 시그니처를 취소하고 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]의 기본 메서드를 호출합니다.  
...
>  [!INCLUDE[vs_current_short](../../../../../../includes/vs-current-short-md.md)]를 사용하면 [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)]를 사용하여 엔터티 클래스에 유효성 검사와 기타 사용자 지정을 추가할 수 있습니다.  
 ...
 자세한 내용은 [Partial Methods](../Topic/Partial%20Methods%20\(Visual%20Basic\).md)\([!INCLUDE[vbprvb](../../../../../../includes/vbprvb-md.md)]\) 또는 [부분\(메서드\)\(C\# 참조\)](../Topic/partial%20\(Method\)%20\(C%23%20Reference\).md)\(C\#\)을 참조하세요.  

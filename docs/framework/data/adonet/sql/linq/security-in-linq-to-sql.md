---
title: "LINQ to SQL의 보안 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 연결 문자열  
 ...
 이러한 위험을 최소화하려면 통합 보안을 사용하여 [!INCLUDE[ssNoVersion](../../../../../../includes/ssnoversion-md.md)]에 신뢰할 수 있는 연결을 설정합니다.  이러한 접근 방식을 사용하면 연결 문자열에서 암호를 저장하지 않아도 됩니다.  자세한 내용은 [SQL Server 보안](../../../../../../docs/framework/data/adonet/sql/sql-server-security.md)을 참조하세요.  
...
-   연결 문자열 대신 노출 기간이 제한되는 <xref:System.Data.SqlClient.SqlConnection?displayProperty=fullName> 클래스를 사용합니다.  <xref:System.Data.SqlClient.SqlConnection>을 사용하여 LINQ to SQL <xref:System.Data.Linq.DataContext?displayProperty=fullName> 클래스를 인스턴스화할 수 있습니다.  

---
title: "방법: 데이터베이스 값을 덮어써서 충돌 해결 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 방법: 데이터베이스 값을 덮어써서 충돌 해결
변경 내용을 전송하기 전에 예상 데이터베이스 값과 실제 데이터베이스 값의 차이점을 조정하려면 <xref:System.Data.Linq.RefreshMode>를 사용하여 데이터베이스 값을 덮어씁니다.  자세한 내용은 [낙관적 동시성: 개요](../../../../../../docs/framework/data/adonet/sql/linq/optimistic-concurrency-overview.md)을 참조하세요.  
...
|User2가 이미 변경 내용 전송||Mary|서비스|  
 ...
 User1이 <xref:System.Data.Linq.RefreshMode>를 사용하여 문제를 해결하는 경우 데이터베이스의 결과는 다음 테이블과 같습니다.  

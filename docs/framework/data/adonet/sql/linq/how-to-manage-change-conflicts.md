...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [방법: 동시성 예외가 Throw되는 시기 지정](../../../../../../docs/framework/data/adonet/sql/linq/how-to-specify-when-concurrency-exceptions-are-thrown.md)  
 ...
 [방법: 데이터베이스 값을 병합하여 충돌 해결](../../../../../../docs/framework/data/adonet/sql/linq/how-to-resolve-conflicts-by-merging-with-database-values.md)  

...
2.  **솔루션 탐색기**를 마우스 오른쪽 단추로 클릭 **참조**, 클릭 하 고 **참조 추가**합니다.  
  
3.  에 **참조 추가** 대화 상자를 클릭 **.NET**System.Data.Linq 어셈블리를 클릭 한 다음 클릭, **확인**합니다.  
...
1.  **솔루션 탐색기**를 마우스 오른쪽 단추로 클릭 **Form1.vb**, 클릭 하 고 **코드 보기**합니다.  
...
1.  반환이는 windows Forms 디자이너 (**Form1.vb[Design]**).  
...
3.  이제 두 번 클릭 **Button2** 만들려는 Form1에는 `Button2` 이벤트 처리기 및 코드 편집기를 엽니다.  

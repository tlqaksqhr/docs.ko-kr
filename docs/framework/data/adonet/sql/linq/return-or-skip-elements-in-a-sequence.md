---
title: "시퀀스의 요소 반환 또는 건너뛰기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  <xref:System.Linq.Enumerable.Take%2A> 및 <xref:System.Linq.Enumerable.Skip%2A>에는 SQL Server 2000에 대한 쿼리에서 사용할 경우 몇 가지 제한이 따릅니다.  자세한 내용은 [문제 해결](../../../../../../docs/framework/data/adonet/sql/linq/troubleshooting.md)의 "SQL Server 2000의 Skip 및 Take 예외" 항목을 참조하세요.  
 ...
 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]에서는 하위 쿼리와 함께 SQL `NOT EXISTS` 절을 사용하여 <xref:System.Linq.Queryable.Skip%2A>을 변환합니다.  이 변환에는 다음과 같은 제한 사항이 있습니다.  
...
>  [!INCLUDE[ss2k](../../../../../../includes/ss2k-md.md)]과 [!INCLUDE[sqprsqlong](../../../../../../includes/sqprsqlong-md.md)]의 변환은 서로 다릅니다.  복잡한 쿼리와 함께 <xref:System.Linq.Queryable.Skip%2A>을 사용하려면 [!INCLUDE[sqprsqlong](../../../../../../includes/sqprsqlong-md.md)]를 사용하세요.  
 ...
 [!INCLUDE[ss2k](../../../../../../includes/ss2k-md.md)]에 대해 다음 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 쿼리를 살펴보세요.  

---
title: "ID 캐시에서 개체 검색 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  미리 컴파일된 쿼리는 ID 캐시에서 개체를 반환하지 않습니다.  미리 컴파일된 쿼리에 대한 자세한 내용은 <xref:System.Data.Linq.CompiledQuery> 및 [방법: 쿼리 저장 및 다시 사용](../../../../../../docs/framework/data/adonet/sql/linq/how-to-store-and-reuse-queries.md)을 참조하세요.  

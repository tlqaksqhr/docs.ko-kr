---
title: "방법: 데이터베이스 값을 유지하여 충돌 해결 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 방법: 데이터베이스 값을 유지하여 충돌 해결
변경 내용을 다시 전송하기 전에 예상 데이터베이스 값과 실제 데이터베이스 값의 차이를 조정하려면 <xref:System.Data.Linq.RefreshMode>를 사용하여 데이터베이스에서 찾은 값을 유지합니다.  그런 다음 개체 모델의 현재 값을 덮어씁니다.  자세한 내용은 [낙관적 동시성: 개요](../../../../../../docs/framework/data/adonet/sql/linq/optimistic-concurrency-overview.md)을 참조하세요.  
...
|User2가 이미 변경 내용 전송||Mary|서비스|  
 ...
 User1이 <xref:System.Data.Linq.RefreshMode>를 사용하여 충돌을 해결하는 경우 데이터베이스의 결과는 다음 표와 같습니다.  

---
title: "SQL Server의 서버 및 데이터베이스 역할 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|리소스|설명|  
|---------|--------|  
|[!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)] 온라인 설명서의 [서버 수준 역할](http://msdn.microsoft.com/library/ms188659.aspx) 및 [고정 서버 역할의 권한](http://msdn.microsoft.com/library/ms175892.aspx)|[!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)]의 고정 서버 역할 및 역할에 연결된 권한에 대해 설명합니다.|  
|[!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)] 온라인 설명서의 [데이터베이스 수준 역할](http://msdn.microsoft.com/library/ms189121.aspx) 및 [고정 서버 역할의 권한](http://msdn.microsoft.com/library/ms189612.aspx)|고정 데이터베이스 역할 및 역할에 연결된 권한에 대해 설명합니다.|  
...
> [!NOTE]
>  [SQL Server에서의 소유권 및 사용자 스키마 분리](../../../../../docs/framework/data/adonet/sql/ownership-and-user-schema-separation-in-sql-server.md)에서 설명하는 것과 같이 `dbo`가 스키마 이름도 됩니다.  
...
|리소스|설명|  
|---------|--------|  
|SQL Server 온라인 설명서의 [ID 및 액세스 제어](http://msdn.microsoft.com/library/bb510418.aspx)|보안 주체, 역할, 자격 증명, 보안 개체 및 권한에 대해 설명하는 항목의 링크를 제공합니다.|  
|[!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)] 온라인 설명서의 [원리](http://msdn.microsoft.com/library/ms181127.aspx)|보안 주체에 대해 설명하며 서버 및 데이터베이스 역할에 대해 설명하는 항목의 링크를 제공합니다.|  
...
## 참고 항목  
 ...
 [SQL Server에서의 권한 부여 및 사용 권한](../../../../../docs/framework/data/adonet/sql/authorization-and-permissions-in-sql-server.md)   

---
title: "SQL Server Express 보안 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|SQL Server 온라인 설명서의 [SQL Server Express에 연결](http://msdn.microsoft.com/library/ms165679.aspx)|네트워크에서 SQL Server Express Edition을 사용하는 방법을 설명합니다.|  
...
|SQL Server 온라인 설명서의 [비관리자용 사용자 인스턴스](http://msdn.microsoft.com/library/ms143684.aspx)|사용자 인스턴스를 만들고 배포하는 방법을 설명합니다.|  

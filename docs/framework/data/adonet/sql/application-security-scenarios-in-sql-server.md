---
title: "SQL Server의 응용 프로그램 보안 시나리오 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 단원 내용  
 ...
 [SQL Server에서 행 수준의 권한 부여](../../../../../docs/framework/data/adonet/sql/granting-row-level-permissions-in-sql-server.md)  

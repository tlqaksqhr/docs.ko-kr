...
## <a name="in-this-section"></a>단원 내용  
 [콜백을 사용 하는 Windows 응용 프로그램](../../../../../docs/framework/data/adonet/sql/windows-applications-using-callbacks.md)  
 비동기 명령을 안전하게 실행하여 별도의 스레드에서 폼 및 해당 내용과의 상호 작용을 올바르게 처리하는 방법을 보여 주는 예제를 제공합니다.  
  
 [대기 핸들을 사용 하 여 ASP.NET 응용 프로그램](../../../../../docs/framework/data/adonet/sql/aspnet-apps-using-wait-handles.md)  

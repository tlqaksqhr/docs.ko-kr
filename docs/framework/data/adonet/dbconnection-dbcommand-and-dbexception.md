---
title: "DbConnection, DbCommand 및 DbException | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 데이터 검색 예제  
 다음 예제에서는 `DbConnection` 개체를 인수로 사용합니다.  <xref:System.Data.Common.DbCommand.CommandText%2A>를 SQL SELECT 문으로 설정하여 Categories 테이블에서 데이터를 선택하기 위해 <xref:System.Data.Common.DbCommand>를 만듭니다.  이 코드에서는 Categories 테이블이 데이터 소스에 있다고 가정합니다.  연결이 열리고 <xref:System.Data.Common.DbDataReader>를 통해 데이터가 검색됩니다.  

...
|컨트롤 뷰|콘텐츠 뷰|  
|-----------|-----------|  
|SplitButton<br /><br /> <ul><li>Image\(0 또는 1개\)</li><li>Text\(0 또는 1개\)</li><li>Button\(1 또는 2개\)<br /><br /> <ul><li>Menu\(0 또는 1개, ExpandCollapse 패턴을 지원하는 단추의 자식으로 표시됨\)</li><li>MenuItem\(1개 또는 다수\)</li></ul></li></ul>|SplitButton<br /><br /> -   MenuItem\(1개 또는 다수\)|  
...
## SplitButton 컨트롤 예제  
 ...
 ![분할 단추](../../../docs/framework/ui-automation/media/uiauto-splitbutton-detailed.png "uiauto\_splitbutton\_detailed")  

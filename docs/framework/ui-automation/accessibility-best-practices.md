...
### 프로그래밍 방식 이벤트가 모든 UI 작업에서 트리거되는지 확인  
...
### 모든 시스템 수준 설정 유지 및 액세스 가능성 기능 방해 안 함  
...
### DPI 설정으로 모든 UI가 올바르게 크기 조정되는지 확인  
...
### 텍스트가 아닌 요소에 대한 사용자가 선택할 수 있는 요소 제공  
...
### 장치 독립적 호출을 통해 표준 입력 API 사용  
 장치 독립적 호출을 사용하면 키보드 기능과 마우스 기능이 동일해지고 [!INCLUDE[TLA2#tla_ui](../../../includes/tla2sharptla-ui-md.md)]에 대한 필요한 정보와 함께 [!INCLUDE[TLA2#tla_at](../../../includes/tla2sharptla-at-md.md)]을\(를\) 제공합니다.  
  
## 참고 항목  
 <xref:System.Windows.Automation.Peers>   
 [NumericUpDown Custom Control with Theme and UI Automation Support Sample](http://msdn.microsoft.com/ko-kr/9aed3c10-68eb-419e-a57f-1d2af15a8253)   
 [키보드 사용자 인터페이스 디자인에 대한 지침](http://msdn2.microsoft.com/library/ms971323.aspx)
...
## 예제  
 다음 코드 예제는 <xref:System.Windows.Automation.Text.TextPatternRange.GetAttributeValue%2A>가 <xref:System.Windows.Automation.TextPattern.MixedAttributeValue> 개체를 반환하는 텍스트 범위에서 <xref:System.Windows.Automation.TextPattern.FontNameAttribute>를 가져오는 방법을 보여 줍니다.  

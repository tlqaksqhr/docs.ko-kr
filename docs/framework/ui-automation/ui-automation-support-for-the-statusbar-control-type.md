...
|컨트롤 뷰|콘텐츠 뷰|  
|-----------|-----------|  
|StatusBar<br /><br /> -   Edit\(0개 이상\)<br />-   Progress Bar\(0개 이상\)<br />-   Image\(0개 이상\)<br />-   Button\(0개 이상\)|StatusBar<br /><br /> -   Edit\(0개 이상\)<br />-   ProgressBar\(0개 이상\)<br />-   Image\(0개 이상\)<br />-   Button\(0개 이상\)|  

...
|컨트롤 뷰|콘텐츠 뷰|  
|------------------|------------------|  
|ListItem<br /><br /> -이미지 (0 개 이상)<br />텍스트 (0 개 이상)<br />-Edit (0 개 이상)|ListItem|  
  
 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 트리의 콘텐츠 보기 내에서 목록 항목 컨트롤의 자식은 항상 "0" 이어야 합니다. 컨트롤의 구조에 대 한 요구 사항을 따라야 합니다 목록 항목 아래에 다른 항목이 포함 되는 경우는 [TreeItem 컨트롤 형식에 대 한 UI 자동화 지원](../../../docs/framework/ui-automation/ui-automation-support-for-the-treeitem-control-type.md) 유형을 제어 합니다.  

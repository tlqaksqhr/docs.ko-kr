...
## <a name="embedded-objects-and-the-ui-automation-tree"></a>포함된 개체 및 UI 자동화 트리  
 ...
 ![원하는 텍스트 컨테이너의 이미지를 사용 하 여 테이블을 포함](../../../docs/framework/ui-automation/media/uia-textpattern-embedded-objects-overview-example1.png "UIA_TextPattern_Embedded_Objects_Overview_Example1")  
...
## <a name="expose-embedded-objects-using-textpattern-and-textpatternrange"></a>TextPattern 및 TextPatternRange를 사용하여 포함된 개체 노출  
 ...
 ![포함 된 개체에 의해 확장 되는 텍스트 범위입니다. ](../../../docs/framework/ui-automation/media/uia-textpattern-embeddedobjecttextranges.png "UIA_TextPattern_EmbeddedObjectTextRanges")  
...
|<xref:System.Windows.Automation.Text.TextPatternRange.GetEnclosingElement%2A>|텍스트 범위를 포함하는 가장 안쪽의 <xref:System.Windows.Automation.AutomationElement> 를 반환합니다. 이 예제에서는 텍스트 공급자 자체를 나타내는 <xref:System.Windows.Automation.AutomationElement> 입니다.|  
|<xref:System.Windows.Automation.Text.TextPatternRange.Move%2A> 매개 변수는 (TextUnit.Word, 1)|하이퍼링크의 텍스트가 개별 단어로 이루어져 있으므로 텍스트 범위를 "http"로 이동합니다. 이 경우 하이퍼링크는 단일 개체로 처리되지 않습니다.<br /><br /> {0} [http]} URL 텍스트에 포함 됩니다.|  
  
<a name="Image"></a>   
### <a name="image"></a>이미지  
 **예제 1 - 포함된 이미지가 들어 있는 텍스트 범위**  
  
 {0} 이미지 ![포함 된 이미지 예제](../../../docs/framework/ui-automation/media/uia-textpattern-embedded-objects-overview-imageexample.PNG "UIA_TextPattern_Embedded_Objects_Overview_ImageExample") 텍스트에 포함 된}.  
 ...
 **예 2-텍스트 컨테이너의 콘텐츠를 부분적으로 걸쳐 있는 텍스트 범위입니다. 텍스트 컨테이너에는 포함된 이미지가 텍스트 범위에 속하지 않습니다.**  
  
 {0} 이미지} ![포함 된 이미지 예제](../../../docs/framework/ui-automation/media/uia-textpattern-embedded-objects-overview-imageexample.PNG "UIA_TextPattern_Embedded_Objects_Overview_ImageExample") 텍스트에 포함 됩니다.  

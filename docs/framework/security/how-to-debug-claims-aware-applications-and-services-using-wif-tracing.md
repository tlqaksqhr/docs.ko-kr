---
title: "방법: WIF 추적을 사용하여 클레임 인식 응용 프로그램 및 서비스 디버깅 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.reviewer: ""
ms.suite: ""
...
---
# 방법: WIF 추적을 사용하여 클레임 인식 응용 프로그램 및 서비스 디버깅
## 적용 대상  
...
#### Web.config 구성 파일을 사용하여 WIF 추적을 구성하려면  
...
2.  구성 파일의 끝에 있는 **\<구성\>** 노드 내에 다음과 비슷한 구성 항목을 추가합니다.  
...
#### 추적 뷰어 도구\(SvcTraceViewer.exe\)를 사용하여 WIF 추적 로그를 분석하려면  
  
1.  추적 뷰어 도구\(SvcTraceViewer.exe\)는 Windows SDK의 일부로 제공됩니다.  Windows SDK를 아직 설치하지 않은 경우 여기\([Windows SDK](http://www.microsoft.com/download/en/details.aspx?id=8279)\)서 다운로드할 수 있습니다.  
...
#### WIF 관련 문제를 해결할 수 있는 솔루션을 식별하려면  

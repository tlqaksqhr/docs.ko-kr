...
4.  Tlbimp.exe로 가져온 형식처럼 일부 형식에는 코드에 직접 추가할 수 있는 추가적인 정보가 필요합니다. 자세한 내용은 [방법: interop 어셈블리 편집](http://msdn.microsoft.com/library/16aacb20-2269-42bf-a812-b6a7df17e277)을 참조하세요.  

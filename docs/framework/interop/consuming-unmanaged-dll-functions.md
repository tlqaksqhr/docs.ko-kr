---
title: "관리되지 않는 DLL 함수 사용 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 관리되지 않는 DLL 함수 사용
플랫폼 호출은 Win32 API의 함수와 같이 DLL\(동적 연결 라이브러리\)에서 구현된 관리되지 않는 함수를 관리 코드가 호출할 수 있도록 하는 서비스입니다.  이 서비스는 내보낸 함수를 찾아서 호출하고 필요에 따라 상호 운용 경계를 가로질러 인수\(정수, 문자열, 배열, 구조체 등\)를 마샬링합니다.  이 서비스에 대한 자세한 내용은 [플랫폼 호출 자세히 보기](http://msdn.microsoft.com/ko-kr/ba9dd55b-2eaa-45cd-8afd-75cb8d64d243)를 참조하세요.  

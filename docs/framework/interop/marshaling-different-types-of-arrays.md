---
title: "여러 형식의 배열 마샬링 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   PinvokeLib.dll에서 내보낸 **TestArrayOfStructs2**  
 ...
 [PinvokeLib.dll](http://msdn.microsoft.com/ko-kr/5d1438d7-9946-489d-8ede-6c694a08f614)은 앞에 나열된 함수 및 2개의 구조체 변수 **MYPOINT** 및 **MYPERSON**에 대한 구현을 포함하는 관리되지 않는 사용자 지정 라이브러리입니다. 구조체에는 다음과 같은 요소가 포함됩니다.  
...
## 참고 항목  
 [형식 배열 마샬링](http://msdn.microsoft.com/ko-kr/049b1c1b-228f-4445-88ec-91bc7fd4b1e8)   
 [플랫폼 호출 데이터 형식](http://msdn.microsoft.com/ko-kr/16014d9f-d6bd-481e-83f0-df11377c550f)   

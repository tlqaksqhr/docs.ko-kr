---
title: "관리 코드에서 프로토타입 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  문자열을 할당하는 Win32 API 함수를 통해 `LocalFree`와 같은 메서드를 사용하여 문자열을 해제할 수 있습니다.  플랫폼 호출은 매개 변수를 다르게 처리합니다.  플랫폼 호출의 경우 매개 변수를 `String` 형식 대신 `IntPtr` 형식으로 설정합니다.  <xref:System.Runtime.InteropServices.Marshal?displayProperty=fullName> 클래스에서 제공된 메서드를 사용하여 형식을 문자열로 수동으로 변환하고 해제합니다.  
...
|<xref:System.Runtime.InteropServices.DllImportAttribute.ThrowOnUnmappableChar>|ANSI "?" 문자로 변환되는 매핑할 수 없는 유니코드 문자에 대한 예외 throw를 제어합니다.|  
 ...
 자세한 내용은 [DllImportAttribute Class](frlrfSystemRuntimeInteropServicesDllImportAttributeClassTopic)를 참조하세요.  
...
## 참고 항목  
 ...
 [Platform Invoke Security Considerations](http://msdn.microsoft.com/ko-kr/bbcc67f7-50b5-4917-88ed-cb15470409fb)   

---
title: ".NET Framework 4.5.2의 대상 다시 지정 변경 내용 | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
<a name="EF"></a>   
## <a name="entity-framework-retargeting-changes"></a>Entity Framework 대상 다시 지정 변경 내용  
...
<a name="WinForms"></a>   
## <a name="windows-forms-retargeting-changes"></a>Windows Forms 대상 다시 지정 변경 내용  

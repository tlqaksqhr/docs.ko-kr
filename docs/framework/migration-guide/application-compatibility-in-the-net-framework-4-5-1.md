---
title: ".NET Framework 4.5.1의 응용 프로그램 호환성 | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="application-compatibility-in-the-net-framework-451"></a>.NET Framework 4.5.1의 응용 프로그램 호환성
이 항목에서는 .NET Framework 4.5와 4.5.1 사이의 응용 프로그램 호환성 문제 관련 정보를 참조할 수 있는 링크를 제공합니다. 이 문제는 다음과 같은 두 가지 범주로 나뉩니다.  
  
 [런타임 변경 내용](../../../docs/framework/migration-guide/runtime-changes-in-the-net-framework-4-5-1.md)  
 런타임 변경 내용은 [!INCLUDE[net_v451](../../../includes/net-v451-md.md)]에서 실행되며 특정 기능을 사용하는 모든 앱에 영향을 줍니다.  
  
 [대상 다시 지정 변경 내용](../../../docs/framework/migration-guide/retargeting-changes-in-the-net-framework-4-5-1.md)  
 대상 다시 지정 변경 내용은 [!INCLUDE[net_v451](../../../includes/net-v451-md.md)]을 대상으로 다시 컴파일되는 앱에 영향을 미칩니다. 다음과 같은 변경 내용이 해당됩니다.  
  
-   디자인 타임 환경의 변경 내용. 예를 들어 빌드 도구가 이전 경우와 달리 경고를 내보낼 수 있습니다.  
  
-   런타임 환경의 변경 내용. 이 변경 내용은 구체적으로 [!INCLUDE[net_v451](../../../includes/net-v451-md.md)]을 대상으로 하는 앱에만 영향을 줍니다. 이전 버전의 .NET Framework를 대상으로 하는 앱은 예전 그대로 동작합니다.  
  
 런타임 변경 내용 및 대상 다시 지정 변경 내용에 대해 설명된 항목에서는 각 변경 내용이 다음과 같은 영향력별로 분류되어 있습니다.  

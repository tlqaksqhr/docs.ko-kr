---
title: ".NET Framework 4.6.1의 응용 프로그램 호환성 | Microsoft 문서"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="application-compatibility-in-the-net-framework-461"></a>.NET Framework 4.6.1의 응용 프로그램 호환성
이 항목에서는 .NET Framework 4.6과 [!INCLUDE[net_v461](../../../includes/net-v461-md.md)] 사이의 응용 프로그램 호환성 문제 관련 정보를 참조할 수 있는 링크를 제공합니다. 이 문제는 다음과 같은 두 가지 범주로 나뉩니다.  
  
 [런타임 변경 내용](../../../docs/framework/migration-guide/runtime-changes-in-the-net-framework-4-6-1.md)  
 ...
 대상 다시 지정 변경 내용은 특히 [!INCLUDE[net_v461](../../../includes/net-v461-md.md)]을 대상으로 다시 컴파일되는 앱에만 영향을 줍니다. 이전 버전의 .NET Framework를 대상으로 하는 앱은 예전 그대로 동작합니다.  

...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-471"></a>.NET Framework 4.0을 4.7.1에서에서의 마이그레이션에 대 한 변경 내용 대상 변경

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

4.7.1를.NET Framework 4.0에서 마이그레이션하는, 응용 프로그램에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.

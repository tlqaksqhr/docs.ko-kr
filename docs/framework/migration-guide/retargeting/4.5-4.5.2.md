...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-452"></a>.NET Framework 4.5.2를 4.5에서에서 마이그레이션에 대 한 변경 내용 대상 변경

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

4.5.2를.NET Framework 4.5에서 마이그레이션하는, 응용 프로그램에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.

---
title: ".NET Framework 4.5.2를 4.5에서에서 마이그레이션에 대 한 런타임 변경 내용"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="41df8-102">.NET Framework 4.5.2를 4.5에서에서 마이그레이션에 대 한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="41df8-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="41df8-103">4.5.2를.NET Framework 4.5에서 마이그레이션하는, 응용 프로그램에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.</span><span class="sxs-lookup"><span data-stu-id="41df8-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="41df8-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="41df8-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="41df8-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="41df8-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="41df8-106">핵심</span><span class="sxs-lookup"><span data-stu-id="41df8-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="41df8-107">데이터</span><span class="sxs-lookup"><span data-stu-id="41df8-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="41df8-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="41df8-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="41df8-109">Serialization</span><span class="sxs-lookup"><span data-stu-id="41df8-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="41df8-110">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="41df8-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="41df8-111">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="41df8-111">Windows Presentation Foundation (WPF)</span></span>

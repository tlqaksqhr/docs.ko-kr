...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a>.NET Framework 4.5.2를 4.7.1에서에서의 마이그레이션에 대 한 런타임 변경 내용

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

.NET Framework 4.5.2를 4.7.1에서에서 마이그레이션하려는 경우 앱에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.

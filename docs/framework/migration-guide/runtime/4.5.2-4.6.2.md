---
title: ".NET Framework 4.5.2를 4.6.2에서에서의 마이그레이션에 대 한 런타임 변경 내용"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="1c9b4-102">.NET Framework 4.5.2를 4.6.2에서에서의 마이그레이션에 대 한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="1c9b4-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1c9b4-103">.NET Framework 4.5.2를 4.6.2에서에서 마이그레이션하려는 경우 앱에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.</span><span class="sxs-lookup"><span data-stu-id="1c9b4-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>
...
## <a name="core"></a><span data-ttu-id="1c9b4-105">핵심</span><span class="sxs-lookup"><span data-stu-id="1c9b4-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="1c9b4-106">데이터</span><span class="sxs-lookup"><span data-stu-id="1c9b4-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="1c9b4-107">디버거</span><span class="sxs-lookup"><span data-stu-id="1c9b4-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="1c9b4-108">전역화</span><span class="sxs-lookup"><span data-stu-id="1c9b4-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="1c9b4-109">네트워킹</span><span class="sxs-lookup"><span data-stu-id="1c9b4-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="1c9b4-110">보안</span><span class="sxs-lookup"><span data-stu-id="1c9b4-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="1c9b4-111">Serialization</span><span class="sxs-lookup"><span data-stu-id="1c9b4-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="1c9b4-112">설치 및 배포</span><span class="sxs-lookup"><span data-stu-id="1c9b4-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="1c9b4-113">도구</span><span class="sxs-lookup"><span data-stu-id="1c9b4-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1c9b4-114">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="1c9b4-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1c9b4-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="1c9b4-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1c9b4-116">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="1c9b4-116">Windows Presentation Foundation (WPF)</span></span>

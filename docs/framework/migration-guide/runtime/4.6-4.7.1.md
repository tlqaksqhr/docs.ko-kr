---
title: ".NET Framework 4.6을 4.7.1에서에서의 마이그레이션에 대 한 런타임 변경 내용 | Microsoft Docs"
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-471"></a><span data-ttu-id="0a808-102">.NET Framework 4.6에 4.7.1에서에서의 마이그레이션에 대 한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="0a808-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0a808-103">4.7.1를.NET Framework 4.6에서 마이그레이션하는, 응용 프로그램에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.</span><span class="sxs-lookup"><span data-stu-id="0a808-103">If you are migrating from the .NET Framework 4.6 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="0a808-104">핵심</span><span class="sxs-lookup"><span data-stu-id="0a808-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0a808-105">데이터</span><span class="sxs-lookup"><span data-stu-id="0a808-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0a808-106">전역화</span><span class="sxs-lookup"><span data-stu-id="0a808-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="0a808-107">보안</span><span class="sxs-lookup"><span data-stu-id="0a808-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="0a808-108">도구</span><span class="sxs-lookup"><span data-stu-id="0a808-108">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0a808-109">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="0a808-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0a808-110">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="0a808-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0a808-111">Windows WF(Workflow Foundation)</span><span class="sxs-lookup"><span data-stu-id="0a808-111">Windows Workflow Foundation (WF)</span></span>

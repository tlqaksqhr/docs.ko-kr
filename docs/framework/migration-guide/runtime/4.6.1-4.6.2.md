---
title: ".NET Framework 4.6.1을 4.6.2에서에서의 마이그레이션에 대 한 런타임 변경 내용"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="7719f-102">.NET Framework 4.6.1을 4.6.2에서에서의 마이그레이션에 대 한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="7719f-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="7719f-103">.NET Framework 4.6.1을 4.6.2에서에서 마이그레이션하려는 경우 앱에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.</span><span class="sxs-lookup"><span data-stu-id="7719f-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="7719f-104">핵심</span><span class="sxs-lookup"><span data-stu-id="7719f-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7719f-105">데이터</span><span class="sxs-lookup"><span data-stu-id="7719f-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7719f-106">전역화</span><span class="sxs-lookup"><span data-stu-id="7719f-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="7719f-107">보안</span><span class="sxs-lookup"><span data-stu-id="7719f-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7719f-108">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="7719f-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7719f-109">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="7719f-109">Windows Presentation Foundation (WPF)</span></span>

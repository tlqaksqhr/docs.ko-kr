...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="fca09-102">.NET Framework 4.5.1을 4.5에서에서 마이그레이션에 대 한 런타임 변경 내용</span><span class="sxs-lookup"><span data-stu-id="fca09-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="fca09-103">4.5.1에.NET Framework 4.5에서 마이그레이션하는, 응용 프로그램에 영향을 줄 수 있는 응용 프로그램 호환성 문제에 대 한 다음 항목을 검토 합니다.</span><span class="sxs-lookup"><span data-stu-id="fca09-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="fca09-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="fca09-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="fca09-105">핵심</span><span class="sxs-lookup"><span data-stu-id="fca09-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="fca09-106">Serialization</span><span class="sxs-lookup"><span data-stu-id="fca09-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fca09-107">WCF(Windows Communication Foundation)</span><span class="sxs-lookup"><span data-stu-id="fca09-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fca09-108">WPF(Windows Presentation Foundation)</span><span class="sxs-lookup"><span data-stu-id="fca09-108">Windows Presentation Foundation (WPF)</span></span>

...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 1.1, .NET Framework 4.5로 마이그레이션"
  - ".NET Framework 4.5, 1.1에서 마이그레이션"
...
[!INCLUDE[win7](../../../includes/win7-md.md)] 및 이후 버전의 Windows 운영 체제는 [!INCLUDE[net_v11_long](../../../includes/net-v11-long-md.md)]을 지원하지 않습니다. 따라서 [!INCLUDE[win7](../../../includes/win7-md.md)] 이상 운영 체제 버전에서 수정하지 않으면 [!INCLUDE[net_v11_short](../../../includes/net-v11-short-md.md)]을 대상으로 하는 응용 프로그램이 실행되지 않습니다. 이 항목에서는 [!INCLUDE[win7](../../../includes/win7-md.md)] 및 이후 버전의 Windows 운영 체제에서 [!INCLUDE[net_v11_short](../../../includes/net-v11-short-md.md)]을 대상으로 하는 응용 프로그램을 실행하는 데 필요한 단계에 대해 설명합니다.[!INCLUDE[net_v11_long](../../../includes/net-v11-long-md.md)] 및 [!INCLUDE[win8](../../../includes/win8-md.md)]에 대한 자세한 내용은 [Windows 8 이상 버전에서 .NET Framework 1.1 앱 실행](../../../docs/framework/install/run-net-framework-1-1-apps.md)을 참조하세요.  
...
-   [.NET Framework 2.0의 주요 변경 내용](http://go.microsoft.com/fwlink/?LinkId=125263) 문서의 [!INCLUDE[net_v11_short](../../../includes/net-v11-short-md.md)]을 대상으로 하는 응용 프로그램에 영향을 줄 수 있는 [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)]의 변경 내용  

---
title: ".NET Framework 클래스 라이브러리의 사용되지 않는 기능 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "사용되지 않는[.NET Framework]"
  - "오래된[.NET Framework]"
  - "오래된 기능[.NET Framework]"
...
---
# .NET Framework 클래스 라이브러리의 사용되지 않는 기능
...
|4.5\(4.5.1 및 기타 포인트 릴리스 포함\)|v4.0|  
|4|v4.0|  
|3.5|v2.0.50727|  
|2.0|v2.0.50727|  
|1.1|v1.1.4322|  

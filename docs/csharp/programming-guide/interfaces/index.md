---
title: "인터페이스(C# 프로그래밍 가이드) | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
  - "devlang-csharp"
...
## 중요 설명서 장  
 [C\# 3.0 학습: C\# 3.0의 기본 사항 마스터](http://msdn.microsoft.com/library/orm-9780596521066-01.aspx)의 [인터페이스](http://msdn.microsoft.com/library/orm-9780596521066-01-13.aspx)\(영문\)  

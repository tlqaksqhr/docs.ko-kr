---
title: "방법: 네임스페이스에서 요소 찾기(XPath 및 LINQ to XML)(C#) | Microsoft 문서"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="example"></a>예제  
 다음 예제에서는 두 네임스페이스가 포함된 XML 트리를 읽습니다. 여기에서는 <xref:System.Xml.XmlReader>를 사용하여 XML 문서를 읽습니다. 그런 다음 <xref:System.Xml.XmlReader>에서 <xref:System.Xml.XmlNameTable>을 가져오고, <xref:System.Xml.XmlNameTable>에서 <xref:System.Xml.XmlNamespaceManager>를 가져옵니다. 요소를 선택할 때 <xref:System.Xml.XmlNamespaceManager>를 사용합니다.  

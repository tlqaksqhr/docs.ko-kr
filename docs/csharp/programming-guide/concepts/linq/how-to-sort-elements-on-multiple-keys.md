---
title: "방법: 여러 키로 요소 정렬(C#) | Microsoft 문서"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="example"></a>예제  
 ...
 이 예제에서는 XML 문서 [샘플 XML 파일: 네임스페이스의 Customers 및 Orders](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)을 사용합니다.  

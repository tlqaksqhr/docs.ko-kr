---
title: "순수 함수 변환 소개(C#) | Microsoft 문서"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
|항목|설명|  
|-----------|-----------------|  
|[개념과 용어(함수 변환)(C#)](../../../../csharp/programming-guide/concepts/linq/concepts-and-terminology-functional-transformation.md)|순수 함수 변환의 개념과 용어에 대해 소개합니다.|  
|[함수형 프로그래밍과 명령형 프로그래밍 비교(C#)](../../../../csharp/programming-guide/concepts/linq/functional-programming-vs-imperative-programming.md)|함수형 프로그래밍을 더욱 일반적인 명령형(절차적) 프로그래밍과 비교하고 대조합니다.|  
|[순수 함수로 리팩터링(C#)](../../../../csharp/programming-guide/concepts/linq/refactoring-into-pure-functions.md)|순수 함수에 대해 소개하고 순수 함수와 비순수 함수의 예제를 보여 줍니다.|  

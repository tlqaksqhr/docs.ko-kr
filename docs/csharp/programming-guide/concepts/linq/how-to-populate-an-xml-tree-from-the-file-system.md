...
## <a name="example"></a><span data-ttu-id="b20cc-107">예</span><span class="sxs-lookup"><span data-stu-id="b20cc-107">Example</span></span>  
 <span data-ttu-id="b20cc-108">다음 예제에서는 재귀를 사용하여 로컬 파일 시스템에서 XML 트리를 채운 다음</span><span class="sxs-lookup"><span data-stu-id="b20cc-108">The following example populates an XML tree from the local file system using recursion.</span></span> <span data-ttu-id="b20cc-109">트리를 쿼리하고 트리에 있는 모든 파일의 총 크기를 계산합니다.</span><span class="sxs-lookup"><span data-stu-id="b20cc-109">It then queries the tree, calculating the total of the sizes of all files in the tree.</span></span>  
...
```  
 ...
 <span data-ttu-id="b20cc-110">이 예제의 결과는 다음과 유사합니다.</span><span class="sxs-lookup"><span data-stu-id="b20cc-110">This example produces output similar to the following:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="b20cc-111">참고 항목</span><span class="sxs-lookup"><span data-stu-id="b20cc-111">See Also</span></span>  
 [<span data-ttu-id="b20cc-112">고급 쿼리 기술(LINQ to XML)(C#)</span><span class="sxs-lookup"><span data-stu-id="b20cc-112">Advanced Query Techniques (LINQ to XML) (C#)</span></span>](../../../../csharp/programming-guide/concepts/linq/advanced-query-techniques-linq-to-xml.md)

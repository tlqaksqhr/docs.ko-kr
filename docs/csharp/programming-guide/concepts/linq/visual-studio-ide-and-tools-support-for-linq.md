---
title: "LINQ에 대한 Visual Studio IDE 및 도구 지원(C#) | Microsoft 문서"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
## <a name="object-relational-designer"></a>Object Relational Designer  
 개체 관계형 디자이너는 기본 데이터베이스의 관계형 데이터를 나타내는 C#의 클래스를 생성하기 위해 [LINQ to SQL](https://msdn.microsoft.com/library/bb386976) 응용 프로그램에서 사용할 수 있는 시각적 디자인 도구입니다. 자세한 내용은 [Visual Studio의 LINQ to SQL 도구](https://docs.microsoft.com/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)를 참조하세요.  
...
## <a name="visual-studio-debugger-support"></a>Visual Studio 디버거 지원  
 Visual Studio 디버거는 쿼리 식의 디버깅을 지원합니다. 자세한 내용은 [LINQ 디버깅](https://docs.microsoft.com/visualstudio/debugger/debugging-linq)을 참조하세요.  

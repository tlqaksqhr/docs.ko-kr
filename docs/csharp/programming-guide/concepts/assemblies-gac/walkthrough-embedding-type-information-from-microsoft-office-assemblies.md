...
##  <span data-ttu-id="d0875-112"><a name="BKMK_createapp"></a> 여러 버전의 Microsoft Office와 함께 작동 하는 응용 프로그램을 만들려면</span><span class="sxs-lookup"><span data-stu-id="d0875-112"><a name="BKMK_createapp"></a> To create an application that works with multiple versions of Microsoft Office</span></span>  
...
##  <span data-ttu-id="d0875-132"><a name="BKMK_publishapp"></a> 다른 버전의 Microsoft Office가 설치된 컴퓨터에 응용 프로그램을 게시하려면</span><span class="sxs-lookup"><span data-stu-id="d0875-132"><a name="BKMK_publishapp"></a> To publish the application to a computer on which a different version of Microsoft Office is installed</span></span>  

...
ms.locfileid: "33338255"
---
# <a name="ltexamplegt-c-programming-guide"></a>&lt;예제&gt;(C# 프로그래밍 가이드)
## <a name="syntax"></a>구문  
...
## <a name="remarks"></a>설명  
 \<example> 태그를 사용하면 메서드 또는 기타 라이브러리 멤버를 사용하는 방법의 예제를 지정할 수 있습니다. 여기에는 일반적으로 [\<code>](../../../csharp/programming-guide/xmldoc/code.md) 태그를 같이 사용합니다.  

...
## <a name="remarks"></a>설명  
 \<para> 태그는 [\<summary>](../../../csharp/programming-guide/xmldoc/summary.md), [\<remarks>](../../../csharp/programming-guide/xmldoc/remarks.md), [\<returns>](../../../csharp/programming-guide/xmldoc/returns.md) 등의 태그 내에 사용되어 텍스트에 구조를 추가할 수 있게 합니다.  

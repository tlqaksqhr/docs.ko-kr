...
|[&&](../../../csharp/language-reference/operators/conditional-and-operator.md), [&#124;&#124;](../../../csharp/language-reference/operators/conditional-or-operator.md)|조건부 논리 연산자는 오버로드할 수 없지만 오버로드할 수 있는 `&` 및 <code>&#124;</code>를 사용하여 계산됩니다.|  

...
|<xref:System.OutOfMemoryException>|[new](../../../visual-basic/language-reference/operators/new-operator.md) 연산자를 사용하여 메모리를 할당하는 데 실패한 경우.  이는 공용 언어 런타임에 사용할 수 있는 메모리가 부족하다는 것을 의미합니다.|  

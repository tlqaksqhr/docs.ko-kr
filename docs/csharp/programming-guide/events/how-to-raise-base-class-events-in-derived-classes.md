...
다음의 간단한 예제에서는 기본 클래스의 이벤트를 선언할 때 해당 이벤트가 파생 클래스에서도 발생할 수 있도록 하는 일반적인 방법을 보여 줍니다.  이 패턴은 [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort_md.md)] 클래스 라이브러리의 Windows Forms 클래스에서 광범위하게 사용됩니다.  

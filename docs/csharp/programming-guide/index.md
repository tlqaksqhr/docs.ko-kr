...
이 단원에서는 C\# 언어의 주요 기능 및 C\#에서 .NET Framework를 통해 액세스할 수 있는 기능에 대한 자세한 정보를 제공합니다.  
 ...
 특정 키워드, 연산자 및 전처리기 지시문에 대한 자세한 내용은 [C\# 참조](../../csharp/language-reference/index.md)를 참조하십시오.  C\# 언어 사양에 대한 자세한 내용은 [C\# 언어 사양](../../visual-basic/reference/language-specification.md)을 참조하십시오.  

...
-   [방법: 메서드에 대한 구조체 전달과 클래스 참조 전달 간의 차이점 이해](../Topic/How%20to:%20Know%20the%20Difference%20Between%20Passing%20a%20Struct%20and%20Passing%20a%20Class%20Reference%20to%20a%20Method%20\(C%23%20Programming%20Guide\).md)  

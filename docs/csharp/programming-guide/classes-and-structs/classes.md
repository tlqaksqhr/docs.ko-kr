...
## 클래스 상속  
 ...
 C\+\+와 달리 C\#의 클래스는 하나의 기본 클래스만 직접 상속할 수 있습니다.  그러나 기본 클래스 자체도 다른 클래스를 상속할 수 있기 때문에 클래스는 여러 개의 기본 클래스를 간접적으로 상속할 수 있습니다.  또한 클래스는 인터페이스를 두 개 이상 직접 구현할 수 있습니다.  자세한 내용은 [인터페이스](../../../csharp/programming-guide/interfaces/index.md)을 참조하십시오.  

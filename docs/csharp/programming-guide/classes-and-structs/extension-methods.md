...
```  
 ...
 자세한 내용은 [방법: 사용자 지정 확장 메서드 구현 및 호출](../Topic/How%20to:%20Implement%20and%20Call%20a%20Custom%20Extension%20Method%20\(C%23%20Programming%20Guide\).md)을 참조하십시오.  

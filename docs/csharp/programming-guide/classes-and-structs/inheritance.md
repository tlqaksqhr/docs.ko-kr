...
> [!NOTE]
>  구조체는 상속을 지원하지 않지만 인터페이스는 구현할 수 있습니다.  자세한 내용은 [인터페이스](../../../visual-basic/reference/command-line-compiler/index.md)를 참조하십시오.  
 ...
 ![클래스 상속](../../../csharp/programming-guide/classes-and-structs/media/class_inheritance.png "Class\_Inheritance")  
클래스 상속  

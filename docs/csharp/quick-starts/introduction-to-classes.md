...
<span data-ttu-id="78cf0-206">파일을 저장하고 `dotnet run`을 입력하여 시도해 보세요.</span><span class="sxs-lookup"><span data-stu-id="78cf0-206">Save the file and type `dotnet run` to try it.</span></span>

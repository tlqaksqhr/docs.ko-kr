 ...
 **식 본문을 사용하는 함수 멤버**  
 람다 식에 사용하는 동일한 간단한 구문으로 코드의 식 본문과 함께 멤버를 선언할 수 있습니다.  [메서드](../../csharp/programming-guide/classes-and-structs/methods.md), [속성](../../csharp/programming-guide/classes-and-structs/properties.md), [인덱서](../../csharp/programming-guide/indexers/index.md) 및 [오버로드할 수 있는 연산자](../../csharp/programming-guide/statements-expressions-operators/overloadable-operators.md)를 참조하세요.  

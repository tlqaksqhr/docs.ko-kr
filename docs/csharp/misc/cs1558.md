...
'class'에 적합한 정적 Main 메서드가 없습니다.  
 ...
 [\/main](../../csharp/language-reference/compiler-options/main-compiler-option.md) 컴파일러 옵션에서 **Main** 메서드를 찾을 클래스를 지정했습니다. 그러나 [Main](../../csharp/programming-guide/main-and-command-args/main-and-command-line-arguments.md) 메서드가 올바르게 정의되지 않았습니다.  

...
'method signature'에는 CLS 규격 형식만 사용하는 액세스 가능 생성자가 없습니다.  
 ...
 CLS(공용 언어 사양)를 따르려면 특성 클래스의 인수 목록이 배열을 포함할 수 없습니다. CLS 규격에 대한 자세한 내용은 [CLS 규격 코드 작성](http://msdn.microsoft.com/en-us/4c705105-69a2-4e5e-b24e-0633bc32c7f3) 및 [언어 독립성 및 언어 독립적 구성 요소](https://msdn.microsoft.com/library/12a7a7h3)를 참조하세요.  

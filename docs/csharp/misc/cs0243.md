...
'method'는 재정의 메서드이기 때문에 Conditional 특성을 사용할 수 없습니다.  
 ...
 [Conditional](http://msdn.microsoft.com/en-us/e1c4913b-74d0-421a-8a6d-c14b3f0e68fb) 특성은 [override](../../csharp/language-reference/keywords/override.md) 키워드로 표시된 메서드에서 사용할 수 없습니다. 자세한 내용은 참조 [알고 있으면 때 사용 하 여 재정의 하 고 새 키워드](../../csharp/programming-guide/classes-and-structs/knowing-when-to-use-override-and-new-keywords.md)합니다.  

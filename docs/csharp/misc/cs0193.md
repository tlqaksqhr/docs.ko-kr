---
title: "컴파일러 오류 CS0193 | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
  - "devlang-csharp"
 ...
 **\*** 또는 **\-\>** 연산자를 포인터가 아닌 형식과 함께 사용했습니다. 자세한 내용은 [포인터 형식](../../csharp/programming-guide/unsafe-code-pointers/pointer-types.md)을 참조하세요.  

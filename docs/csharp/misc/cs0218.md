...
'type' 형식에는 true 및 false 연산자 선언이 있어야 합니다.  
 ...
 사용자 정의 형식에 대해 연산자를 정의한 다음 연산자를 단락 연산자로 사용하려는 경우 사용자 정의 연산자에 true 연산자 및 false 연산자가 정의되어 있어야 합니다. 단락 연산자에 대한 자세한 내용은 [&& 연산자](../../csharp/language-reference/operators/conditional-and-operator.md) 및 [&#124;&#124; 연산자](../../csharp/language-reference/operators/conditional-or-operator.md)를 참조하세요.  

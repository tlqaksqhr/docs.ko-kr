...
C# 언어 사양은 C# 구문 및 사용을 위한 확정된 소스입니다. 이 사양에는 C# 설명서에 나와 있지 않은 여러 항목을 비롯하여 C# 언어의 모든 측면에 대한 세부 정보가 포함되어 있습니다.

버전 5.0 사양은 2017년 12월에 [표준 ECMA-334 다섯 번째 버전](https://www.ecma-international.org/publications/files/ECMA-ST/Ecma-334.pdf)으로 릴리스되었습니다.

...
## 관계형 및 형식 테스트 연산자  
 ...
 [x \>\= y](../../../csharp/language-reference/operators/greater-than-equal-operator.md) – 크거나 같음  
...
## 논리적 AND 연산자  
 ...
 [x & y](../../../csharp/language-reference/operators/and-operator.md) – 논리적 또는 비트 AND.  정수 형식에 사용되고 일반적으로 `enum` 형식이 허용됩니다.  

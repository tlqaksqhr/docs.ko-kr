...
## <a name="example"></a><span data-ttu-id="7b0a1-105">예</span><span class="sxs-lookup"><span data-stu-id="7b0a1-105">Example</span></span>  
 <span data-ttu-id="7b0a1-106">다음 예제에서는 `group` 절에 `by` 상황별 키워드를 사용하여 각 학생의 성에서 첫 번째 문자에 따라 학생들을 그룹화하도록 지정하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="7b0a1-106">The following example shows the use of the `by` contextual keyword in a `group` clause to specify that the students should be grouped according to the first letter of the last name of each student.</span></span>  
  
 [!code-csharp[csrefKeywordsContextual#10](../../../csharp/language-reference/keywords/codesnippet/CSharp/by_1.cs)]  
  
## <a name="see-also"></a><span data-ttu-id="7b0a1-107">참고 항목</span><span class="sxs-lookup"><span data-stu-id="7b0a1-107">See Also</span></span>  
 [<span data-ttu-id="7b0a1-108">LINQ 쿼리 식</span><span class="sxs-lookup"><span data-stu-id="7b0a1-108">LINQ Query Expressions</span></span>](../../../csharp/programming-guide/linq-query-expressions/index.md)

---
title: "문 키워드(C# 참조) | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
문은 프로그램 명령입니다.  다음 표에서 참조된 항목에 설명하지 않은 문은 순서대로 실행됩니다.  다음 표에서는 C\# 문 키워드를 보여 줍니다.  키워드로 표시되지 않는 문에 대한 자세한 내용은 [문](../../../visual-basic/programming-guide/language-features/statements.md)을 참조하십시오.  
...
|[lock 문](../../../csharp/language-reference/keywords/lock-statement.md)|[잠금](../../../csharp/language-reference/keywords/lock-statement.md)|  

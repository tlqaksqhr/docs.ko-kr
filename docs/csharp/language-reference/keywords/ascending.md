---
title: "ascending(C# 참조) | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
  - "devlang-csharp"
...
---
# ascending(C# 참조)
`ascending` 컨텍스트 키워드는 쿼리 식의 [orderby 절](../../../csharp/language-reference/keywords/orderby-clause.md)에서 사용되어 정렬 순서를 오름차순으로 지정합니다.  `ascending`은 기본 정렬 순서이므로 지정할 필요가 없습니다.  

...
## <a name="example"></a><span data-ttu-id="297f6-105">예</span><span class="sxs-lookup"><span data-stu-id="297f6-105">Example</span></span>  
 <span data-ttu-id="297f6-106">다음 예제에서는 [orderby 절](../../../csharp/language-reference/keywords/orderby-clause.md)에 `ascending`을 사용하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="297f6-106">The following example shows the use of `ascending` in an [orderby clause](../../../csharp/language-reference/keywords/orderby-clause.md).</span></span>  
  
 [!code-csharp[csrefKeywordsContextual#14](../../../csharp/language-reference/keywords/codesnippet/CSharp/ascending_1.cs)]  
  
## <a name="see-also"></a><span data-ttu-id="297f6-107">참고 항목</span><span class="sxs-lookup"><span data-stu-id="297f6-107">See Also</span></span>  
 [<span data-ttu-id="297f6-108">C# 참조</span><span class="sxs-lookup"><span data-stu-id="297f6-108">C# Reference</span></span>](../../../csharp/language-reference/index.md)  
 [<span data-ttu-id="297f6-109">LINQ 쿼리 식</span><span class="sxs-lookup"><span data-stu-id="297f6-109">LINQ Query Expressions</span></span>](../../../csharp/programming-guide/linq-query-expressions/index.md)  
 [<span data-ttu-id="297f6-110">descending</span><span class="sxs-lookup"><span data-stu-id="297f6-110">descending</span></span>](../../../csharp/language-reference/keywords/descending.md)

...
---
# <a name="iteration-statements-c-reference"></a>반복문(C# 참조)
반복 문을 사용하여 루프를 만들 수 있습니다. 반복 문은 포함 문이 여러 번 실행되도록 하며 루프 종료 조건이 적용됩니다. 이러한 문은 [점프 문](../../../csharp/language-reference/keywords/jump-statements.md)이 발생하는 경우를 제외하고 순서대로 실행됩니다.  
  
 반복 문에서 사용되는 키워드는 다음과 같습니다.  

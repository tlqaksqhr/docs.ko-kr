---
title: "dotnet test 및 xUnit을 사용하여 .NET Core에서 C# 코드 단위 테스트"
...
---
# <a name="unit-testing-c-in-net-core-using-dotnet-test-and-xunit"></a>dotnet test 및 xUnit을 사용하여 .NET Core에서 C# 단위 테스트

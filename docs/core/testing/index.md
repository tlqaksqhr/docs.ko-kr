...
* [xUnit 및 .NET Core CLI를 사용하여 단위 테스트 만들기 연습](unit-testing-with-dotnet-test.md)을 사용해 보세요. 
...
* MSTest를 사용하려는 경우 [MSTest 및 .NET Core CLI를 사용하여 단위 테스트 만들기 연습](unit-testing-with-mstest.md)을 사용해 보세요.

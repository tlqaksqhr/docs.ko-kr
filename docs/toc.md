...
### [Microsoft 플랫폼 및 도구를 사용하여 컨테이너화된 Docker 응용 프로그램 수명 주기](standard/containerized-lifecycle-architecture/)
### [.NET 마이크로 서비스: 컨테이너화된 .NET 응용 프로그램을 위한 아키텍처](standard/microservices-architecture/)
### [서버를 사용하지 않는 앱: 아키텍처, 패턴 및 Azure 구현](standard/serverless-architecture/)
...
## [병렬 처리, 동시성 및 비동기](standard/parallel-processing-and-concurrency.md)
...
### [.NET Core와 Docker 기본 사항 알아보기](core/docker/docker-basics-dotnet-core.md)
...
### [아이리스 클러스터링](machine-learning/tutorials/iris-clustering.md)

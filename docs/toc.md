...
## [.NET Core 도구 RC4](core/preview3/tools/index.md)
### [CLI의 변경 내용 개요](core/preview3/tools/layering.md)
### [종속성 관리](core/preview3/tools/dependencies.md)
### [응용 프로그램 배포](core/preview3/deploying/index.md)
...
### [연속 통합](core/preview3/tools/using-ci-with-cli.md)
